var V=[{id:"war_participation",label:"Ikut War",points:10,icon:"\u2694\uFE0F",category:"war"},{id:"used_both_attacks",label:"Menggunakan 2 Attack",points:10,icon:"\u{1F5E1}\uFE0F",category:"war"},{id:"three_stars",label:"3 Bintang",points:15,icon:"\u2B50",category:"war"},{id:"cwl_participation",label:"Ikut CWL",points:30,icon:"\u{1F3C6}",category:"cwl"},{id:"clan_games_complete",label:"Clan Games Selesai",points:20,icon:"\u{1F3AE}",category:"clangames"},{id:"donation_1000",label:"Donasi 1000",points:5,icon:"\u{1F381}",category:"donation"},{id:"clan_capital_active",label:"Clan Capital Aktif",points:10,icon:"\u{1F3F0}",category:"capital"}],X=[{id:"missed_attack_1",label:"Tidak Menggunakan Attack Pertama",points:-20,icon:"\u274C",category:"war"},{id:"missed_attack_2",label:"Tidak Menggunakan Attack Kedua",points:-15,icon:"\u26D4",category:"war"},{id:"missed_war_no_excuse",label:"Tidak Ikut War Tanpa Izin",points:-30,icon:"\u{1F6AB}",category:"war"},{id:"afk_too_long",label:"AFK Terlalu Lama",points:-10,icon:"\u{1F4A4}",category:"activity"},{id:"rule_violation",label:"Melanggar Aturan Clan",points:-25,icon:"\u26A0\uFE0F",category:"violation"}];var Ge=[{label:"Home",hash:"#/",icon:"\u{1F3E0}"},{label:"Members",hash:"#/members",icon:"\u{1F465}"},{label:"Leaderboard",hash:"#/leaderboard",icon:"\u{1F3C6}"},{label:"War History",hash:"#/wars",icon:"\u2694\uFE0F"},{label:"Statistics",hash:"#/statistics",icon:"\u{1F4CA}"},{label:"Base Layouts",hash:"#/layouts",icon:"\u{1F5FA}\uFE0F"},{label:"Clan Rules",hash:"#/rules",icon:"\u{1F4DC}"},{label:"Admin Panel",hash:"#/admin",icon:"\u2699\uFE0F",adminOnly:!0}];var N={gold:"rgba(245, 166, 35, 1)",purple:"rgba(168, 85, 247, 1)",blue:"rgba(59, 130, 246, 1)",green:"rgba(34, 197, 94, 1)",red:"rgba(239, 68, 68, 1)",cyan:"rgba(6, 182, 212, 1)",goldAlpha:"rgba(245, 166, 35, 0.2)",purpleAlpha:"rgba(168, 85, 247, 0.2)",blueAlpha:"rgba(59, 130, 246, 0.2)",greenAlpha:"rgba(34, 197, 94, 0.2)",redAlpha:"rgba(239, 68, 68, 0.2)",cyanAlpha:"rgba(6, 182, 212, 0.2)"};function Ve(e="#/",t=null,a=null){let o=a==="leader"||a==="coleader",i=Ge.filter(r=>!(r.adminOnly&&!o));return`
    ...
    `}function Qe({date:e,opponent:t,warSize:a,result:o,clanStars:i,opponentStars:r,clanDestruction:n,opponentDestruction:s,noAttackMembers:l,onClick:c}){let d={win:{label:"VICTORY",bg:"from-green-500/20 to-emerald-600/10",border:"border-green-500/30",badge:"from-green-500 to-emerald-600"},loss:{label:"DEFEAT",bg:"from-red-500/20 to-rose-600/10",border:"border-red-500/30",badge:"from-red-500 to-rose-600"},draw:{label:"DRAW",bg:"from-gray-500/20 to-gray-600/10",border:"border-gray-500/30",badge:"from-gray-500 to-gray-600"}},m=d[o]||d.draw;return`
    ...
    `}import{initializeApp as Wt}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-app.js";import{getAuth as qt}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js";import{initializeFirestore as Ut}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js";import{getStorage as zt}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-storage.js";var De={apiKey:"AIzaSyCJvQDiM7JQ7n0si8UgI-lpVA7CgiVD8eA",authDomain:"victorytoclan.firebaseapp.com",projectId:"victorytoclan",storageBucket:"victorytoclan.firebasestorage.app",messagingSenderId:"762294306774",appId:"1:762294306774:web:601d43f7d499167e40c677"},ye,Y,f,Kt;try{ye=Wt(De),Y=qt(ye),f=Ut(ye,{experimentalForceLongPolling:!0}),Kt=zt(ye),console.log("\u2705 Firebase initialized successfully with long polling enabled")}catch(e){console.warn("\u26A0\uFE0F Firebase initialization failed:",e.message),console.warn("Please configure your Firebase project in js/config/firebase.js")}function w(){return De.apiKey!=="YOUR_API_KEY"&&De.projectId!=="YOUR_PROJECT_ID"}async function y(){return await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js")}async function _(){if(!w())return Ae();try{let{collection:e,getDocs:t,query:a,orderBy:o}=await y(),i=a(e(f,"members"),o("totalPoints","desc"));return(await t(i)).docs.map(n=>({id:n.id,...n.data()}))}catch(e){return console.error("getMembers:",e),Ae()}}async function et(e){if(!w())return Ae().find(t=>t.tag===e)||null;try{let{doc:t,getDoc:a}=await y(),o=await a(t(f,"members",e));return o.exists()?{id:o.id,...o.data()}:null}catch(t){return console.error("getMember:",t),null}}async function Z(){if(!w())return Xe();try{let{collection:e,getDocs:t,query:a,orderBy:o}=await y(),i=a(e(f,"wars"),o("date","desc"));return(await t(i)).docs.map(n=>({id:n.id,...n.data()}))}catch(e){return console.error("getWars:",e),Xe()}}async function tt(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o}=await y();return await a(t(f,"wars"),{...e,createdAt:o()})}async function at(e){if(!w())return ke();try{let{collection:t,getDocs:a,query:o,where:i}=await y(),r=o(t(f,"pointHistory"),i("memberTag","==",e)),s=(await a(r)).docs.map(l=>({id:l.id,...l.data()}));return s.sort((l,c)=>{let d=l.date?l.date.toDate?l.date.toDate():new Date(l.date):0;return(c.date?c.date.toDate?c.date.toDate():new Date(c.date):0)-d}),s}catch(t){return console.error("getPointHistory:",t),ke()}}async function Ie(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o,doc:i,runTransaction:r}=await y(),n=i(f,"members",e.memberTag);await r(f,async s=>{let l=await s.get(n);if(!l.exists())throw"Document does not exist!";let c=l.data(),d=c.totalPoints!==void 0?c.totalPoints:500,m=c.sidePoints||0,g=d+m+e.amount,p=g,v=0;g>1500&&(p=1500,v=g-1500),p<0&&(p=0),s.update(n,{totalPoints:p,sidePoints:v})}),await a(t(f,"pointHistory"),{...e,date:o()})}async function ot(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o,doc:i,runTransaction:r}=await y(),n=i(f,"members",e.memberTag);await r(f,async s=>{let l=await s.get(n);if(!l.exists())throw"Document does not exist!";let c=l.data(),d=c.totalPoints!==void 0?c.totalPoints:500,m=c.sidePoints||0,g=d+m+e.amount,p=g,v=0;g>1500&&(p=1500,v=g-1500),p<0&&(p=0),s.update(n,{totalPoints:p,sidePoints:v})}),await a(t(f,"pointHistory"),{...e,date:o()})}async function W(){if(!w())return ke();try{let{collection:e,getDocs:t,query:a,orderBy:o,limit:i}=await y(),r=a(e(f,"pointHistory"),o("date","desc"),i(150));return(await t(r)).docs.map(s=>({id:s.id,...s.data()}))}catch(e){return console.error("getAllPointHistory:",e),ke()}}async function Le(e){if(!w())return;let{doc:t,deleteDoc:a}=await y(),o=t(f,"pointHistory",e);await a(o)}async function nt(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o}=await y();return await a(t(f,"promotions"),{...e,date:o()})}async function it(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o}=await y();return await a(t(f,"violations"),{...e,date:o()})}async function rt(){if(!w())return{clanTag:"#2ABC123",clanName:"StreetLourd"};try{let{doc:e,getDoc:t}=await y(),a=await t(e(f,"settings","general"));return a.exists()?a.data():{clanTag:"",clanName:""}}catch(e){return console.error("getSettings:",e),{clanTag:"",clanName:""}}}function Ae(){return["DragonSlayer","WarMachine","ClashKing","QueenArcher","GoblinHero","WallBreaker","TH17Master","EliteWarrior","SuperWitch","IceGolem","LavaHound","ElectroDragon","YetiSmash","HeadHunter","InfernoTower","PhoenixRise","RoyalGhost","SneakyGoblin","SuperBowler","PartyWizard"].map((t,a)=>({tag:`#${String(2e3+a).padStart(4,"0")}ABC`,name:t,townHallLevel:Math.floor(Math.random()*7)+11,role:a===0?"leader":a<3?"coLeader":a<7?"admin":"member",trophies:Math.floor(Math.random()*2e3)+4e3,donations:Math.floor(Math.random()*5e3)+500,donationsReceived:Math.floor(Math.random()*3e3)+200,clanCapitalContributions:Math.floor(Math.random()*1e5)+1e4,totalPoints:Math.floor(Math.random()*300)+50,totalWars:Math.floor(Math.random()*50)+10,totalStars:Math.floor(Math.random()*100)+20,avgDestruction:Math.random()*30+70}))}function Xe(){return["Dark Warriors","Storm Legion","Iron Wolves","Shadow Riders","Thunder Hawks"].map((t,a)=>({id:`war-${a}`,date:new Date(Date.now()-a*3*864e5).toISOString(),opponent:t,warSize:[15,20,25,30,40][a%5],result:["win","win","loss","win","draw"][a],clanStars:Math.floor(Math.random()*30)+20,opponentStars:Math.floor(Math.random()*30)+15,clanDestruction:Math.random()*20+80,opponentDestruction:Math.random()*30+60}))}function ke(){return["Ikut War","3 Bintang","Donasi 1000","Clan Games","Tidak Attack"].map((t,a)=>({id:`ph-${a}`,amount:a===4?-20:[10,15,5,20][a],reason:t,category:"war",adminName:"Leader",date:new Date(Date.now()-a*2*864e5).toISOString()}))}async function ee(){if(!w())return null;try{let{doc:e,getDoc:t}=await y(),a=await t(e(f,"settings","rules"));return a.exists()?a.data():null}catch(e){return console.error("getRules:",e),null}}async function st(e){if(!w())return;let{doc:t,setDoc:a}=await y();await a(t(f,"settings","rules"),e)}async function $e(){if(!w())return{heroTitle:`<span class="hero-title-gradient">Lead Your Clan</span>
<br>
...
<span class="hero-title-gradient-2">To Victory</span>`,heroDescription:"Pantau kontribusi anggota, statistik war, sistem poin, dan rekomendasi kenaikan pangkat secara otomatis."}}}async function lt(e){if(!w())return;let{doc:t,setDoc:a}=await y();await a(t(f,"settings","landing"),e,{merge:!0})}async function te(){if(!w())return Ze();try{let{collection:e,getDocs:t,query:a,orderBy:o}=await y(),i=a(e(f,"layouts"),o("createdAt","desc"));return(await t(i)).docs.map(n=>({id:n.id,...n.data()}))}catch(e){console.error("getLayouts:",e);try{let{collection:t,getDocs:a}=await y(),i=(await a(t(f,"layouts"))).docs.map(r=>({id:r.id,...r.data()}));return i.sort((r,n)=>{let s=r.createdAt?r.createdAt.toDate?r.createdAt.toDate():new Date(r.createdAt):0;return(n.createdAt?n.createdAt.toDate?n.createdAt.toDate():new Date(n.createdAt):0)-s}),i}catch(t){return console.error("getLayouts fallback failed:",t),Ze()}}}async function dt(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o}=await y();return await a(t(f,"layouts"),{...e,createdAt:o()})}async function ct(e,t){if(!w())return;let{doc:a,updateDoc:o}=await y();await o(a(f,"layouts",e),t)}async function mt(e){if(!w())return;let{doc:t,deleteDoc:a}=await y();await a(t(f,"layouts",e))}function Ze(){return[{id:"demo-1",title:"TH18 Legend League War Base",townHallLevel:18,category:"home",type:"war",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH18-War-Demo",createdAt:new Date().toISOString()},{id:"demo-2",title:"TH16 Hybrid farming layout",townHallLevel:16,category:"home",type:"hybrid",rating:4,imageUrl:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH16-Hybrid-Demo",createdAt:new Date().toISOString()},{id:"demo-2b",title:"TH18 Anti 3-Star War Base",townHallLevel:18,category:"home",type:"anti_3",rating:5,imageUrl:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH18-Anti3-Demo",createdAt:new Date().toISOString()},{id:"demo-2c",title:"TH15 Heart Shape Fun Base",townHallLevel:15,category:"home",type:"fun",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH15-Fun-Demo",createdAt:new Date().toISOString()},{id:"demo-3",title:"BH10 Trophy Push Base",townHallLevel:10,category:"builder",type:"",rating:4,imageUrl:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=BH10-Demo",createdAt:new Date().toISOString()},{id:"demo-4",title:"Capital Peak Level 10 Base",townHallLevel:10,category:"capital",district:"capital_peak",type:"",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=CH10-Demo",createdAt:new Date().toISOString()},{id:"demo-5",title:"Barbarian Camp Level 5 Base",townHallLevel:5,category:"capital",district:"barbarian_camp",type:"",rating:4,imageUrl:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=BC5-Demo",createdAt:new Date().toISOString()}]}async function ut(){let[e,t,a]=await Promise.all([$e(),rt(),_()]),r=`https://link.clashofclans.com/en?action=OpenClanProfile&tag=%23${(t.clanTag||"#P0YVL80U").replace("#","")}`,n=a.filter(s=>s.role!=="leader").sort((s,l)=>(l.totalPoints||0)-(s.totalPoints||0)).slice(0,3);return`
        ...
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 animate-on-scroll" data-stagger="true">
                    ${de({icon:"\u{1F465}",label:"Total Members",value:U(i),color:"blue"})}
                    ${de({icon:"\u{1F381}",label:"Top Donator",value:r?.name||"-",color:"purple",subtitle:`${U(r?.donations||0)} donated`})}
                    ${de({icon:"\u{1F3C6}",label:"Top Player",value:n?.name||"-",color:"gold",glow:!0,subtitle:`${U(n?.trophies||0)} trophies`})}
    ...
    `}function Vt(e,t){let a=["\u{1F947}","\u{1F948}","\u{1F949}"],o=["text-amber-400","text-gray-300","text-orange-400"];return`
    ...
    `,me=await _(),ce=[...me],P=1,He(e)}function He(e){let t=Math.ceil(ce.length/Be),a=ce.slice((P-1)*Be,P*Be),o=[...new Set(me.map(l=>l.townHallLevel))].sort((l,c)=>c-l);e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <!-- Header -->
        ...
        ${h()}
    `;let i=document.getElementById("member-search"),r=document.getElementById("filter-th"),n=document.getElementById("filter-role"),s=gt(()=>{let l=i?.value.toLowerCase()||"",c=r?.value||"",d=n?.value||"";ce=me.filter(m=>{let g=!l||m.name.toLowerCase().includes(l)||m.tag.toLowerCase().includes(l),p=!c||m.townHallLevel==c,v=!d||m.role===d;return g&&p&&v}),P=1,He(e)},250);i?.addEventListener("input",s),r?.addEventListener("change",s),n?.addEventListener("change",s),window.__membersPage=l=>{let c=Math.ceil(ce.length/Be);l<1||l>c||(P=l,He(e),window.scrollTo({top:0,behavior:"smooth"}))},setTimeout(()=>ne(),50)}function Yt(e,t){let a=[],i=Math.max(1,e-Math.floor(2.5)),r=Math.min(t,i+5-1);r-i<4&&(i=Math.max(1,r-5+1));for(let n=i;n<=r;n++)a.push(`
        ...
        `);return a.join("")}async function vt(e){let t=document.getElementById("page-content");t.innerHTML=`<div class="pt-24 pb-8 px-4"><div class="max-w-5xl mx-auto">${S.profile()}</div></div>`;let a=decodeURIComponent(e),[o,i]=await Promise.all([et(a),at(a)]);if(!o){t.innerHTML=`
            <div class="pt-24 pb-8 px-4">
        ...
        ${h()}
    `}function Jt(e){if(!e||e.length===0)return`
        ...
        `;let t=e.map(a=>{let o=a.amount>=0,i=o?"text-green-400":"text-red-400",r=o?"bg-green-500/5 border-green-500/10":"bg-red-500/5 border-red-500/10",n=" Poin",s=o?"bg-green-500/10":"bg-red-500/10",l=o?"+":"",c=o?"\u25B2":"\u25BC";a.category==="side_point"&&(i=o?"text-blue-400":"text-indigo-400",r=o?"bg-blue-500/5 border-blue-500/10":"bg-indigo-500/5 border-indigo-500/10",n=" SP",s=o?"bg-blue-500/10":"bg-indigo-500/10");let d="-";if(a.date){let p=a.date.toDate?a.date.toDate():new Date(a.date);d=p.toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"})+" "+p.toLocaleTimeString("id-ID",{hour:"2-digit",minute:"2-digit"})}let g={war:"\u2694\uFE0F",donation:"\u{1F381}",clan_games:"\u{1F3AE}",cwl:"\u{1F3C5}",penalty:"\u26D4",bonus:"\u{1F31F}",side_point:"\u{1F48E}",other:"\u{1F4CC}"}[a.category]||"\u{1F4CC}";return`
    ...
    `;let t=await _(),a=await W(),o=t.filter(n=>n.role!=="leader").sort((n,s)=>(s.totalPoints||0)-(n.totalPoints||0)).slice(0,100);if(o.length===0){e.innerHTML=`
            <div class="pt-24 pb-8 px-4"><div class="max-w-4xl mx-auto">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mt-12 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm overflow-hidden animate-on-scroll" data-stagger="true">
                    ...
                    <div class="p-4 space-y-2 max-h-[500px] overflow-y-auto pr-2">
                        ${a.length>0?a.map(n=>{let s=ae(oe(n.date)),l=(n.amount||0)>=0,c=l?"bg-green-500/20 text-green-400 border border-green-500/30":"bg-red-500/20 text-red-400 border border-red-500/30";return`
    ...
    `;let[t,a]=await Promise.all([_(),Z()]);e.innerHTML=`
        ...
        ${h()}
    `,await Qt(),Xt(t),Zt(a),ea(t),ta(t)}function Qt(){return new Promise(e=>{if(window.Chart){e();return}let t=setInterval(()=>{window.Chart&&(clearInterval(t),e())},100);setTimeout(()=>{clearInterval(t),e()},5e3)})}function Xt(e){let t=document.getElementById("chart-donations");if(!t||!window.Chart)return;let a=[...e].sort((i,r)=>(r.donations||0)-(i.donations||0)).slice(0,10),o=new Chart(t.getContext("2d"),{type:"bar",data:{labels:a.map(i=>i.name.substring(0,10)),datasets:[{label:"Donations",data:a.map(i=>i.donations||0),backgroundColor:N.purpleAlpha,borderColor:N.purple,borderWidth:1,borderRadius:8}]},options:Lt()});ie.push(o)}function Zt(e){let t=document.getElementById("chart-wars");if(!t||!window.Chart)return;let a=e.filter(n=>n.result==="win").length,o=e.filter(n=>n.result==="loss").length,i=e.filter(n=>n.result==="draw").length,r=new Chart(t.getContext("2d"),{type:"doughnut",data:{labels:["Victories","Defeats","Draws"],datasets:[{data:[a,o,i],backgroundColor:[N.green,N.red,N.gold],borderColor:"#0a0e17",borderWidth:3,hoverOffset:8}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"65%",plugins:{legend:{labels:{color:"#94a3b8",font:{size:12},padding:16,usePointStyle:!0}},tooltip:{backgroundColor:"rgba(15,23,42,0.9)",titleColor:"#f1f5f9",bodyColor:"#cbd5e1",borderColor:"rgba(255,255,255,0.1)",borderWidth:1,cornerRadius:12,padding:12}},animation:{animateRotate:!0,animateScale:!0,duration:1200}}});ie.push(r)}function ea(e){let t=document.getElementById("chart-points");if(!t||!window.Chart)return;let a=[...e].sort((i,r)=>(r.totalPoints||0)-(i.totalPoints||0)).slice(0,10),o=new Chart(t.getContext("2d"),{type:"bar",data:{labels:a.map(i=>i.name.substring(0,10)),datasets:[{label:"Points",data:a.map(i=>i.totalPoints||0),backgroundColor:N.goldAlpha,borderColor:N.gold,borderWidth:1,borderRadius:8}]},options:{...Lt(),indexAxis:"y"}});ie.push(o)}function ta(e){let t=document.getElementById("chart-th");if(!t||!window.Chart)return;let a={};e.forEach(s=>{let l=s.townHallLevel||0;a[l]=(a[l]||0)+1});let o=Object.keys(a).sort((s,l)=>s-l).map(s=>`TH${s}`),i=Object.keys(a).sort((s,l)=>s-l).map(s=>a[s]),r=i.map((s,l)=>`hsl(${l*30+200}, 70%, 55%)`),n=new Chart(t.getContext("2d"),{type:"doughnut",data:{labels:o,datasets:[{data:i,backgroundColor:r,borderColor:"#0a0e17",borderWidth:3}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"55%",plugins:{legend:{labels:{color:"#94a3b8",font:{size:11},padding:12,usePointStyle:!0}},tooltip:{backgroundColor:"rgba(15,23,42,0.9)",titleColor:"#f1f5f9",bodyColor:"#cbd5e1",cornerRadius:12,padding:12}}}});ie.push(n)}function Lt(){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"rgba(15,23,42,0.9)",titleColor:"#f1f5f9",bodyColor:"#cbd5e1",borderColor:"rgba(255,255,255,0.1)",borderWidth:1,cornerRadius:12,padding:12}},scales:{x:{ticks:{color:"#64748b",font:{size:10}},grid:{color:"rgba(255,255,255,0.05)"},border:{color:"rgba(255,255,255,0.1)"}},y:{ticks:{color:"#64748b",font:{size:10}},grid:{color:"rgba(255,255,255,0.05)"},border:{color:"rgba(255,255,255,0.1)"}}},animation:{duration:1e3,easing:"easeOutQuart"}}}var aa=["Semua perubahan poin memiliki alasan, nama admin, dan tanggal yang tercatat","Jika status Opt-In dan tidak menyerang, poin otomatis berkurang","Jika status Opt-Out atau Izin, tidak ada pengurangan poin","Leader dan Co-Leader berhak menambah/mengurangi poin manual","Riwayat poin dapat dilihat oleh semua anggota","Promosi direkomendasikan berdasarkan akumulasi poin","Setiap anggota wajib menghormati sesama anggota clan","Donasi yang aktif dan Clan Capital yang rajin akan mendapat poin tambahan"];async function $t(){let e=await ee(),t=e&&e.rewards?e.rewards:V,a=e&&e.punishments?e.punishments:X,o=e&&e.generalRules?e.generalRules:aa;return`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header -->
                <div class="text-center mb-12 animate-on-scroll">
    ...
    `}var Re=class{constructor(){this.container=null,this.toasts=[],this.init()}init(){this.container||(this.container=document.createElement("div"),this.container.id="toast-container",this.container.className="fixed top-20 right-4 z-[9999] flex flex-col gap-3 pointer-events-none",this.container.style.maxWidth="380px",this.container.style.width="100%",document.body.appendChild(this.container))}show(t,a="info",o=4e3){this.init();let i={success:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',error:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',warning:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z"/></svg>',info:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>'},r={success:"border-green-500/50 bg-green-500/10",error:"border-red-500/50 bg-red-500/10",warning:"border-amber-500/50 bg-amber-500/10",info:"border-blue-500/50 bg-blue-500/10"},n={success:"text-green-400",error:"text-red-400",warning:"text-amber-400",info:"text-blue-400"},s=document.createElement("div");return s.className=`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-xl border ${r[a]} backdrop-blur-xl text-white shadow-2xl toast-enter`,s.innerHTML=`
        ...
        `,document.body.appendChild(l),document.body.style.overflow="hidden",r.forEach((c,d)=>{let m=l.querySelector(`#modal-action-${d}`);m&&c.onClick&&m.addEventListener("click",()=>c.onClick(l))}),requestAnimationFrame(()=>{let c=l.querySelector(".modal-content-enter");c&&c.classList.add("modal-content-visible")}),this.activeModal=l,this.onClose=n,this._escHandler=c=>{c.key==="Escape"&&this.close()},document.addEventListener("keydown",this._escHandler),l}confirm({title:t,message:a,confirmLabel:o="Confirm",cancelLabel:i="Cancel",onConfirm:r,onCancel:n,danger:s=!1}){return this.show({title:t||"Konfirmasi",content:`<p class="text-gray-300">${a}</p>`,size:"sm",actions:[{label:i,class:"px-4 py-2 rounded-xl text-sm font-medium bg-white/10 hover:bg-white/20 text-white transition-all",onClick:()=>{this.close(),n&&n()}},{label:o,class:`px-4 py-2 rounded-xl text-sm font-bold text-white transition-all ${s?"bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700":"bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700"}`,onClick:()=>{this.close(),r&&r()}}]})}close(){if(this.activeModal){let t=this.activeModal.querySelector(".modal-content-visible");t&&(t.classList.remove("modal-content-visible"),t.classList.add("modal-content-exit"));let a=this.activeModal;setTimeout(()=>{a.remove(),document.body.style.overflow=""},200),this.activeModal=null}this._escHandler&&document.removeEventListener("keydown",this._escHandler),this.onClose&&(this.onClose(),this.onClose=null)}},j=new Oe;window.__modalManager=j;var z=null,K=null,na=[];async function _t(){if(!w())return u.warning("Firebase belum dikonfigurasi. Silakan setup Firebase terlebih dahulu."),null;try{let{GoogleAuthProvider:e,signInWithPopup:t}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js"),a=new e,o=await t(Y,a);return u.success(`Selamat datang, ${o.user.displayName}!`),o.user}catch(e){return e.code==="auth/popup-closed-by-user"?u.info("Login dibatalkan."):u.error(`Login gagal: ${e.message}`),console.error("Auth error:",e),null}}async function je(){try{let{signOut:e}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js");await e(Y),z=null,K=null,u.info("Berhasil logout.")}catch(e){u.error("Logout gagal."),console.error("Sign out error:",e)}}function Bt(e){if(!w())return e(null,null),()=>{};let{onAuthStateChanged:t}=Y.constructor.prototype;import("https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js").then(({onAuthStateChanged:a})=>{a(Y,async o=>{if(z=o,o){try{await o.reload(),z=Y.currentUser}catch(i){console.warn("Failed to reload auth profile:",i)}K=await ia(z.uid),await ra(z)}else K=null;e(z,K),na.forEach(i=>i(z,K))})})}async function ia(e){try{let{doc:t,getDoc:a}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js"),o=await a(t(f,"users",e));return o.exists()&&o.data().role||"member"}catch(t){return console.warn("Error fetching user role:",t),"member"}}async function ra(e){try{let{doc:t,getDoc:a,setDoc:o,serverTimestamp:i}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js"),r=t(f,"users",e.uid);if(!(await a(r)).exists())await o(r,{uid:e.uid,email:e.email,displayName:e.displayName,photoURL:e.photoURL,role:"member",playerTag:"",createdAt:i(),lastLogin:i()});else{let{updateDoc:s}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js");await s(r,{displayName:e.displayName,photoURL:e.photoURL,lastLogin:i()})}}catch(t){console.warn("Error ensuring user doc:",t)}}function F(){return z}function St(){return K}function R(){return K==="leader"||K==="coleader"}var A=[],O=null,D=new Set,J=new Set;async function Tt(){let e=document.getElementById("page-content");if(!R()){e.innerHTML=`
            <div class="pt-24 pb-8 px-4">
        ...
        ${h()}
    `,window.__updatePointPresets=ua,window.__fillPointPreset=pa,window.__submitPoints=()=>ga(a),window.__submitWar=()=>ba(a),window.__submitViolation=()=>xa(a),window.__submitRole=()=>ha(a),window.__loadAdminPointLogs=()=>Se(a),window.__deleteLogEntry=o=>fa(o,a),window.__filterPointMembers=sa,window.__selectAllPointMembers=la,window.__toggleMemberSelection=da,window.__resetSelectedMembers=Pt,window.__filterWarNoAttackMembers=ca,window.__toggleWarNoAttackMember=ma,setTimeout(()=>{Se(a),ue(),Fe()},100)}function Ct(){return A.map(e=>`<option value="${e.tag}">${e.name} (${e.tag})</option>`).join("")}function ue(){let e=document.getElementById("point-members-container"),t=document.getElementById("point-selected-container"),a=document.getElementById("selected-count");if(!e||!t)return;let o=document.getElementById("point-member-search")?.value.toLowerCase()||"",i=A.filter(n=>!D.has(n.tag));e.innerHTML=i.map(n=>{let l=n.name.toLowerCase().includes(o)||n.tag.toLowerCase().includes(o)?"flex":"none";return`
        ...
        `}).join(""),i.length===0&&(e.innerHTML='<p class="text-center text-gray-500 text-xs py-8">Semua anggota terpilih</p>');let r=A.filter(n=>D.has(n.tag));t.innerHTML=r.map(n=>`
        ...
        `).join(""),r.length===0&&(t.innerHTML='<p class="text-center text-gray-500 text-xs py-8">Belum ada yang dipilih</p>'),a&&(a.textContent=r.length)}function sa(){ue()}function la(e){if(e){let t=document.getElementById("point-member-search")?.value.toLowerCase()||"";A.forEach(a=>{D.has(a.tag)||(a.name.toLowerCase().includes(t)||a.tag.toLowerCase().includes(t))&&D.add(a.tag)})}else D.clear();ue()}function da(e,t){t?D.add(e):D.delete(e),ue()}function Pt(){D.clear();let e=document.getElementById("point-member-search");e&&(e.value="");let t=document.querySelector('input[name="point-target"][value="selected"]');t&&(t.checked=!0),ue()}function Fe(){let e=document.getElementById("war-no-attack-container");if(!e)return;let t=document.getElementById("war-no-attack-search")?.value.toLowerCase()||"";e.innerHTML=A.map(a=>{let i=a.name.toLowerCase().includes(t)||a.tag.toLowerCase().includes(t)?"flex":"none",r=J.has(a.tag)?"checked":"";return`
            <label class="flex items-center gap-3 p-2 rounded-lg hover:bg-white/5 cursor-pointer transition-colors" style="display: ${i};">
        ...
        `}).join("")}function ca(){Fe()}function ma(e){J.has(e)?J.delete(e):J.add(e)}function ua(){let e=document.getElementById("point-type")?.value,t=document.getElementById("point-preset-container"),a=document.getElementById("point-preset");if(a)if(e==="manual")t.style.display="none";else{t.style.display="block";let o=O&&O.rewards?O.rewards:V,i=O&&O.punishments?O.punishments:X,r=e==="reward"?o:i;a.innerHTML='<option value="">-- Pilih Preset --</option>'+r.map(n=>`<option value="${n.points}" data-reason="${n.label}">${n.points>0?"+":""}${n.points} \u2014 ${n.label}</option>`).join("")}}function pa(){let t=document.getElementById("point-preset")?.selectedOptions[0];if(!t||!t.value)return;let a=document.getElementById("point-amount"),o=document.getElementById("point-reason");a&&(a.value=t.value),o&&(o.value=t.dataset.reason||"")}async function ga(e){let t=document.querySelector('input[name="point-target"]:checked')?.value||"selected",a=[];t==="selected"?a=Array.from(D):a=A.filter(l=>!D.has(l.tag)).map(l=>l.tag);let o=parseInt(document.getElementById("point-amount")?.value),i=document.getElementById("point-reason")?.value,r=document.getElementById("point-category")?.value;if(a.length===0){u.warning(t==="selected"?"Mohon pilih minimal satu anggota di daftar kanan.":"Tidak ada anggota tersisa di daftar kiri.");return}if(isNaN(o)||!i){u.warning("Mohon lengkapi semua field.");return}let n=a.map(l=>A.find(c=>c.tag===l)).filter(Boolean);if(o>0){let l=n.filter(c=>(c.totalPoints||0)+o>1500);if(l.length>0){let c=l.map(d=>d.name).join(", ");u.warning(`Gagal: Penambahan poin akan membuat poin ${c} melebihi batas maksimal 1500. Silakan gunakan menu Kelola Side Points.`);return}}let s=n.map(l=>l.name).join(", ");j.confirm({title:"Konfirmasi Kelola Poin",message:`${o>0?"Tambah":"Kurangi"} <strong>${Math.abs(o)}</strong> poin untuk <strong>${n.length} anggota</strong> (${t==="selected"?"Daftar Kanan":"Daftar Kiri"})?<br><br>Anggota: <i>${s}</i><br><br>Alasan: ${i}`,onConfirm:async()=>{try{for(let l of n)await Ie({memberTag:l.tag,memberName:l.name,amount:o,reason:i,category:r,adminName:e?.displayName||"Admin"});u.success(`Poin berhasil ${o>0?"ditambahkan":"dikurangi"} untuk ${n.length} anggota!`),document.getElementById("point-amount").value="",document.getElementById("point-reason").value="",Pt(),Se(e)}catch(l){u.error("Gagal menyimpan poin."),console.error(l)}}})}async function ba(e){let t=parseInt(document.getElementById("war-size")?.value),a=document.getElementById("war-result")?.value,o=document.getElementById("war-opponent")?.value,i=parseInt(document.getElementById("war-our-stars")?.value)||0,r=parseInt(document.getElementById("war-enemy-stars")?.value)||0,n=parseFloat(document.getElementById("war-our-dest")?.value)||0,s=parseFloat(document.getElementById("war-enemy-dest")?.value)||0;if(!o){u.warning("Mohon isi nama lawan.");return}let l=Array.from(J).map(c=>{let d=A.find(m=>m.tag===c);return d?{tag:d.tag,name:d.name}:null}).filter(Boolean);try{await tt({date:new Date().toISOString(),opponent:o,warSize:t,result:a,clanStars:i,opponentStars:r,clanDestruction:n,opponentDestruction:s,noAttackMembers:l,addedBy:e?.displayName||"Admin"}),u.success("Data war berhasil disimpan!"),document.getElementById("war-opponent").value="",document.getElementById("war-our-stars").value="",document.getElementById("war-enemy-stars").value="",document.getElementById("war-our-dest").value="",document.getElementById("war-enemy-dest").value="";let c=document.getElementById("war-no-attack-search");c&&(c.value=""),J.clear(),Fe()}catch(c){u.error("Gagal menyimpan data war."),console.error(c)}}async function xa(e){let t=document.getElementById("viol-member")?.value,a=document.getElementById("viol-type")?.value,o=document.getElementById("viol-desc")?.value,i=parseInt(document.getElementById("viol-points")?.value)||0;if(!t||!o){u.warning("Mohon lengkapi semua field.");return}let r=A.find(n=>n.tag===t);try{await it({memberTag:t,memberName:r?.name||"Unknown",type:a,description:o,pointsDeducted:i,adminName:e?.displayName||"Admin"}),i>0&&await Ie({memberTag:t,memberName:r?.name||"Unknown",amount:-i,reason:`[${a}] ${o}`,category:"violation",adminName:e?.displayName||"Admin"}),u.success("Violation berhasil dicatat!"),document.getElementById("viol-desc").value="",document.getElementById("viol-points").value=""}catch(n){u.error("Gagal menyimpan violation."),console.error(n)}}async function ha(e){let t=document.getElementById("role-member")?.value,a=document.getElementById("role-new")?.value,o=document.getElementById("role-reason")?.value,i=A.find(r=>r.tag===t);if(!t||!a){u.warning("Mohon pilih member dan role.");return}try{await nt({memberTag:t,memberName:i?.name||"Unknown",fromRole:i?.role||"member",toRole:a,reason:o||"Role updated",adminName:e?.displayName||"Admin"}),u.success(`Role ${i?.name} berhasil diubah ke ${a}!`),document.getElementById("role-reason").value=""}catch(r){u.error("Gagal mengubah role."),console.error(r)}}async function Se(e){let t=document.getElementById("admin-point-logs");if(t)try{let a=await W();if(a.length===0){t.innerHTML='<p class="text-center text-gray-500 text-sm py-6">Belum ada riwayat perubahan poin.</p>';return}t.innerHTML=a.map(o=>{let i=ae(oe(o.date)),r=(o.amount||0)>=0,n="",s=" Poin";return o.category==="side_point"?(n=r?"bg-blue-500/20 text-blue-400 border border-blue-500/30":"bg-indigo-500/20 text-indigo-400 border border-indigo-500/30",s=" Side Point"):n=r?"bg-green-500/20 text-green-400 border border-green-500/30":"bg-red-500/20 text-red-400 border border-red-500/30",`
            ...
            `}).join("")}catch(a){console.error(a),t.innerHTML='<p class="text-center text-red-400 text-sm py-6">Gagal memuat log poin.</p>'}}async function fa(e,t){j.confirm({title:"Hapus Log Poin",message:"Apakah Anda yakin ingin menghapus log poin ini?",onConfirm:async()=>{try{await Le(e),u.success("Log poin berhasil dihapus!"),Se(t)}catch(a){console.error(a),u.error("Gagal menghapus log poin.")}}})}var L={rewards:[],punishments:[],generalRules:[]},va=["Semua perubahan poin memiliki alasan, nama admin, dan tanggal yang tercatat","Jika status Opt-In dan tidak menyerang, poin otomatis berkurang","Jika status Opt-Out atau Izin, tidak ada pengurangan poin","Leader dan Co-Leader berhak menambah/mengurangi poin manual","Riwayat poin dapat dilihat oleh semua anggota","Promosi direkomendasikan berdasarkan akumulasi poin","Setiap anggota wajib menghormati sesama anggota clan","Donasi yang aktif dan Clan Capital yang rajin akan mendapat poin tambahan"];async function Et(){let e=document.getElementById("page-content");if(!R()){e.innerHTML=`
            <div class="pt-24 pb-8 px-4">
                <div class="max-w-3xl mx-auto text-center py-20">
                    <p class="text-6xl mb-4">\u{1F512}</p>
                    <h2 class="text-2xl font-bold text-white mb-2" style="font-family: 'Lilita One', cursive;">Access Denied</h2>
    ...
    `;try{let t=await ee();t?L={rewards:t.rewards||[],punishments:t.punishments||[],generalRules:t.generalRules||[]}:L={rewards:JSON.parse(JSON.stringify(V)),punishments:JSON.parse(JSON.stringify(X)),generalRules:[...va]}}catch(t){console.error(t),u.error("Gagal mengambil data rules.")}ge(e)}function ge(e){e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header & Back Button -->
    ...
    `}function pe(){let e=document.querySelectorAll(".general-rule-input");L.generalRules=Array.from(e).map(i=>i.value);let t=document.querySelectorAll(".preset-row"),a=[],o=[];t.forEach((i,r)=>{let n=i.dataset.type,s=i.querySelector(".preset-icon-input")?.value||"",l=i.querySelector(".preset-label-input")?.value||"",c=parseInt(i.querySelector(".preset-points-input")?.value)||0,d=i.querySelector(".preset-category-input")?.value||"war",m={id:`${n}_${r}_${Date.now()}`,icon:s,label:l,points:c,category:d};n==="reward"?a.push(m):o.push(m)}),L.rewards=a,L.punishments=o}var be={heroTitle:"",heroDescription:""};async function Dt(){let e=document.getElementById("page-content");if(!R()){e.innerHTML=`
            <div class="pt-24 pb-8 px-4">
                <div class="max-w-3xl mx-auto text-center py-20">
                    <p class="text-6xl mb-4">\u{1F512}</p>
                    <h2 class="text-2xl font-bold text-white mb-2" style="font-family: 'Lilita One', cursive;">Access Denied</h2>
    ...
    `;let t=document.getElementById("hero-title-input"),a=document.getElementById("hero-desc-input"),o=document.getElementById("preview-title"),i=document.getElementById("preview-desc");t&&o&&t.addEventListener("input",()=>{o.innerHTML=t.value||'<span class="text-gray-600">[Judul Kosong]</span>'}),a&&i&&a.addEventListener("input",()=>{i.textContent=a.value||"[Deskripsi Kosong]"}),window.__saveLandingConfig=async()=>{let r=t?.value.trim(),n=a?.value.trim();if(!r||!n){u.warning("Teks judul dan deskripsi tidak boleh kosong.");return}try{await lt({heroTitle:r,heroDescription:n}),u.success("Landing page settings berhasil disimpan!")}catch(s){console.error(s),u.error("Gagal menyimpan landing page settings.")}}}var Q=[],I=new Set;async function At(){let e=document.getElementById("page-content");if(!R()){e.innerHTML=`
        ...
        ${h()}
    `,window.__filterSideMembers=ya,window.__selectAllSideMembers=ka,window.__toggleSideMemberSelection=La,window.__resetSideSelectedMembers=It,window.__fillSidePreset=$a,window.__submitSidePoints=()=>_a(t),window.__deleteLogEntry=a=>Ba(a,t),setTimeout(()=>{Ne(t),re()},100)}function re(){let e=document.getElementById("side-members-container"),t=document.getElementById("side-selected-container"),a=document.getElementById("side-selected-count");if(!e||!t)return;let o=document.getElementById("side-member-search")?.value.toLowerCase()||"",i=Q.filter(n=>!I.has(n.tag));e.innerHTML=i.map(n=>{let l=n.name.toLowerCase().includes(o)||n.tag.toLowerCase().includes(o)?"flex":"none";return`
            <label class="point-member-row flex items-center gap-3 p-2 rounded-lg hover:bg-white/5 cursor-pointer transition-colors" 
                   data-name="${n.name}" data-tag="${n.tag}" style="display: ${l};">
        ...
        `}).join(""),i.length===0&&(e.innerHTML='<p class="text-center text-gray-500 text-xs py-8">Semua anggota terpilih</p>');let r=Q.filter(n=>I.has(n.tag));t.innerHTML=r.map(n=>`
        ...
        `).join(""),r.length===0&&(t.innerHTML='<p class="text-center text-gray-500 text-xs py-8">Belum ada yang dipilih</p>'),a&&(a.textContent=r.length)}function ya(){re()}function ka(e){if(e){let t=document.getElementById("side-member-search")?.value.toLowerCase()||"";Q.forEach(a=>{I.has(a.tag)||(a.name.toLowerCase().includes(t)||a.tag.toLowerCase().includes(t))&&I.add(a.tag)})}else I.clear();re()}function La(e,t){t?I.add(e):I.delete(e),re()}function It(){I.clear();let e=document.getElementById("side-member-search");e&&(e.value="");let t=document.querySelector('input[name="side-point-target"][value="selected"]');t&&(t.checked=!0),re()}function $a(){let e=document.getElementById("side-preset");if(!e||!e.value)return;let t=document.getElementById("side-amount");t&&(t.value=e.value)}async function _a(e){let t=document.querySelector('input[name="side-point-target"]:checked')?.value||"selected",a=[];t==="selected"?a=Array.from(I):a=Q.filter(s=>!I.has(s.tag)).map(s=>s.tag);let o=parseInt(document.getElementById("side-amount")?.value),i=document.getElementById("side-reason")?.value;if(a.length===0){u.warning(t==="selected"?"Mohon pilih minimal satu anggota di daftar kanan.":"Tidak ada anggota tersisa di daftar kiri.");return}if(isNaN(o)||!i){u.warning("Mohon lengkapi semua field.");return}let r=a.map(s=>Q.find(l=>l.tag===s)).filter(Boolean),n=r.map(s=>s.name).join(", ");j.confirm({title:"Konfirmasi Kelola Side Points",message:`Apakah Anda yakin ingin ${o>0?"menambah":"mengurangi"} <strong>${Math.abs(o)}</strong> side points untuk <strong>${r.length} anggota</strong> (${t==="selected"?"Daftar Kanan":"Daftar Kiri"})?<br><br>Anggota: <i>${n}</i><br><br>Alasan: ${i}`,onConfirm:async()=>{try{for(let s of r)await ot({memberTag:s.tag,memberName:s.name,amount:o,reason:i,category:"side_point",adminName:e?.displayName||"Admin"});u.success(`Side points berhasil ${o>0?"ditambahkan":"dikurangi"} untuk ${r.length} anggota!`),document.getElementById("side-amount").value="",document.getElementById("side-reason").value="",document.getElementById("side-preset").value="",It(),Q=await _(),re(),Ne(e)}catch(s){u.error("Gagal menyimpan side points."),console.error(s)}}})}async function Ne(e){let t=document.getElementById("admin-sidepoint-logs");if(t)try{let o=(await W()).filter(i=>i.category==="side_point");if(o.length===0){t.innerHTML='<p class="text-center text-gray-500 text-sm py-6">Belum ada riwayat perubahan side points.</p>';return}t.innerHTML=o.map(i=>{let r=ae(oe(i.date)),n=(i.amount||0)>=0,s=n?"bg-blue-500/20 text-blue-400 border border-blue-500/30":"bg-indigo-500/20 text-indigo-400 border border-indigo-500/30";return`
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl border border-white/5 bg-white/5 hover:bg-white/10 transition-all duration-200">
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 flex-wrap">
            ...
            `}).join("")}catch(a){console.error(a),t.innerHTML='<p class="text-center text-red-400 text-sm py-6">Gagal memuat log side points.</p>'}}async function Ba(e,t){j.confirm({title:"Hapus Log Side Points",message:"Apakah Anda yakin ingin menghapus log side points ini? Tindakan ini tidak mengembalikan nilai side points anggota.",onConfirm:async()=>{try{await Le(e),u.success("Log side points berhasil dihapus!"),Ne(t)}catch(a){console.error(a),u.error("Gagal menghapus log.")}}})}async function Ht(){let e=document.getElementById("page-content");e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <div class="mb-8">
                    <div class="h-8 bg-white/10 rounded w-48 mb-2 animate-pulse"></div>
    ...
    `;let a="home",o="all",i="all",r="all",n="all",s=1,l=9;window.__filterLayouts=()=>{let d=document.getElementById("layout-search")?.value.toLowerCase()||"",m=document.getElementById("layouts-grid");if(!m)return;let g=t.filter(b=>{let H=b.title.toLowerCase().includes(d),$=(b.category||"home")===a,B=i==="all"||parseInt(b.townHallLevel)===parseInt(i),C=!0;a==="home"&&(C=r==="all"||(b.type||"war")===r);let G=!0;a==="capital"&&(G=o==="all"||(b.district||"capital_peak")===o);let x=n==="all"||parseInt(b.rating||5)>=parseInt(n);return H&&$&&B&&C&&G&&x}),p=document.getElementById("pagination-container");if(g.length===0){m.innerHTML=`
            ...
            `}).join(""),p)if(v<=1)p.innerHTML="";else{let b="";b+=`
                ...
                `;let H=5,$=Math.max(1,s-Math.floor(H/2)),B=Math.min(v,$+H-1);B-$+1<H&&($=Math.max(1,B-H+1)),$>1&&(b+=`
                    ...
                    `,$>2&&(b+='<span class="text-gray-500 text-xs px-1">...</span>'));for(let C=$;C<=B;C++)b+=`
                        <button onclick="window.__setPage(${C})" 
                                class="w-9 h-9 rounded-xl text-xs font-bold transition-all ${C===s?"bg-amber-500 text-black shadow-md shadow-amber-500/20":"border border-white/10 bg-white/5 text-gray-400 hover:text-white hover:bg-white/10"}">
                            ${C}
                        </button>
    ...
    `;try{se=await te()}catch(t){console.error(t),u.error("Gagal memuat layouts.")}le=null,Sa(e)}function Sa(e){let t=F();e.innerHTML=`
        ...
        ${h()}
    `,window.__onCategoryChange=Ce,window.__updateLevelOptions=We,window.__submitLayoutForm=()=>Ta(t),window.__deleteLayout=a=>Pa(a),window.__editLayout=a=>Ca(a),window.__cancelEdit=Ue,Ce(),qe()}function Ce(){let e=document.getElementById("layout-form-category")?.value||"home",t=document.getElementById("type-select-container"),a=document.getElementById("district-select-container");!t||!a||(e==="home"?(t.classList.remove("hidden"),a.classList.add("hidden")):e==="builder"?(t.classList.add("hidden"),a.classList.add("hidden")):e==="capital"&&(t.classList.add("hidden"),a.classList.remove("hidden")),We())}function We(){let e=document.getElementById("layout-form-category")?.value||"home",t=document.getElementById("layout-form-district")?.value||"capital_peak",a=document.getElementById("layout-form-th"),o=document.getElementById("level-label");if(!a||!o)return;let i="";e==="home"?(o.textContent="Level Town Hall (TH)",i=Array.from({length:18},(r,n)=>18-n).map(r=>`
        ...
        `).join("")):e==="capital"&&(t==="capital_peak"?(o.textContent="Level Capital Hall (CH)",i=Array.from({length:10},(r,n)=>10-n).map(r=>`
            ...
            `).join(""))),a.innerHTML=i}function qe(){let e=document.getElementById("admin-layouts-list");if(!e)return;if(se.length===0){e.innerHTML='<p class="text-center text-gray-500 text-sm py-8">Belum ada layout base klan.</p>';return}let t={home:"Desa Asal",builder:"Desa Tukang",capital:"Clan Capital"},a={capital_peak:"Puncak Ibu Kota",barbarian_camp:"Perkemahan Barbar",wizard_valley:"Lembah Penyihir",balloon_lagoon:"Laguna Balon",builders_workshop:"Bengkel Tukang",dragon_cliffs:"Tebing Naga",golem_quarry:"Tambang Golem",skeleton_park:"Taman Rangka",goblin_mines:"Tambang Goblin"},o={war:"War Base",farming:"Farming Base",trophy:"Trophy Base",hybrid:"Hybrid Base",defense:"Defense Base",anti_2:"Anti 2 Stars Base",anti_3:"Anti 3 Stars Base",anti_air:"Anti Air Base",anti_ground:"Anti Ground Base",fun:"Fun Base",progress:"Progress Base",troll:"Troll Base"},i={home:"bg-emerald-500/20 text-emerald-400",builder:"bg-orange-500/20 text-orange-400",capital:"bg-sky-500/20 text-sky-400"};e.innerHTML=se.map(r=>{let n="\u2B50".repeat(r.rating||5),s=t[r.category||"home"],l="";r.category==="home"?l=`<span class="px-2 py-0.5 rounded text-[10px] font-bold text-gray-300 bg-white/10">${o[r.type||"war"]||"War"}</span>`:r.category==="capital"&&(l=`<span class="px-2 py-0.5 rounded text-[10px] font-bold text-sky-400 bg-sky-500/10">${a[r.district||"capital_peak"]||"Ibu Kota"}</span>`);let c=r.category==="builder"?"BH":r.category==="capital"?r.district==="capital_peak"?"CH":"Lvl":"TH";return`
        ...
        `}).join("")}function Ca(e){let t=se.find(a=>a.id===e);t&&(le=e,document.getElementById("form-title").innerHTML=`\u270F\uFE0F Edit Base: ${t.title}`,document.getElementById("submit-btn").innerHTML="Update Layout Base",document.getElementById("cancel-btn").classList.remove("hidden"),document.getElementById("layout-form-category").value=t.category||"home",Ce(),t.category==="capital"&&(document.getElementById("layout-form-district").value=t.district||"capital_peak",We()),document.getElementById("layout-form-th").value=t.townHallLevel,t.category==="home"&&(document.getElementById("layout-form-type").value=t.type||"war"),document.getElementById("layout-form-rating").value=t.rating||"5",document.getElementById("layout-form-title").value=t.title||"",document.getElementById("layout-form-link").value=t.link||"",document.getElementById("layout-form-image").value=t.imageUrl||"",document.getElementById("form-title").scrollIntoView({behavior:"smooth",block:"center"}))}function Ue(){le=null,document.getElementById("form-title").innerHTML="\u2795 Tambah Base Baru",document.getElementById("submit-btn").innerHTML="Simpan Layout Base",document.getElementById("cancel-btn").classList.add("hidden"),document.getElementById("layout-form-title").value="",document.getElementById("layout-form-link").value="",document.getElementById("layout-form-image").value="",document.getElementById("layout-form-category").value="home",Ce()}async function Ta(e){let t=document.getElementById("layout-form-category").value,a=parseInt(document.getElementById("layout-form-th").value),o=parseInt(document.getElementById("layout-form-rating").value),i=document.getElementById("layout-form-title").value.trim(),r=document.getElementById("layout-form-link").value.trim(),n=document.getElementById("layout-form-image").value.trim();if(!i||!r||!n){u.warning("Mohon isi seluruh kolom input.");return}if(!r.startsWith("http://")&&!r.startsWith("https://")){u.warning("Tautan Salin Base harus berupa URL valid.");return}let s={title:i,townHallLevel:a,category:t,rating:o,link:r,imageUrl:n,lastUpdatedBy:e?.displayName||"Admin"};t==="home"?(s.type=document.getElementById("layout-form-type").value,s.district=""):t==="capital"?(s.type="",s.district=document.getElementById("layout-form-district").value):(s.type="",s.district="");try{le?(await ct(le,s),u.success("Layout base berhasil diperbarui!"),Ue()):(await dt({...s,addedBy:e?.displayName||"Admin"}),u.success("Layout base baru berhasil disimpan!"),document.getElementById("layout-form-title").value="",document.getElementById("layout-form-link").value="",document.getElementById("layout-form-image").value=""),se=await te(),qe()}catch(l){console.error(l),u.error("Gagal memproses layout.")}}async function Pa(e){j.confirm({title:"Hapus Layout Base",message:"Apakah Anda yakin ingin menghapus layout base ini dari daftar?",onConfirm:async()=>{try{await mt(e),u.success("Layout base berhasil dihapus!"),le===e&&Ue(),se=await te(),qe()}catch(t){console.error(t),u.error("Gagal menghapus layout.")}}})}var xe=[{id:"theme_war",name:"Combat Planning (War)",url:"assets/audio/theme_war.mp3"},{id:"theme_classic",name:"Classic Clash Theme",url:"assets/audio/theme_classic.mp3"}];function Ot(){if(document.getElementById("music-player-container"))return;let e=localStorage.getItem("sl_music_track")||xe[0].id,t=parseFloat(localStorage.getItem("sl_music_volume")??"0.4"),a=localStorage.getItem("sl_music_playing")!=="false",o=xe.find(x=>x.id===e)||xe[0],i=new Audio(o.url);i.loop=!0,i.volume=t;let r=document.createElement("div");r.id="music-player-container",r.className="fixed bottom-4 left-4 md:bottom-6 md:left-6 z-50 flex items-center gap-2 sm:gap-3 bg-[#111827]/90 border border-white/10 backdrop-blur-md px-3 py-2 sm:px-4 sm:py-2.5 rounded-full shadow-2xl transition-all duration-300 hover:border-amber-500/30 group",r.innerHTML=`
    ...
    `,document.body.appendChild(r);let n=document.getElementById("music-disc"),s=document.getElementById("music-eq"),l=document.getElementById("music-play-btn"),c=document.getElementById("play-icon"),d=document.getElementById("pause-icon"),m=document.getElementById("music-volume-btn"),g=document.getElementById("volume-icon"),p=document.getElementById("mute-icon"),v=document.getElementById("music-volume-slider"),k=document.getElementById("music-track-btn"),M=document.getElementById("music-track-dropdown"),b=document.getElementById("music-tooltip"),H=document.getElementById("track-name");function $(x){a=x,localStorage.setItem("sl_music_playing",x),x?(i.play().catch(fe=>{console.log("Autoplay blocked by browser. Waiting for interaction.")}),c.classList.add("hidden"),d.classList.remove("hidden"),n.classList.add("animate-[spin_6s_linear_infinite]"),s.classList.remove("opacity-0"),s.classList.add("opacity-100")):(i.pause(),c.classList.remove("hidden"),d.classList.add("hidden"),n.classList.remove("animate-[spin_6s_linear_infinite]"),s.classList.remove("opacity-100"),s.classList.add("opacity-0"))}function B(x){t=parseFloat(x),i.volume=t,v.value=t,localStorage.setItem("sl_music_volume",t),t===0?(g.classList.add("hidden"),p.classList.remove("hidden")):(p.classList.add("hidden"),g.classList.remove("hidden"))}l.addEventListener("click",()=>{$(!a),b.classList.remove("opacity-100","translate-y-0"),b.classList.add("opacity-0","translate-y-2")}),n.addEventListener("click",()=>{$(!a),b.classList.remove("opacity-100","translate-y-0"),b.classList.add("opacity-0","translate-y-2")}),v.addEventListener("input",x=>{B(x.target.value)});let C=t||.4;m.addEventListener("click",()=>{i.volume>0?(C=i.volume,B(0)):B(C)}),k.addEventListener("click",x=>{x.stopPropagation(),M.classList.toggle("hidden")}),document.addEventListener("click",()=>{M.classList.add("hidden")}),M.querySelectorAll("button[data-track-id]").forEach(x=>{x.addEventListener("click",fe=>{fe.stopPropagation();let ve=x.getAttribute("data-track-id"),Te=xe.find(Pe=>Pe.id===ve);if(Te){e=ve,localStorage.setItem("sl_music_track",ve);let Pe=a;i.src=Te.url,H.textContent=Te.name,M.querySelectorAll("button[data-track-id]").forEach(Ke=>{Ke.classList.remove("text-amber-400","font-bold","bg-white/5");let Ee=Ke.querySelector("span:last-child");Ee&&Ee.textContent==="\u2714"&&Ee.remove()}),x.classList.add("text-amber-400","font-bold","bg-white/5");let Me=document.createElement("span");Me.className="text-[10px]",Me.textContent="\u2714",x.appendChild(Me),M.classList.add("hidden"),Pe&&$(!0)}})}),B(t);let G=()=>{a&&i.paused&&i.play().then(()=>{$(!0)}).catch(x=>{console.log("Autoplay check:",x)})};["click","scroll","mousemove","keydown","touchstart"].forEach(x=>{document.addEventListener(x,G,{once:!0,passive:!0})}),a&&$(!0)}if(!document.getElementById("music-eq-styles")){let e=document.createElement("style");e.id="music-eq-styles",e.textContent=`
        .eq-bar {
    ...
    `,document.head.appendChild(e)}var jt=null,Ft="",Ma={"/":{render:Da,title:"Home"},"/dashboard":{render:Aa,title:"Dashboard"},"/members":{render:Ia,title:"Members"},"/leaderboard":{render:Ra,title:"Leaderboard"},"/wars":{render:Oa,title:"War History"},"/statistics":{render:ja,title:"Statistics"},"/layouts":{render:za,title:"Base Layouts"},"/rules":{render:Fa,title:"Clan Rules"},"/admin":{render:Na,title:"Admin Panel"},"/admin/rules":{render:Wa,title:"Rules Settings"},"/admin/landing":{render:qa,title:"Landing Settings"},"/admin/sidepoints":{render:Ua,title:"Manage Side Points"},"/admin/layouts":{render:Ka,title:"Manage Base Layouts"},"/login":{render:Ga,title:"Login"}};document.addEventListener("DOMContentLoaded",()=>{Ea()});async function Ea(){jt=new we("particles-canvas"),jt.start(),Ot(),Bt((e,t)=>{he(),e&&ze()==="/login"&&(window.location.hash="#/dashboard")}),Nt(),window.addEventListener("hashchange",Nt),console.log("\u2694\uFE0F StreetLourd initialized!")}function ze(){return window.location.hash.slice(1)||"/"}function Nt(){let e=ze();if(e.startsWith("/member/")){let a=e.replace("/member/","");Ft="/member/:tag",document.title="Member Detail \u2014 StreetLourd",Ha(a),he();return}let t=Ma[e];t?(Ft=e,document.title=`${t.title} \u2014 StreetLourd`,t.render()):window.location.hash="#/",he()}function he(){let e=document.getElementById("navbar-container");if(!e)return;let t=F(),a=St(),o=ze(),i="#"+o;o.startsWith("/member/")&&(i="#/members"),e.innerHTML=Ve(i,t,a),Ye();let r=document.getElementById("logout-btn"),n=document.getElementById("mobile-logout-btn");r&&r.addEventListener("click",async()=>{await je(),window.location.hash="#/",he()}),n&&n.addEventListener("click",async()=>{await je(),window.location.hash="#/",he()})}async function Da(){let e=document.getElementById("page-content");e.style.opacity="0",e.innerHTML=await ut(),requestAnimationFrame(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="1"}),setTimeout(()=>{ne(),ht()},100)}async function Aa(){let e=document.getElementById("page-content");await T(e,()=>xt())}async function Ia(){let e=document.getElementById("page-content");await T(e,()=>ft())}async function Ha(e){let t=document.getElementById("page-content");await T(t,()=>vt(e))}async function Ra(){let e=document.getElementById("page-content");await T(e,()=>wt())}async function Oa(){let e=document.getElementById("page-content");await T(e,()=>yt())}async function ja(){let e=document.getElementById("page-content");await T(e,()=>kt())}async function Fa(){let e=document.getElementById("page-content");e.style.opacity="0",e.innerHTML=await $t(),requestAnimationFrame(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="1"}),setTimeout(()=>ne(),100)}async function Na(){let e=document.getElementById("page-content");await T(e,()=>Tt())}async function Wa(){let e=document.getElementById("page-content");await T(e,()=>Et())}async function qa(){let e=document.getElementById("page-content");await T(e,()=>Dt())}async function Ua(){let e=document.getElementById("page-content");await T(e,()=>At())}async function za(){let e=document.getElementById("page-content");await T(e,()=>Ht())}async function Ka(){let e=document.getElementById("page-content");await T(e,()=>Rt())}function Ga(){let e=F(),t=document.getElementById("page-content");if(e){window.location.hash="#/dashboard";return}t.innerHTML=`
        <div class="pt-24 pb-8 px-4">
