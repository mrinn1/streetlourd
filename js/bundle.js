var V=[{id:"war_participation",label:"Ikut War",points:10,icon:"\u2694\uFE0F",category:"war"},{id:"used_both_attacks",label:"Menggunakan 2 Attack",points:10,icon:"\u{1F5E1}\uFE0F",category:"war"},{id:"three_stars",label:"3 Bintang",points:15,icon:"\u2B50",category:"war"},{id:"cwl_participation",label:"Ikut CWL",points:30,icon:"\u{1F3C6}",category:"cwl"},{id:"clan_games_complete",label:"Clan Games Selesai",points:20,icon:"\u{1F3AE}",category:"clangames"},{id:"donation_1000",label:"Donasi 1000",points:5,icon:"\u{1F381}",category:"donation"},{id:"clan_capital_active",label:"Clan Capital Aktif",points:10,icon:"\u{1F3F0}",category:"capital"}],X=[{id:"missed_attack_1",label:"Tidak Menggunakan Attack Pertama",points:-20,icon:"\u274C",category:"war"},{id:"missed_attack_2",label:"Tidak Menggunakan Attack Kedua",points:-15,icon:"\u26D4",category:"war"},{id:"missed_war_no_excuse",label:"Tidak Ikut War Tanpa Izin",points:-30,icon:"\u{1F6AB}",category:"war"},{id:"afk_too_long",label:"AFK Terlalu Lama",points:-10,icon:"\u{1F4A4}",category:"activity"},{id:"rule_violation",label:"Melanggar Aturan Clan",points:-25,icon:"\u26A0\uFE0F",category:"violation"}];var Ye=[{label:"Home",hash:"#/",icon:"\u{1F3E0}"},{label:"Members",hash:"#/members",icon:"\u{1F465}"},{label:"Leaderboard",hash:"#/leaderboard",icon:"\u{1F3C6}"},{label:"War History",hash:"#/wars",icon:"\u2694\uFE0F"},{label:"Statistics",hash:"#/statistics",icon:"\u{1F4CA}"},{label:"Base Layouts",hash:"#/layouts",icon:"\u{1F5FA}\uFE0F"},{label:"Clan Rules",hash:"#/rules",icon:"\u{1F4DC}"},{label:"Admin Panel",hash:"#/admin",icon:"\u2699\uFE0F",adminOnly:!0}];var N={gold:"rgba(245, 166, 35, 1)",purple:"rgba(168, 85, 247, 1)",blue:"rgba(59, 130, 246, 1)",green:"rgba(34, 197, 94, 1)",red:"rgba(239, 68, 68, 1)",cyan:"rgba(6, 182, 212, 1)",goldAlpha:"rgba(245, 166, 35, 0.2)",purpleAlpha:"rgba(168, 85, 247, 0.2)",blueAlpha:"rgba(59, 130, 246, 0.2)",greenAlpha:"rgba(34, 197, 94, 0.2)",redAlpha:"rgba(239, 68, 68, 0.2)",cyanAlpha:"rgba(6, 182, 212, 0.2)"};function Qe(e="#/",t=null,a=null){let o=a==="leader"||a==="coleader",n=Ye.filter(r=>!(r.adminOnly&&!o));return`
    ...
    `}function Xe(){let e=document.getElementById("main-navbar");if(!e)return;let t=0;function a(){let d=window.scrollY,m=e.querySelector(".navbar-glass");m&&(d>60?m.classList.add("navbar-solid"):m.classList.remove("navbar-solid"),t=d)}window.addEventListener("scroll",a,{passive:!0}),a();let o=document.getElementById("mobile-menu-btn"),n=document.getElementById("mobile-menu"),r=document.getElementById("mobile-menu-panel"),i=document.getElementById("mobile-menu-close"),s=document.getElementById("mobile-menu-backdrop");function l(){!n||!r||(n.classList.remove("hidden"),requestAnimationFrame(()=>{r.classList.remove("translate-x-full"),r.classList.add("translate-x-0")}))}function c(){!n||!r||(r.classList.remove("translate-x-0"),r.classList.add("translate-x-full"),setTimeout(()=>n.classList.add("hidden"),300))}return o?.addEventListener("click",l),i?.addEventListener("click",c),s?.addEventListener("click",c),document.querySelectorAll(".mobile-nav-link").forEach(d=>{d.addEventListener("click",c)}),()=>{window.removeEventListener("scroll",a)}}var Le=class{constructor(t="particles-canvas"){this.canvas=document.getElementById(t),this.canvas&&(this.ctx=this.canvas.getContext("2d"),this.particles=[],this.animationId=null,this.maxParticles=60,this.colors=["rgba(245, 166, 35, 0.4)","rgba(168, 85, 247, 0.3)","rgba(59, 130, 246, 0.3)","rgba(255, 215, 0, 0.2)","rgba(147, 51, 234, 0.2)"],this.resize(),window.addEventListener("resize",()=>this.resize()))}resize(){this.canvas&&(this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight)}createParticle(){return{x:Math.random()*this.canvas.width,y:this.canvas.height+Math.random()*100,size:Math.random()*3+1,speedY:-(Math.random()*.5+.2),speedX:(Math.random()-.5)*.3,opacity:Math.random()*.5+.1,color:this.colors[Math.floor(Math.random()*this.colors.length)],life:0,maxLife:Math.random()*300+200,pulse:Math.random()*Math.PI*2,pulseSpeed:Math.random()*.02+.01}}update(){for(;this.particles.length<this.maxParticles;)this.particles.push(this.createParticle());for(let t=this.particles.length-1;t>=0;t--){let a=this.particles[t];a.x+=a.speedX,a.y+=a.speedY,a.life++,a.pulse+=a.pulseSpeed;let o=a.life/a.maxLife;o<.1?a.currentOpacity=a.opacity*(o/.1):o>.8?a.currentOpacity=a.opacity*((1-o)/.2):a.currentOpacity=a.opacity,a.currentSize=a.size+Math.sin(a.pulse)*.5,(a.life>=a.maxLife||a.y<-20)&&this.particles.splice(t,1)}}draw(){if(this.ctx){this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);for(let t of this.particles)this.ctx.save(),this.ctx.globalAlpha=t.currentOpacity||t.opacity,this.ctx.fillStyle=t.color,this.ctx.shadowColor=t.color,this.ctx.shadowBlur=t.currentSize*4,this.ctx.beginPath(),this.ctx.arc(t.x,t.y,t.currentSize,0,Math.PI*2),this.ctx.fill(),this.ctx.restore()}}animate(){this.update(),this.draw(),this.animationId=requestAnimationFrame(()=>this.animate())}start(){this.canvas&&this.animate()}stop(){this.animationId&&(cancelAnimationFrame(this.animationId),this.animationId=null)}destroy(){this.stop(),this.particles=[],this.ctx&&this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height)}};function h(){return`
    ...
    `}function et({date:e,opponent:t,warSize:a,result:o,clanStars:n,opponentStars:r,clanDestruction:i,opponentDestruction:s,noAttackMembers:l,onClick:c}){let d={win:{label:"VICTORY",bg:"from-green-500/20 to-emerald-600/10",border:"border-green-500/30",badge:"from-green-500 to-emerald-600"},loss:{label:"DEFEAT",bg:"from-red-500/20 to-rose-600/10",border:"border-red-500/30",badge:"from-red-500 to-rose-600"},draw:{label:"DRAW",bg:"from-gray-500/20 to-gray-600/10",border:"border-gray-500/30",badge:"from-gray-500 to-gray-600"}},m=d[o]||d.draw;return`
    ...
    `}import{initializeApp as Xt}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-app.js";import{getAuth as Zt}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js";import{initializeFirestore as ea}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js";import{getStorage as ta}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-storage.js";var He={apiKey:"AIzaSyCJvQDiM7JQ7n0si8UgI-lpVA7CgiVD8eA",authDomain:"victorytoclan.firebaseapp.com",projectId:"victorytoclan",storageBucket:"victorytoclan.firebasestorage.app",messagingSenderId:"762294306774",appId:"1:762294306774:web:601d43f7d499167e40c677"},Be,J,x,aa;try{Be=Xt(He),J=Zt(Be),x=ea(Be,{experimentalForceLongPolling:!0}),aa=ta(Be),console.log("\u2705 Firebase initialized successfully with long polling enabled")}catch(e){console.warn("\u26A0\uFE0F Firebase initialization failed:",e.message),console.warn("Please configure your Firebase project in js/config/firebase.js")}function w(){return He.apiKey!=="YOUR_API_KEY"&&He.projectId!=="YOUR_PROJECT_ID"}async function y(){return await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js")}async function $(){if(!w())return Re();try{let{collection:e,getDocs:t,query:a,orderBy:o}=await y(),n=a(e(x,"members"),o("totalPoints","desc"));return(await t(n)).docs.map(i=>({id:i.id,...i.data()}))}catch(e){return console.error("getMembers:",e),Re()}}async function nt(e){if(!w())return Re().find(t=>t.tag===e)||null;try{let{doc:t,getDoc:a}=await y(),o=await a(t(x,"members",e));return o.exists()?{id:o.id,...o.data()}:null}catch(t){return console.error("getMember:",t),null}}async function Z(){if(!w())return tt();try{let{collection:e,getDocs:t,query:a,orderBy:o}=await y(),n=a(e(x,"wars"),o("date","desc"));return(await t(n)).docs.map(i=>({id:i.id,...i.data()}))}catch(e){return console.error("getWars:",e),tt()}}async function it(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o}=await y();return await a(t(x,"wars"),{...e,createdAt:o()})}async function rt(e){if(!w())return $e();try{let{collection:t,getDocs:a,query:o,where:n}=await y(),r=o(t(x,"pointHistory"),n("memberTag","==",e)),s=(await a(r)).docs.map(l=>({id:l.id,...l.data()}));return s.sort((l,c)=>{let d=l.date?l.date.toDate?l.date.toDate():new Date(l.date):0;return(c.date?c.date.toDate?c.date.toDate():new Date(c.date):0)-d}),s}catch(t){return console.error("getPointHistory:",t),$e()}}async function je(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o,doc:n,runTransaction:r}=await y(),i=n(x,"members",e.memberTag);await r(x,async s=>{let l=await s.get(i);if(!l.exists())throw"Document does not exist!";let c=l.data(),d=c.totalPoints!==void 0?c.totalPoints:500,m=c.sidePoints||0,g=d+m+e.amount,p=g,v=0;g>1500&&(p=1500,v=g-1500),p<0&&(p=0),s.update(i,{totalPoints:p,sidePoints:v})}),await a(t(x,"pointHistory"),{...e,date:o()})}async function st(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o,doc:n,runTransaction:r}=await y(),i=n(x,"members",e.memberTag);await r(x,async s=>{let l=await s.get(i);if(!l.exists())throw"Document does not exist!";let c=l.data(),d=c.totalPoints!==void 0?c.totalPoints:500,m=c.sidePoints||0,g=d+m+e.amount,p=g,v=0;g>1500&&(p=1500,v=g-1500),p<0&&(p=0),s.update(i,{totalPoints:p,sidePoints:v})}),await a(t(x,"pointHistory"),{...e,date:o()})}async function W(){if(!w())return $e();try{let{collection:e,getDocs:t,query:a,orderBy:o,limit:n}=await y(),r=a(e(x,"pointHistory"),o("date","desc"),n(150));return(await t(r)).docs.map(s=>({id:s.id,...s.data()}))}catch(e){return console.error("getAllPointHistory:",e),$e()}}async function _e(e){if(!w())return;let{doc:t,deleteDoc:a}=await y(),o=t(x,"pointHistory",e);await a(o)}async function lt(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o}=await y();return await a(t(x,"promotions"),{...e,date:o()})}async function dt(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o}=await y();return await a(t(x,"violations"),{...e,date:o()})}async function ct(){if(!w())return{clanTag:"#2ABC123",clanName:"StreetLourd"};try{let{doc:e,getDoc:t}=await y(),a=await t(e(x,"settings","general"));return a.exists()?a.data():{clanTag:"",clanName:""}}catch(e){return console.error("getSettings:",e),{clanTag:"",clanName:""}}}function Re(){return["DragonSlayer","WarMachine","ClashKing","QueenArcher","GoblinHero","WallBreaker","TH17Master","EliteWarrior","SuperWitch","IceGolem","LavaHound","ElectroDragon","YetiSmash","HeadHunter","InfernoTower","PhoenixRise","RoyalGhost","SneakyGoblin","SuperBowler","PartyWizard"].map((t,a)=>({tag:`#${String(2e3+a).padStart(4,"0")}ABC`,name:t,townHallLevel:Math.floor(Math.random()*7)+11,role:a===0?"leader":a<3?"coLeader":a<7?"admin":"member",trophies:Math.floor(Math.random()*2e3)+4e3,donations:Math.floor(Math.random()*5e3)+500,donationsReceived:Math.floor(Math.random()*3e3)+200,clanCapitalContributions:Math.floor(Math.random()*1e5)+1e4,totalPoints:Math.floor(Math.random()*300)+50,totalWars:Math.floor(Math.random()*50)+10,totalStars:Math.floor(Math.random()*100)+20,avgDestruction:Math.random()*30+70}))}function tt(){return["Dark Warriors","Storm Legion","Iron Wolves","Shadow Riders","Thunder Hawks"].map((t,a)=>({id:`war-${a}`,date:new Date(Date.now()-a*3*864e5).toISOString(),opponent:t,warSize:[15,20,25,30,40][a%5],result:["win","win","loss","win","draw"][a],clanStars:Math.floor(Math.random()*30)+20,opponentStars:Math.floor(Math.random()*30)+15,clanDestruction:Math.random()*20+80,opponentDestruction:Math.random()*30+60}))}function $e(){return["Ikut War","3 Bintang","Donasi 1000","Clan Games","Tidak Attack"].map((t,a)=>({id:`ph-${a}`,amount:a===4?-20:[10,15,5,20][a],reason:t,category:"war",adminName:"Leader",date:new Date(Date.now()-a*2*864e5).toISOString()}))}async function ee(){if(!w())return null;try{let{doc:e,getDoc:t}=await y(),a=await t(e(x,"settings","rules"));return a.exists()?a.data():null}catch(e){return console.error("getRules:",e),null}}async function mt(e){if(!w())return;let{doc:t,setDoc:a}=await y();await a(t(x,"settings","rules"),e)}async function Ce(){if(!w())return{heroTitle:`<span class="hero-title-gradient">Lead Your Clan</span>
<br>
...
<span class="hero-title-gradient-2">To Victory</span>`,heroDescription:"Pantau kontribusi anggota, statistik war, sistem poin, dan rekomendasi kenaikan pangkat secara otomatis."}}}async function ut(e){if(!w())return;let{doc:t,setDoc:a}=await y();await a(t(x,"settings","landing"),e,{merge:!0})}async function te(){if(!w())return at();try{let{collection:e,getDocs:t,query:a,orderBy:o}=await y(),n=a(e(x,"layouts"),o("createdAt","desc"));return(await t(n)).docs.map(i=>({id:i.id,...i.data()}))}catch(e){console.error("getLayouts:",e);try{let{collection:t,getDocs:a}=await y(),n=(await a(t(x,"layouts"))).docs.map(r=>({id:r.id,...r.data()}));return n.sort((r,i)=>{let s=r.createdAt?r.createdAt.toDate?r.createdAt.toDate():new Date(r.createdAt):0;return(i.createdAt?i.createdAt.toDate?i.createdAt.toDate():new Date(i.createdAt):0)-s}),n}catch(t){return console.error("getLayouts fallback failed:",t),at()}}}async function pt(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o}=await y();return await a(t(x,"layouts"),{...e,createdAt:o()})}async function gt(e,t){if(!w())return;let{doc:a,updateDoc:o}=await y();await o(a(x,"layouts",e),t)}async function bt(e){if(!w())return;let{doc:t,deleteDoc:a}=await y();await a(t(x,"layouts",e))}function at(){return[{id:"demo-1",title:"TH18 Legend League War Base",townHallLevel:18,category:"home",type:"war",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH18-War-Demo",createdAt:new Date().toISOString()},{id:"demo-2",title:"TH16 Hybrid farming layout",townHallLevel:16,category:"home",type:"hybrid",rating:4,imageUrl:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH16-Hybrid-Demo",createdAt:new Date().toISOString()},{id:"demo-2b",title:"TH18 Anti 3-Star War Base",townHallLevel:18,category:"home",type:"anti_3",rating:5,imageUrl:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH18-Anti3-Demo",createdAt:new Date().toISOString()},{id:"demo-2c",title:"TH15 Heart Shape Fun Base",townHallLevel:15,category:"home",type:"fun",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH15-Fun-Demo",createdAt:new Date().toISOString()},{id:"demo-3",title:"BH10 Trophy Push Base",townHallLevel:10,category:"builder",type:"",rating:4,imageUrl:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=BH10-Demo",createdAt:new Date().toISOString()},{id:"demo-4",title:"Capital Peak Level 10 Base",townHallLevel:10,category:"capital",district:"capital_peak",type:"",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=CH10-Demo",createdAt:new Date().toISOString()},{id:"demo-5",title:"Barbarian Camp Level 5 Base",townHallLevel:5,category:"capital",district:"barbarian_camp",type:"",rating:4,imageUrl:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=BC5-Demo",createdAt:new Date().toISOString()}]}async function ae(){if(!w())return ot();try{let{collection:e,getDocs:t,query:a,orderBy:o}=await y(),n=a(e(x,"news"),o("createdAt","desc"));return(await t(n)).docs.map(i=>({id:i.id,...i.data()}))}catch(e){console.error("getNews:",e);try{let{collection:t,getDocs:a}=await y(),n=(await a(t(x,"news"))).docs.map(r=>({id:r.id,...r.data()}));return n.sort((r,i)=>{let s=r.createdAt?r.createdAt.toDate?r.createdAt.toDate():new Date(r.createdAt):0;return(i.createdAt?i.createdAt.toDate?i.createdAt.toDate():new Date(i.createdAt):0)-s}),n}catch(t){return console.error("getNews fallback failed:",t),ot()}}}async function xt(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o}=await y();return await a(t(x,"news"),{...e,createdAt:o()})}async function ht(e,t){if(!w())return;let{doc:a,updateDoc:o}=await y();await o(a(x,"news",e),t)}async function ft(e){if(!w())return;let{doc:t,deleteDoc:a}=await y();await a(t(x,"news",e))}function ot(){return[{id:"demo-news-1",title:"Clash of Clans Town Hall 18 Update Resmi!",description:"Ketahui fitur-fitur terbaru, pertahanan baru, dan pasukan baru yang hadir di Town Hall 18!",imageUrl:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&auto=format&fit=crop&q=60",videoUrl:"https://www.youtube.com/watch?v=dQw4w9WgXcQ",externalLink:"https://supercell.com/en/games/clashofclans/",createdAt:new Date().toISOString()},{id:"demo-news-2",title:"Keseimbangan Game (Game Balancing Update)",description:"Penyesuaian statistik hero equipment, spell, dan kekuatan def dari pertahanan udara.",imageUrl:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=800&auto=format&fit=crop&q=60",videoUrl:"",externalLink:"https://supercell.com/en/games/clashofclans/",createdAt:new Date(Date.now()-864e5).toISOString()}]}async function vt(){let[e,t,a,o]=await Promise.all([Ce(),ct(),$(),ae()]),i=`https://link.clashofclans.com/en?action=OpenClanProfile&tag=%23${(t.clanTag||"#P0YVL80U").replace("#","")}`,s=a.filter(l=>l.role!=="leader").sort((l,c)=>(c.totalPoints||0)-(l.totalPoints||0)).slice(0,3);return`
            ...
            <div class="max-w-7xl mx-auto">
                ...
                `:`
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-on-scroll" data-stagger="true">
                        ${o.map((l,c)=>{let d=c*100,m=l.videoUrl,g=l.externalLink;return`
                                <div class="animate-item group flex flex-col rounded-3xl border border-white/10 bg-white/5 hover:bg-white/10 hover:border-amber-500/30 overflow-hidden transition-all duration-300 hover:scale-[1.03] hover:shadow-xl cursor-default" style="transition-delay: ${d}ms;">
                                    <!-- Thumbnail -->
                                    <div class="relative h-48 overflow-hidden bg-slate-800">
                                        <img src="${l.imageUrl}" alt="${l.title}" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" onerror="this.src='https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=400'">
                                        ...
                                        ${m?`
                                            <a href="${l.videoUrl}" target="_blank" class="absolute inset-0 flex items-center justify-center bg-black/30 group-hover:bg-black/40 transition-colors">
                                    ...
                                    <div class="p-6 flex-1 flex flex-col justify-between">
                                        <div>
                                            <h3 class="text-white font-bold text-lg mb-2 line-clamp-2 hover:text-amber-400 transition-colors" style="font-family: 'Lilita One', cursive;">${l.title}</h3>
                                            <p class="text-gray-400 text-sm leading-relaxed mb-6 line-clamp-3">${l.description}</p>
                                        </div>
                                        ...
                                        <div class="flex items-center justify-between pt-4 border-t border-white/5">
                                            <div class="flex gap-4">
                                                ${m?`
                                                    <a href="${l.videoUrl}" target="_blank" class="inline-flex items-center gap-1.5 text-xs text-red-400 hover:text-red-300 font-bold transition-colors">
                                                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                                        Video
                                                    </a>
                                                `:""}
                                                ${g?`
                                                    <a href="${l.externalLink}" target="_blank" class="inline-flex items-center gap-1.5 text-xs text-blue-400 hover:text-blue-300 font-bold transition-colors">
    ...
    `}function q(e){return e==null?"0":Number(e).toLocaleString("en-US")}function wt(e){return e?(e instanceof Date?e:new Date(e)).toLocaleDateString("id-ID",{year:"numeric",month:"long",day:"numeric"}):"-"}function oe(e){return e?(e instanceof Date?e:new Date(e)).toLocaleDateString("id-ID",{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"-"}function yt(e,t=300){let a;return function(...o){clearTimeout(a),a=setTimeout(()=>e.apply(this,o),t)}}function kt(e){let t={leader:{label:"Leader",bg:"from-yellow-500 to-amber-600",text:"text-black"},coLeader:{label:"Co-Leader",bg:"from-purple-500 to-violet-600",text:"text-white"},admin:{label:"Elder",bg:"from-blue-500 to-cyan-600",text:"text-white"},member:{label:"Member",bg:"from-gray-500 to-gray-600",text:"text-white"}},a=t[e]||t.member;return`<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-gradient-to-r ${a.bg} ${a.text}">${a.label}</span>`}function ne(e){return e?e.toDate?e.toDate():e.seconds?new Date(e.seconds*1e3):new Date(e):null}async function Lt(){let e=document.getElementById("page-content");e.innerHTML=`
    ...
    `;let[t,a,o]=await Promise.all([$(),Z(),W()]),n=t.length,r=[...t].sort((d,m)=>(m.donations||0)-(d.donations||0))[0],i=[...t].sort((d,m)=>(m.trophies||0)-(d.trophies||0))[0],s={};t.forEach(d=>{s[d.tag]=0}),o&&Array.isArray(o)&&o.forEach(d=>{(d.reason&&(d.reason.toLowerCase().includes("3 bintang")||d.reason.toLowerCase().includes("three star")||d.reason.toLowerCase().includes("three_stars")||d.reason.toLowerCase().includes("3-bintang"))||d.category==="war"&&d.amount===15)&&d.memberTag&&s[d.memberTag]!==void 0&&s[d.memberTag]++});let l=null,c=[...t].map(d=>({...d,threeStarCount:s[d.tag]||0})).sort((d,m)=>m.threeStarCount-d.threeStarCount);c[0]&&c[0].threeStarCount>0?l=c[0]:(l=[...t].sort((d,m)=>(m.totalStars||0)-(d.totalStars||0))[0],l&&(l.threeStarCount=l.totalStars||0)),e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <!-- Header -->
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 animate-on-scroll" data-stagger="true">
                    ${ue({icon:"\u{1F465}",label:"Total Members",value:q(n),color:"blue"})}
                    ${ue({icon:"\u{1F381}",label:"Top Donator",value:r?.name||"-",color:"purple",subtitle:`${q(r?.donations||0)} donated`})}
                    ${ue({icon:"\u{1F3C6}",label:"Top Player",value:i?.name||"-",color:"gold",glow:!0,subtitle:`${q(i?.trophies||0)} trophies`})}
                    ${ue({icon:"\u{1F525}",label:"Most Active",value:l?.name||"-",color:"red",subtitle:`${l?.threeStarCount||0} 3-star attacks`})}
                </div>
    ...
    `}function na(e,t){let a=["\u{1F947}","\u{1F948}","\u{1F949}"],o=["text-amber-400","text-gray-300","text-orange-400"];return`
    ...
    `}function ie(){let e=new IntersectionObserver(t=>{t.forEach(a=>{if(a.isIntersecting){a.target.classList.add("animate-visible");let o=[];a.target.dataset.stagger&&o.push(a.target),a.target.querySelectorAll('[data-stagger="true"]').forEach(n=>{o.push(n)}),o.forEach(n=>{n.querySelectorAll(".animate-item").forEach((i,s)=>{i.style.transitionDelay=`${Math.min(s,8)*100}ms`,i.classList.add("animate-visible")})})}})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});return document.querySelectorAll(".animate-on-scroll").forEach(t=>{e.observe(t)}),e}function Bt(){let e=document.querySelectorAll("[data-parallax]");if(!e.length)return;let t=!1;function a(){t||(requestAnimationFrame(()=>{let o=window.scrollY;e.forEach(n=>{let r=parseFloat(n.dataset.parallax)||.5;n.style.transform=`translateY(${o*r}px)`}),t=!1}),t=!0)}return window.addEventListener("scroll",a,{passive:!0}),()=>window.removeEventListener("scroll",a)}async function S(e,t){e.style.opacity="0",e.style.transform="translateY(10px)",await new Promise(a=>setTimeout(a,200)),await t(),window.scrollTo({top:0,behavior:"instant"}),requestAnimationFrame(()=>{e.style.transition="opacity 0.4s ease, transform 0.4s ease",e.style.opacity="1",e.style.transform="translateY(0)"}),setTimeout(()=>ie(),100)}var ge=[],pe=[],P=1,Se=12;async function $t(){let e=document.getElementById("page-content");e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <div class="mb-8"><div class="h-8 bg-white/10 rounded w-48 mb-2 animate-pulse"></div></div>
                <div class="grid gap-4">${C.repeat("memberCard",6)}</div>
            </div>
        </div>
    `,ge=await $(),pe=[...ge],P=1,Oe(e)}function Oe(e){let t=Math.ceil(pe.length/Se),a=pe.slice((P-1)*Se,P*Se),o=[...new Set(ge.map(l=>l.townHallLevel))].sort((l,c)=>c-l);e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <!-- Header -->
                <div class="mb-8 animate-on-scroll">
                    ...
                    <p class="text-gray-400">Daftar anggota clan \xB7 ${ge.length} members</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 animate-on-scroll" id="members-list" data-stagger="true">
                    ${a.length>0?a.map(l=>Ze({name:l.name,tag:l.tag,role:l.role,townHallLevel:l.townHallLevel,trophies:l.trophies,donations:l.donations,clanCapital:l.clanCapitalContributions,totalPoints:l.totalPoints,sidePoints:l.sidePoints,onClick:`location.hash='#/member/${encodeURIComponent(l.tag)}'`})).join(""):U("\u{1F465}","Tidak ada member ditemukan","Coba ubah filter pencarian")}
                </div>
                ...
                <div class="flex items-center justify-center gap-2 animate-on-scroll" id="pagination">
                    <button class="px-4 py-2 rounded-xl text-sm font-medium transition-all
                                   ${P===1?"bg-white/5 text-gray-600 cursor-not-allowed":"bg-white/10 text-white hover:bg-white/20"}"
                            onclick="window.__membersPage(${P-1})" ${P===1?"disabled":""}>
                        \u2190 Prev
                    </button>
                    ${ia(P,t)}
                    <button class="px-4 py-2 rounded-xl text-sm font-medium transition-all
                                   ${P===t?"bg-white/5 text-gray-600 cursor-not-allowed":"bg-white/10 text-white hover:bg-white/20"}"
                            onclick="window.__membersPage(${P+1})" ${P===t?"disabled":""}>
                        Next \u2192
                    </button>
                </div>
                `:""}
        ...
        ${h()}
    `;let n=document.getElementById("member-search"),r=document.getElementById("filter-th"),i=document.getElementById("filter-role"),s=yt(()=>{let l=n?.value.toLowerCase()||"",c=r?.value||"",d=i?.value||"";pe=ge.filter(m=>{let g=!l||m.name.toLowerCase().includes(l)||m.tag.toLowerCase().includes(l),p=!c||m.townHallLevel==c,v=!d||m.role===d;return g&&p&&v}),P=1,Oe(e)},250);n?.addEventListener("input",s),r?.addEventListener("change",s),i?.addEventListener("change",s),window.__membersPage=l=>{let c=Math.ceil(pe.length/Se);l<1||l>c||(P=l,Oe(e),window.scrollTo({top:0,behavior:"smooth"}))},setTimeout(()=>ie(),50)}function ia(e,t){let a=[],n=Math.max(1,e-Math.floor(2.5)),r=Math.min(t,n+5-1);r-n<4&&(n=Math.max(1,r-5+1));for(let i=n;i<=r;i++)a.push(`
        ...
        `);return a.join("")}async function _t(e){let t=document.getElementById("page-content");t.innerHTML=`<div class="pt-24 pb-8 px-4"><div class="max-w-5xl mx-auto">${C.profile()}</div></div>`;let a=decodeURIComponent(e),[o,n]=await Promise.all([nt(a),rt(a)]);if(!o){t.innerHTML=`
            <div class="pt-24 pb-8 px-4">
        ...
        `;return}let i={1:"#8B7355",2:"#CD853F",3:"#DAA520",4:"#B8860B",5:"#4169E1",6:"#FFD700",7:"#9370DB",8:"#DC143C",9:"#4B0082",10:"#FF4500",11:"#00CED1",12:"#1E90FF",13:"#228B22",14:"#32CD32",15:"#4169E1",16:"#8B008B",17:"#FFD700"}[o.townHallLevel]||"#6b7280",s="",l=o.totalPoints||0;if(o.role==="leader")s=`
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex flex-wrap gap-4 text-sm text-gray-400">
                                <span class="flex items-center gap-1.5">\u{1F3C6} ${q(o.trophies)} trophies</span>
                                <span class="flex items-center gap-1.5">\u{1F381} ${q(o.donations)} donated</span>
                            </div>
                        </div>
        ...
        ${h()}
    `}function ra(e){if(!e||e.length===0)return`
        ...
        `;let t=e.map(a=>{let o=a.amount>=0,n=o?"text-green-400":"text-red-400",r=o?"bg-green-500/5 border-green-500/10":"bg-red-500/5 border-red-500/10",i=" Poin",s=o?"bg-green-500/10":"bg-red-500/10",l=o?"+":"",c=o?"\u25B2":"\u25BC";a.category==="side_point"&&(n=o?"text-blue-400":"text-indigo-400",r=o?"bg-blue-500/5 border-blue-500/10":"bg-indigo-500/5 border-indigo-500/10",i=" SP",s=o?"bg-blue-500/10":"bg-indigo-500/10");let d="-";if(a.date){let p=a.date.toDate?a.date.toDate():new Date(a.date);d=p.toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"})+" "+p.toLocaleTimeString("id-ID",{hour:"2-digit",minute:"2-digit"})}let g={war:"\u2694\uFE0F",donation:"\u{1F381}",clan_games:"\u{1F3AE}",cwl:"\u{1F3C5}",penalty:"\u26D4",bonus:"\u{1F31F}",side_point:"\u{1F48E}",other:"\u{1F4CC}"}[a.category]||"\u{1F4CC}";return`
            <div class="flex items-center gap-4 p-4 rounded-xl border ${r} transition-all duration-200 hover:bg-white/5">
                ...
                <div class="text-right shrink-0">
                    <p class="${n} font-bold text-lg" style="font-family: 'Lilita One', cursive;">
                        <span class="text-xs">${c}</span> ${l}${a.amount}${i}
                    </p>
                </div>
            </div>
        `}).join("");return`
    ...
    `}async function Ct(){let e=document.getElementById("page-content");e.innerHTML=`
        <div class="pt-24 pb-8 px-4"><div class="max-w-4xl mx-auto">
            <div class="mb-8"><div class="h-8 bg-white/10 rounded w-48 mb-2 animate-pulse"></div></div>
            ${C.repeat("leaderboardRow",10)}
        </div></div>
    `;let t=await $(),a=await W(),o=t.filter(i=>i.role!=="leader").sort((i,s)=>(s.totalPoints||0)-(i.totalPoints||0)).slice(0,100);if(o.length===0){e.innerHTML=`
            <div class="pt-24 pb-8 px-4"><div class="max-w-4xl mx-auto">
                ${U("\u{1F3C6}","Belum Ada Data","Leaderboard akan muncul setelah data member tersedia")}
            </div></div>${h()}
        `;return}let n=o.slice(0,3),r=o.slice(3);e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mt-12 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm overflow-hidden animate-on-scroll" data-stagger="true">
                    ...
                    <div class="p-4 space-y-2 max-h-[500px] overflow-y-auto pr-2">
                        ${a.length>0?a.map(i=>{let s=oe(ne(i.date)),l=(i.amount||0)>=0,c=l?"bg-green-500/20 text-green-400 border border-green-500/30":"bg-red-500/20 text-red-400 border border-red-500/30";return`
        ...
        ${h()}
    `}async function St(){let e=document.getElementById("page-content");e.innerHTML=`
        <div class="pt-24 pb-8 px-4"><div class="max-w-4xl mx-auto">
            <div class="mb-8"><div class="h-8 bg-white/10 rounded w-48 mb-2 animate-pulse"></div></div>
            ${C.repeat("warCard",5)}
        </div></div>
    `;let t=await Z();if(t.length===0){e.innerHTML=`
            <div class="pt-24 pb-8 px-4"><div class="max-w-4xl mx-auto">
                ...
                ${U("\u2694\uFE0F","Belum Ada Data War","Data war akan muncul setelah admin menginput hasil war")}
            </div></div>${h()}
        `;return}let a=t.length,o=t.filter(s=>s.result==="win").length,n=t.filter(s=>s.result==="loss").length,r=t.filter(s=>s.result==="draw").length,i=a?Math.round(o/a*100):0;e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-4xl mx-auto">
                <!-- Header -->
                <div class="mb-8 animate-on-scroll">
                ...
                <div class="relative max-h-[600px] overflow-y-auto pr-2 animate-on-scroll" data-stagger="true">
                    ...
                    <div class="space-y-6">
                        ${t.map((s,l)=>{let c=wt(s.date);return`
                                <div class="animate-item relative flex gap-6 md:gap-8">
                                    ...
                                    <div class="flex-1 pb-2">
                                        ${et({date:c,opponent:s.opponent,warSize:s.warSize,result:s.result,clanStars:s.clanStars,opponentStars:s.opponentStars,clanDestruction:s.clanDestruction,opponentDestruction:s.opponentDestruction,noAttackMembers:s.noAttackMembers})}
                                    </div>
                                </div>
                            `}).join("")}
                    </div>
        ...
        ${h()}
    `}var re=[];async function Tt(){re.forEach(o=>{try{o.destroy()}catch{}}),re=[];let e=document.getElementById("page-content");e.innerHTML=`
        <div class="pt-24 pb-8 px-4"><div class="max-w-7xl mx-auto">
            <div class="mb-8"><div class="h-8 bg-white/10 rounded w-48 mb-2 animate-pulse"></div></div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">${C.repeat("chart",4)}</div>
        </div></div>
    `;let[t,a]=await Promise.all([$(),Z()]);e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <div class="mb-10 animate-on-scroll">
        ...
        ${h()}
    `,await sa(),la(t),da(a),ca(t),ma(t)}function sa(){return new Promise(e=>{if(window.Chart){e();return}let t=setInterval(()=>{window.Chart&&(clearInterval(t),e())},100);setTimeout(()=>{clearInterval(t),e()},5e3)})}function la(e){let t=document.getElementById("chart-donations");if(!t||!window.Chart)return;let a=[...e].sort((n,r)=>(r.donations||0)-(n.donations||0)).slice(0,10),o=new Chart(t.getContext("2d"),{type:"bar",data:{labels:a.map(n=>n.name.substring(0,10)),datasets:[{label:"Donations",data:a.map(n=>n.donations||0),backgroundColor:N.purpleAlpha,borderColor:N.purple,borderWidth:1,borderRadius:8}]},options:Pt()});re.push(o)}function da(e){let t=document.getElementById("chart-wars");if(!t||!window.Chart)return;let a=e.filter(i=>i.result==="win").length,o=e.filter(i=>i.result==="loss").length,n=e.filter(i=>i.result==="draw").length,r=new Chart(t.getContext("2d"),{type:"doughnut",data:{labels:["Victories","Defeats","Draws"],datasets:[{data:[a,o,n],backgroundColor:[N.green,N.red,N.gold],borderColor:"#0a0e17",borderWidth:3,hoverOffset:8}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"65%",plugins:{legend:{labels:{color:"#94a3b8",font:{size:12},padding:16,usePointStyle:!0}},tooltip:{backgroundColor:"rgba(15,23,42,0.9)",titleColor:"#f1f5f9",bodyColor:"#cbd5e1",borderColor:"rgba(255,255,255,0.1)",borderWidth:1,cornerRadius:12,padding:12}},animation:{animateRotate:!0,animateScale:!0,duration:1200}}});re.push(r)}function ca(e){let t=document.getElementById("chart-points");if(!t||!window.Chart)return;let a=[...e].sort((n,r)=>(r.totalPoints||0)-(n.totalPoints||0)).slice(0,10),o=new Chart(t.getContext("2d"),{type:"bar",data:{labels:a.map(n=>n.name.substring(0,10)),datasets:[{label:"Points",data:a.map(n=>n.totalPoints||0),backgroundColor:N.goldAlpha,borderColor:N.gold,borderWidth:1,borderRadius:8}]},options:{...Pt(),indexAxis:"y"}});re.push(o)}function ma(e){let t=document.getElementById("chart-th");if(!t||!window.Chart)return;let a={};e.forEach(s=>{let l=s.townHallLevel||0;a[l]=(a[l]||0)+1});let o=Object.keys(a).sort((s,l)=>s-l).map(s=>`TH${s}`),n=Object.keys(a).sort((s,l)=>s-l).map(s=>a[s]),r=n.map((s,l)=>`hsl(${l*30+200}, 70%, 55%)`),i=new Chart(t.getContext("2d"),{type:"doughnut",data:{labels:o,datasets:[{data:n,backgroundColor:r,borderColor:"#0a0e17",borderWidth:3}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"55%",plugins:{legend:{labels:{color:"#94a3b8",font:{size:11},padding:12,usePointStyle:!0}},tooltip:{backgroundColor:"rgba(15,23,42,0.9)",titleColor:"#f1f5f9",bodyColor:"#cbd5e1",cornerRadius:12,padding:12}}}});re.push(i)}function Pt(){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"rgba(15,23,42,0.9)",titleColor:"#f1f5f9",bodyColor:"#cbd5e1",borderColor:"rgba(255,255,255,0.1)",borderWidth:1,cornerRadius:12,padding:12}},scales:{x:{ticks:{color:"#64748b",font:{size:10}},grid:{color:"rgba(255,255,255,0.05)"},border:{color:"rgba(255,255,255,0.1)"}},y:{ticks:{color:"#64748b",font:{size:10}},grid:{color:"rgba(255,255,255,0.05)"},border:{color:"rgba(255,255,255,0.1)"}}},animation:{duration:1e3,easing:"easeOutQuart"}}}var ua=["Semua perubahan poin memiliki alasan, nama admin, dan tanggal yang tercatat","Jika status Opt-In dan tidak menyerang, poin otomatis berkurang","Jika status Opt-Out atau Izin, tidak ada pengurangan poin","Leader dan Co-Leader berhak menambah/mengurangi poin manual","Riwayat poin dapat dilihat oleh semua anggota","Promosi direkomendasikan berdasarkan akumulasi poin","Setiap anggota wajib menghormati sesama anggota clan","Donasi yang aktif dan Clan Capital yang rajin akan mendapat poin tambahan"];async function Mt(){let e=await ee(),t=e&&e.rewards?e.rewards:V,a=e&&e.punishments?e.punishments:X,o=e&&e.generalRules?e.generalRules:ua;return`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header -->
                <div class="text-center mb-12 animate-on-scroll">
    ...
    `}var Fe=class{constructor(){this.container=null,this.toasts=[],this.init()}init(){this.container||(this.container=document.createElement("div"),this.container.id="toast-container",this.container.className="fixed top-20 right-4 z-[9999] flex flex-col gap-3 pointer-events-none",this.container.style.maxWidth="380px",this.container.style.width="100%",document.body.appendChild(this.container))}show(t,a="info",o=4e3){this.init();let n={success:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',error:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',warning:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z"/></svg>',info:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>'},r={success:"border-green-500/50 bg-green-500/10",error:"border-red-500/50 bg-red-500/10",warning:"border-amber-500/50 bg-amber-500/10",info:"border-blue-500/50 bg-blue-500/10"},i={success:"text-green-400",error:"text-red-400",warning:"text-amber-400",info:"text-blue-400"},s=document.createElement("div");return s.className=`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-xl border ${r[a]} backdrop-blur-xl text-white shadow-2xl toast-enter`,s.innerHTML=`
        ...
        `,document.body.appendChild(l),document.body.style.overflow="hidden",r.forEach((c,d)=>{let m=l.querySelector(`#modal-action-${d}`);m&&c.onClick&&m.addEventListener("click",()=>c.onClick(l))}),requestAnimationFrame(()=>{let c=l.querySelector(".modal-content-enter");c&&c.classList.add("modal-content-visible")}),this.activeModal=l,this.onClose=i,this._escHandler=c=>{c.key==="Escape"&&this.close()},document.addEventListener("keydown",this._escHandler),l}confirm({title:t,message:a,confirmLabel:o="Confirm",cancelLabel:n="Cancel",onConfirm:r,onCancel:i,danger:s=!1}){return this.show({title:t||"Konfirmasi",content:`<p class="text-gray-300">${a}</p>`,size:"sm",actions:[{label:n,class:"px-4 py-2 rounded-xl text-sm font-medium bg-white/10 hover:bg-white/20 text-white transition-all",onClick:()=>{this.close(),i&&i()}},{label:o,class:`px-4 py-2 rounded-xl text-sm font-bold text-white transition-all ${s?"bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700":"bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700"}`,onClick:()=>{this.close(),r&&r()}}]})}close(){if(this.activeModal){let t=this.activeModal.querySelector(".modal-content-visible");t&&(t.classList.remove("modal-content-visible"),t.classList.add("modal-content-exit"));let a=this.activeModal;setTimeout(()=>{a.remove(),document.body.style.overflow=""},200),this.activeModal=null}this._escHandler&&document.removeEventListener("keydown",this._escHandler),this.onClose&&(this.onClose(),this.onClose=null)}},F=new Ne;window.__modalManager=F;var K=null,z=null,ga=[];async function Et(){if(!w())return u.warning("Firebase belum dikonfigurasi. Silakan setup Firebase terlebih dahulu."),null;try{let{GoogleAuthProvider:e,signInWithPopup:t}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js"),a=new e,o=await t(J,a);return u.success(`Selamat datang, ${o.user.displayName}!`),o.user}catch(e){return e.code==="auth/popup-closed-by-user"?u.info("Login dibatalkan."):u.error(`Login gagal: ${e.message}`),console.error("Auth error:",e),null}}async function We(){try{let{signOut:e}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js");await e(J),K=null,z=null,u.info("Berhasil logout.")}catch(e){u.error("Logout gagal."),console.error("Sign out error:",e)}}function At(e){if(!w())return e(null,null),()=>{};let{onAuthStateChanged:t}=J.constructor.prototype;import("https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js").then(({onAuthStateChanged:a})=>{a(J,async o=>{if(K=o,o){try{await o.reload(),K=J.currentUser}catch(n){console.warn("Failed to reload auth profile:",n)}z=await ba(K.uid),await xa(K)}else z=null;e(K,z),ga.forEach(n=>n(K,z))})})}async function ba(e){try{let{doc:t,getDoc:a}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js"),o=await a(t(x,"users",e));return o.exists()&&o.data().role||"member"}catch(t){return console.warn("Error fetching user role:",t),"member"}}async function xa(e){try{let{doc:t,getDoc:a,setDoc:o,serverTimestamp:n}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js"),r=t(x,"users",e.uid);if(!(await a(r)).exists())await o(r,{uid:e.uid,email:e.email,displayName:e.displayName,photoURL:e.photoURL,role:"member",playerTag:"",createdAt:n(),lastLogin:n()});else{let{updateDoc:s}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js");await s(r,{displayName:e.displayName,photoURL:e.photoURL,lastLogin:n()})}}catch(t){console.warn("Error ensuring user doc:",t)}}function D(){return K}function Dt(){return z}function M(){return z==="leader"||z==="coleader"}var H=[],O=null,I=new Set,Y=new Set;async function Ht(){let e=document.getElementById("page-content");if(!M()){e.innerHTML=`
            <div class="pt-24 pb-8 px-4">
        ...
        `;return}H=await $(),O=await ee(),I.clear(),Y.clear();let t=O&&O.rewards?O.rewards:V,a=D();e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 animate-on-scroll" data-stagger="true">
                    ...
                    <div class="animate-item rounded-2xl border border-purple-500/20 bg-gradient-to-br from-purple-500/10 to-violet-600/5 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select id="viol-member" class="admin-select">${It()}</select>
                            </div>
                            <div>
                    ...
                    <div class="animate-item rounded-2xl border border-blue-500/20 bg-gradient-to-br from-blue-500/10 to-cyan-600/5 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-xs text-gray-400 mb-1.5">Member</label>
                                <select id="role-member" class="admin-select">${It()}</select>
                            </div>
                            <div>
        ...
        ${h()}
    `,window.__updatePointPresets=ka,window.__fillPointPreset=La,window.__submitPoints=()=>Ba(a),window.__submitWar=()=>$a(a),window.__submitViolation=()=>_a(a),window.__submitRole=()=>Ca(a),window.__loadAdminPointLogs=()=>Te(a),window.__deleteLogEntry=o=>Sa(o,a),window.__filterPointMembers=ha,window.__selectAllPointMembers=fa,window.__toggleMemberSelection=va,window.__resetSelectedMembers=Rt,window.__filterWarNoAttackMembers=wa,window.__toggleWarNoAttackMember=ya,setTimeout(()=>{Te(a),be(),Ue()},100)}function It(){return H.map(e=>`<option value="${e.tag}">${e.name} (${e.tag})</option>`).join("")}function be(){let e=document.getElementById("point-members-container"),t=document.getElementById("point-selected-container"),a=document.getElementById("selected-count");if(!e||!t)return;let o=document.getElementById("point-member-search")?.value.toLowerCase()||"",n=H.filter(i=>!I.has(i.tag));e.innerHTML=n.map(i=>{let l=i.name.toLowerCase().includes(o)||i.tag.toLowerCase().includes(o)?"flex":"none";return`
        ...
        `}).join(""),n.length===0&&(e.innerHTML='<p class="text-center text-gray-500 text-xs py-8">Semua anggota terpilih</p>');let r=H.filter(i=>I.has(i.tag));t.innerHTML=r.map(i=>`
        ...
        `).join(""),r.length===0&&(t.innerHTML='<p class="text-center text-gray-500 text-xs py-8">Belum ada yang dipilih</p>'),a&&(a.textContent=r.length)}function ha(){be()}function fa(e){if(e){let t=document.getElementById("point-member-search")?.value.toLowerCase()||"";H.forEach(a=>{I.has(a.tag)||(a.name.toLowerCase().includes(t)||a.tag.toLowerCase().includes(t))&&I.add(a.tag)})}else I.clear();be()}function va(e,t){t?I.add(e):I.delete(e),be()}function Rt(){I.clear();let e=document.getElementById("point-member-search");e&&(e.value="");let t=document.querySelector('input[name="point-target"][value="selected"]');t&&(t.checked=!0),be()}function Ue(){let e=document.getElementById("war-no-attack-container");if(!e)return;let t=document.getElementById("war-no-attack-search")?.value.toLowerCase()||"";e.innerHTML=H.map(a=>{let n=a.name.toLowerCase().includes(t)||a.tag.toLowerCase().includes(t)?"flex":"none",r=Y.has(a.tag)?"checked":"";return`
            <label class="flex items-center gap-3 p-2 rounded-lg hover:bg-white/5 cursor-pointer transition-colors" style="display: ${n};">
        ...
        `}).join("")}function wa(){Ue()}function ya(e){Y.has(e)?Y.delete(e):Y.add(e)}function ka(){let e=document.getElementById("point-type")?.value,t=document.getElementById("point-preset-container"),a=document.getElementById("point-preset");if(a)if(e==="manual")t.style.display="none";else{t.style.display="block";let o=O&&O.rewards?O.rewards:V,n=O&&O.punishments?O.punishments:X,r=e==="reward"?o:n;a.innerHTML='<option value="">-- Pilih Preset --</option>'+r.map(i=>`<option value="${i.points}" data-reason="${i.label}">${i.points>0?"+":""}${i.points} \u2014 ${i.label}</option>`).join("")}}function La(){let t=document.getElementById("point-preset")?.selectedOptions[0];if(!t||!t.value)return;let a=document.getElementById("point-amount"),o=document.getElementById("point-reason");a&&(a.value=t.value),o&&(o.value=t.dataset.reason||"")}async function Ba(e){let t=document.querySelector('input[name="point-target"]:checked')?.value||"selected",a=[];t==="selected"?a=Array.from(I):a=H.filter(l=>!I.has(l.tag)).map(l=>l.tag);let o=parseInt(document.getElementById("point-amount")?.value),n=document.getElementById("point-reason")?.value,r=document.getElementById("point-category")?.value;if(a.length===0){u.warning(t==="selected"?"Mohon pilih minimal satu anggota di daftar kanan.":"Tidak ada anggota tersisa di daftar kiri.");return}if(isNaN(o)||!n){u.warning("Mohon lengkapi semua field.");return}let i=a.map(l=>H.find(c=>c.tag===l)).filter(Boolean);if(o>0){let l=i.filter(c=>(c.totalPoints||0)+o>1500);if(l.length>0){let c=l.map(d=>d.name).join(", ");u.warning(`Gagal: Penambahan poin akan membuat poin ${c} melebihi batas maksimal 1500. Silakan gunakan menu Kelola Side Points.`);return}}let s=i.map(l=>l.name).join(", ");F.confirm({title:"Konfirmasi Kelola Poin",message:`${o>0?"Tambah":"Kurangi"} <strong>${Math.abs(o)}</strong> poin untuk <strong>${i.length} anggota</strong> (${t==="selected"?"Daftar Kanan":"Daftar Kiri"})?<br><br>Anggota: <i>${s}</i><br><br>Alasan: ${n}`,onConfirm:async()=>{try{for(let l of i)await je({memberTag:l.tag,memberName:l.name,amount:o,reason:n,category:r,adminName:e?.displayName||"Admin"});u.success(`Poin berhasil ${o>0?"ditambahkan":"dikurangi"} untuk ${i.length} anggota!`),document.getElementById("point-amount").value="",document.getElementById("point-reason").value="",Rt(),Te(e)}catch(l){u.error("Gagal menyimpan poin."),console.error(l)}}})}async function $a(e){let t=parseInt(document.getElementById("war-size")?.value),a=document.getElementById("war-result")?.value,o=document.getElementById("war-opponent")?.value,n=parseInt(document.getElementById("war-our-stars")?.value)||0,r=parseInt(document.getElementById("war-enemy-stars")?.value)||0,i=parseFloat(document.getElementById("war-our-dest")?.value)||0,s=parseFloat(document.getElementById("war-enemy-dest")?.value)||0;if(!o){u.warning("Mohon isi nama lawan.");return}let l=Array.from(Y).map(c=>{let d=H.find(m=>m.tag===c);return d?{tag:d.tag,name:d.name}:null}).filter(Boolean);try{await it({date:new Date().toISOString(),opponent:o,warSize:t,result:a,clanStars:n,opponentStars:r,clanDestruction:i,opponentDestruction:s,noAttackMembers:l,addedBy:e?.displayName||"Admin"}),u.success("Data war berhasil disimpan!"),document.getElementById("war-opponent").value="",document.getElementById("war-our-stars").value="",document.getElementById("war-enemy-stars").value="",document.getElementById("war-our-dest").value="",document.getElementById("war-enemy-dest").value="";let c=document.getElementById("war-no-attack-search");c&&(c.value=""),Y.clear(),Ue()}catch(c){u.error("Gagal menyimpan data war."),console.error(c)}}async function _a(e){let t=document.getElementById("viol-member")?.value,a=document.getElementById("viol-type")?.value,o=document.getElementById("viol-desc")?.value,n=parseInt(document.getElementById("viol-points")?.value)||0;if(!t||!o){u.warning("Mohon lengkapi semua field.");return}let r=H.find(i=>i.tag===t);try{await dt({memberTag:t,memberName:r?.name||"Unknown",type:a,description:o,pointsDeducted:n,adminName:e?.displayName||"Admin"}),n>0&&await je({memberTag:t,memberName:r?.name||"Unknown",amount:-n,reason:`[${a}] ${o}`,category:"violation",adminName:e?.displayName||"Admin"}),u.success("Violation berhasil dicatat!"),document.getElementById("viol-desc").value="",document.getElementById("viol-points").value=""}catch(i){u.error("Gagal menyimpan violation."),console.error(i)}}async function Ca(e){let t=document.getElementById("role-member")?.value,a=document.getElementById("role-new")?.value,o=document.getElementById("role-reason")?.value,n=H.find(r=>r.tag===t);if(!t||!a){u.warning("Mohon pilih member dan role.");return}try{await lt({memberTag:t,memberName:n?.name||"Unknown",fromRole:n?.role||"member",toRole:a,reason:o||"Role updated",adminName:e?.displayName||"Admin"}),u.success(`Role ${n?.name} berhasil diubah ke ${a}!`),document.getElementById("role-reason").value=""}catch(r){u.error("Gagal mengubah role."),console.error(r)}}async function Te(e){let t=document.getElementById("admin-point-logs");if(t)try{let a=await W();if(a.length===0){t.innerHTML='<p class="text-center text-gray-500 text-sm py-6">Belum ada riwayat perubahan poin.</p>';return}t.innerHTML=a.map(o=>{let n=oe(ne(o.date)),r=(o.amount||0)>=0,i="",s=" Poin";return o.category==="side_point"?(i=r?"bg-blue-500/20 text-blue-400 border border-blue-500/30":"bg-indigo-500/20 text-indigo-400 border border-indigo-500/30",s=" Side Point"):i=r?"bg-green-500/20 text-green-400 border border-green-500/30":"bg-red-500/20 text-red-400 border border-red-500/30",`
            ...
            `}).join("")}catch(a){console.error(a),t.innerHTML='<p class="text-center text-red-400 text-sm py-6">Gagal memuat log poin.</p>'}}async function Sa(e,t){F.confirm({title:"Hapus Log Poin",message:"Apakah Anda yakin ingin menghapus log poin ini?",onConfirm:async()=>{try{await _e(e),u.success("Log poin berhasil dihapus!"),Te(t)}catch(a){console.error(a),u.error("Gagal menghapus log poin.")}}})}var L={rewards:[],punishments:[],generalRules:[]},Ta=["Semua perubahan poin memiliki alasan, nama admin, dan tanggal yang tercatat","Jika status Opt-In dan tidak menyerang, poin otomatis berkurang","Jika status Opt-Out atau Izin, tidak ada pengurangan poin","Leader dan Co-Leader berhak menambah/mengurangi poin manual","Riwayat poin dapat dilihat oleh semua anggota","Promosi direkomendasikan berdasarkan akumulasi poin","Setiap anggota wajib menghormati sesama anggota clan","Donasi yang aktif dan Clan Capital yang rajin akan mendapat poin tambahan"];async function Ot(){let e=document.getElementById("page-content");if(!M()){e.innerHTML=`
            <div class="pt-24 pb-8 px-4">
                <div class="max-w-3xl mx-auto text-center py-20">
                    <p class="text-6xl mb-4">\u{1F512}</p>
                    <h2 class="text-2xl font-bold text-white mb-2" style="font-family: 'Lilita One', cursive;">Access Denied</h2>
    ...
    `;try{let t=await ee();t?L={rewards:t.rewards||[],punishments:t.punishments||[],generalRules:t.generalRules||[]}:L={rewards:JSON.parse(JSON.stringify(V)),punishments:JSON.parse(JSON.stringify(X)),generalRules:[...Ta]}}catch(t){console.error(t),u.error("Gagal mengambil data rules.")}he(e)}function he(e){e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header & Back Button -->
                    ...
                    <div class="lg:col-span-7 space-y-8">
                        ...
                        <div class="rounded-2xl border border-green-500/20 bg-gradient-to-br from-green-500/5 to-emerald-600/5 p-6 backdrop-blur-sm">
                            ...
                            <div id="rewards-container" class="space-y-4 mb-4">
                                ${L.rewards.map((t,a)=>jt(a,t,"reward")).join("")}
                            </div>
                        ...
                        <div class="rounded-2xl border border-red-500/20 bg-gradient-to-br from-red-500/5 to-rose-600/5 p-6 backdrop-blur-sm">
                            ...
                            <div id="punishments-container" class="space-y-4 mb-4">
                                ${L.punishments.map((t,a)=>jt(a,t,"punishment")).join("")}
                            </div>
        ...
        ${h()}
    `,window.__addGeneralRule=()=>{xe(),L.generalRules.push(""),he(e)},window.__removeGeneralRule=t=>{xe(),L.generalRules.splice(t,1),he(e)},window.__addPreset=t=>{xe(),(t==="reward"?L.rewards:L.punishments).push({id:`${t}_${Date.now()}`,label:"",points:t==="reward"?10:-10,icon:t==="reward"?"\u2B50":"\u274C",category:"war"}),he(e)},window.__removePreset=(t,a)=>{xe(),(a==="reward"?L.rewards:L.punishments).splice(t,1),he(e)},window.__saveRulesConfig=async()=>{if(xe(),L.generalRules.some(o=>!o.trim())){u.warning("Teks aturan umum tidak boleh kosong.");return}let t=L.rewards.some(o=>!o.label.trim()||isNaN(o.points)),a=L.punishments.some(o=>!o.label.trim()||isNaN(o.points));if(t||a){u.warning("Semua label preset harus diisi dan poin harus berupa angka.");return}try{await mt(L),u.success("Rules & presets berhasil disimpan ke database!")}catch(o){console.error(o),u.error("Gagal menyimpan rules.")}}}function jt(e,t,a){let o=a==="reward";return`
    ...
    `}function xe(){let e=document.querySelectorAll(".general-rule-input");L.generalRules=Array.from(e).map(n=>n.value);let t=document.querySelectorAll(".preset-row"),a=[],o=[];t.forEach((n,r)=>{let i=n.dataset.type,s=n.querySelector(".preset-icon-input")?.value||"",l=n.querySelector(".preset-label-input")?.value||"",c=parseInt(n.querySelector(".preset-points-input")?.value)||0,d=n.querySelector(".preset-category-input")?.value||"war",m={id:`${i}_${r}_${Date.now()}`,icon:s,label:l,points:c,category:d};i==="reward"?a.push(m):o.push(m)}),L.rewards=a,L.punishments=o}var fe={heroTitle:"",heroDescription:""};async function Ft(){let e=document.getElementById("page-content");if(!M()){e.innerHTML=`
            <div class="pt-24 pb-8 px-4">
                <div class="max-w-3xl mx-auto text-center py-20">
                    <p class="text-6xl mb-4">\u{1F512}</p>
                    <h2 class="text-2xl font-bold text-white mb-2" style="font-family: 'Lilita One', cursive;">Access Denied</h2>
    ...
    `;try{fe=await Ce()}catch(t){console.error(t),u.error("Gagal mengambil data landing page.")}Pa(e)}function Pa(e){e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header & Back Button -->
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <textarea id="hero-title-input" rows="4" class="admin-input font-mono text-sm leading-relaxed" 
                                              placeholder="Masukkan judul hero...">${fe.heroTitle||""}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea id="hero-desc-input" rows="4" class="admin-input text-sm leading-relaxed" 
                                              placeholder="Masukkan deskripsi hero...">${fe.heroDescription||""}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        ${h()}
    `;let t=document.getElementById("hero-title-input"),a=document.getElementById("hero-desc-input"),o=document.getElementById("preview-title"),n=document.getElementById("preview-desc");t&&o&&t.addEventListener("input",()=>{o.innerHTML=t.value||'<span class="text-gray-600">[Judul Kosong]</span>'}),a&&n&&a.addEventListener("input",()=>{n.textContent=a.value||"[Deskripsi Kosong]"}),window.__saveLandingConfig=async()=>{let r=t?.value.trim(),i=a?.value.trim();if(!r||!i){u.warning("Teks judul dan deskripsi tidak boleh kosong.");return}try{await ut({heroTitle:r,heroDescription:i}),u.success("Landing page settings berhasil disimpan!")}catch(s){console.error(s),u.error("Gagal menyimpan landing page settings.")}}}var Q=[],R=new Set;async function Nt(){let e=document.getElementById("page-content");if(!M()){e.innerHTML=`
            <div class="pt-24 pb-8 px-4">
                <div class="max-w-3xl mx-auto text-center py-20">
                    <p class="text-6xl mb-4">\u{1F512}</p>
                    <h2 class="text-2xl font-bold text-white mb-2" style="font-family: 'Lilita One', cursive;">Access Denied</h2>
        ...
        `;return}Q=await $(),R.clear();let t=D();e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header & Back Button -->
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10 animate-on-scroll">
        ...
        ${h()}
    `,window.__filterSideMembers=Ma,window.__selectAllSideMembers=Ea,window.__toggleSideMemberSelection=Aa,window.__resetSideSelectedMembers=Wt,window.__fillSidePreset=Da,window.__submitSidePoints=()=>Ia(t),window.__deleteLogEntry=a=>Ha(a,t),setTimeout(()=>{qe(t),se()},100)}function se(){let e=document.getElementById("side-members-container"),t=document.getElementById("side-selected-container"),a=document.getElementById("side-selected-count");if(!e||!t)return;let o=document.getElementById("side-member-search")?.value.toLowerCase()||"",n=Q.filter(i=>!R.has(i.tag));e.innerHTML=n.map(i=>{let l=i.name.toLowerCase().includes(o)||i.tag.toLowerCase().includes(o)?"flex":"none";return`
            <label class="point-member-row flex items-center gap-3 p-2 rounded-lg hover:bg-white/5 cursor-pointer transition-colors" 
                   data-name="${i.name}" data-tag="${i.tag}" style="display: ${l};">
        ...
        `}).join(""),n.length===0&&(e.innerHTML='<p class="text-center text-gray-500 text-xs py-8">Semua anggota terpilih</p>');let r=Q.filter(i=>R.has(i.tag));t.innerHTML=r.map(i=>`
        ...
        `).join(""),r.length===0&&(t.innerHTML='<p class="text-center text-gray-500 text-xs py-8">Belum ada yang dipilih</p>'),a&&(a.textContent=r.length)}function Ma(){se()}function Ea(e){if(e){let t=document.getElementById("side-member-search")?.value.toLowerCase()||"";Q.forEach(a=>{R.has(a.tag)||(a.name.toLowerCase().includes(t)||a.tag.toLowerCase().includes(t))&&R.add(a.tag)})}else R.clear();se()}function Aa(e,t){t?R.add(e):R.delete(e),se()}function Wt(){R.clear();let e=document.getElementById("side-member-search");e&&(e.value="");let t=document.querySelector('input[name="side-point-target"][value="selected"]');t&&(t.checked=!0),se()}function Da(){let e=document.getElementById("side-preset");if(!e||!e.value)return;let t=document.getElementById("side-amount");t&&(t.value=e.value)}async function Ia(e){let t=document.querySelector('input[name="side-point-target"]:checked')?.value||"selected",a=[];t==="selected"?a=Array.from(R):a=Q.filter(s=>!R.has(s.tag)).map(s=>s.tag);let o=parseInt(document.getElementById("side-amount")?.value),n=document.getElementById("side-reason")?.value;if(a.length===0){u.warning(t==="selected"?"Mohon pilih minimal satu anggota di daftar kanan.":"Tidak ada anggota tersisa di daftar kiri.");return}if(isNaN(o)||!n){u.warning("Mohon lengkapi semua field.");return}let r=a.map(s=>Q.find(l=>l.tag===s)).filter(Boolean),i=r.map(s=>s.name).join(", ");F.confirm({title:"Konfirmasi Kelola Side Points",message:`Apakah Anda yakin ingin ${o>0?"menambah":"mengurangi"} <strong>${Math.abs(o)}</strong> side points untuk <strong>${r.length} anggota</strong> (${t==="selected"?"Daftar Kanan":"Daftar Kiri"})?<br><br>Anggota: <i>${i}</i><br><br>Alasan: ${n}`,onConfirm:async()=>{try{for(let s of r)await st({memberTag:s.tag,memberName:s.name,amount:o,reason:n,category:"side_point",adminName:e?.displayName||"Admin"});u.success(`Side points berhasil ${o>0?"ditambahkan":"dikurangi"} untuk ${r.length} anggota!`),document.getElementById("side-amount").value="",document.getElementById("side-reason").value="",document.getElementById("side-preset").value="",Wt(),Q=await $(),se(),qe(e)}catch(s){u.error("Gagal menyimpan side points."),console.error(s)}}})}async function qe(e){let t=document.getElementById("admin-sidepoint-logs");if(t)try{let o=(await W()).filter(n=>n.category==="side_point");if(o.length===0){t.innerHTML='<p class="text-center text-gray-500 text-sm py-6">Belum ada riwayat perubahan side points.</p>';return}t.innerHTML=o.map(n=>{let r=oe(ne(n.date)),i=(n.amount||0)>=0,s=i?"bg-blue-500/20 text-blue-400 border border-blue-500/30":"bg-indigo-500/20 text-indigo-400 border border-indigo-500/30";return`
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl border border-white/5 bg-white/5 hover:bg-white/10 transition-all duration-200">
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 flex-wrap">
            ...
            `}).join("")}catch(a){console.error(a),t.innerHTML='<p class="text-center text-red-400 text-sm py-6">Gagal memuat log side points.</p>'}}async function Ha(e,t){F.confirm({title:"Hapus Log Side Points",message:"Apakah Anda yakin ingin menghapus log side points ini? Tindakan ini tidak mengembalikan nilai side points anggota.",onConfirm:async()=>{try{await _e(e),u.success("Log side points berhasil dihapus!"),qe(t)}catch(a){console.error(a),u.error("Gagal menghapus log.")}}})}async function Ut(){let e=document.getElementById("page-content");e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <div class="mb-8">
                    <div class="h-8 bg-white/10 rounded w-48 mb-2 animate-pulse"></div>
    ...
    `;let t=await te();e.innerHTML=`
        ...
        ${h()}
    `;let a="home",o="all",n="all",r="all",i="all",s=1,l=9;window.__filterLayouts=()=>{let d=document.getElementById("layout-search")?.value.toLowerCase()||"",m=document.getElementById("layouts-grid");if(!m)return;let g=t.filter(b=>{let j=b.title.toLowerCase().includes(d),B=(b.category||"home")===a,_=n==="all"||parseInt(b.townHallLevel)===parseInt(n),T=!0;a==="home"&&(T=r==="all"||(b.type||"war")===r);let G=!0;a==="capital"&&(G=o==="all"||(b.district||"capital_peak")===o);let f=i==="all"||parseInt(b.rating||5)>=parseInt(i);return j&&B&&_&&T&&G&&f}),p=document.getElementById("pagination-container");if(g.length===0){m.innerHTML=`
                <div class="col-span-full py-16">
                    ${U("\u{1F5FA}\uFE0F","Layout Tidak Ditemukan","Cobalah mengubah filter atau pencarian Anda.")}
                </div>
            `,p&&(p.innerHTML="");return}let v=Math.ceil(g.length/l);s>v&&(s=v),s<1&&(s=1);let k=(s-1)*l,E=g.slice(k,k+l);if(m.innerHTML=E.map(b=>{let j=b.category==="builder"?"BH":b.category==="capital"?b.district==="capital_peak"?"CH":"Lvl":"TH",_={15:"from-blue-500 to-indigo-600",16:"from-purple-500 to-indigo-700",17:"from-amber-500 to-yellow-600",18:"from-red-500 to-rose-600"}[b.townHallLevel]||"from-gray-600 to-gray-700",T={war:"\u2694\uFE0F War Base",farming:"\u{1F69C} Farming Base",trophy:"\u{1F3C6} Trophy Base",hybrid:"\u{1F9EC} Hybrid Base",defense:"\u{1F6E1}\uFE0F Defense Base",anti_2:"\u{1F6E1}\uFE0F Anti 2 Stars Base",anti_3:"\u{1F6E1}\uFE0F Anti 3 Stars Base",anti_air:"\u{1F388} Anti Air Base",anti_ground:"\u{1F30B} Anti Ground Base",fun:"\u{1F3A8} Fun Base",progress:"\u{1F4C8} Progress Base",troll:"\u{1F61C} Troll Base"},G={capital_peak:"Puncak Ibu Kota",barbarian_camp:"Perkemahan Barbar",wizard_valley:"Lembah Penyihir",balloon_lagoon:"Laguna Balon",builders_workshop:"Bengkel Tukang",dragon_cliffs:"Tebing Naga",golem_quarry:"Tambang Golem",skeleton_park:"Taman Rangka",goblin_mines:"Tambang Goblin"},f="";b.category==="home"?f=`
                ...
                `:b.category==="capital"&&(f=`
                    <span class="absolute top-3 right-3 px-2.5 py-1 rounded-full text-[10px] font-bold text-sky-400 bg-black/60 backdrop-blur-sm shadow-md border border-sky-500/20">
                        ${G[b.district||"capital_peak"]||"Ibu Kota"}
                    </span>
                `);let ye="\u2B50".repeat(b.rating||5);return`
                <div class="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm overflow-hidden 
                    ...
                    <div class="relative h-48 sm:h-52 w-full overflow-hidden bg-slate-800 shrink-0">
                        ...
                        <span class="absolute top-3 left-3 px-3 py-1 rounded-full text-xs font-bold text-white bg-gradient-to-r ${_} shadow-md">
                            ${j} ${b.townHallLevel}
                        </span>
                        ${f}
                    </div>
                    ...
                    <div class="p-5 flex-1 flex flex-col justify-between">
                        <div class="mb-5">
                            <div class="flex items-center justify-between gap-2 mb-2">
                                <span class="text-xs text-yellow-500 font-bold">${ye}</span>
                            </div>
            ...
            `}).join(""),p)if(v<=1)p.innerHTML="";else{let b="";b+=`
                ...
                `;let j=5,B=Math.max(1,s-Math.floor(j/2)),_=Math.min(v,B+j-1);_-B+1<j&&(B=Math.max(1,_-j+1)),B>1&&(b+=`
                    ...
                    `,B>2&&(b+='<span class="text-gray-500 text-xs px-1">...</span>'));for(let T=B;T<=_;T++)b+=`
                        <button onclick="window.__setPage(${T})" 
                                class="w-9 h-9 rounded-xl text-xs font-bold transition-all ${T===s?"bg-amber-500 text-black shadow-md shadow-amber-500/20":"border border-white/10 bg-white/5 text-gray-400 hover:text-white hover:bg-white/10"}">
                            ${T}
                        </button>
                    `;_<v&&(_<v-1&&(b+='<span class="text-gray-500 text-xs px-1">...</span>'),b+=`
                        <button onclick="window.__setPage(${v})" 
                                class="w-9 h-9 rounded-xl text-xs font-bold transition-all border border-white/10 bg-white/5 text-gray-400 hover:text-white hover:bg-white/10">
                            ${v}
                        </button>
                    `),b+=`
                    <button onclick="window.__setPage(${s+1})" ${s===v?"disabled":""} 
                            class="px-4 py-2.5 rounded-xl text-xs font-bold border border-white/10 bg-white/5 text-gray-300 hover:text-white hover:bg-white/10 disabled:opacity-40 disabled:cursor-not-allowed transition-all">
                        Next \u2192
                    </button>
                `,p.innerHTML=b}},window.__shareLayout=d=>{navigator.clipboard.writeText(d).then(()=>{u.success("Link layout base berhasil disalin ke clipboard!")}).catch(m=>{u.error("Gagal menyalin link.")})},window.__setCategoryFilter=d=>{a=d,n="all",o="all",r="all",i="all",["home","builder","capital"].forEach(v=>{let k=document.getElementById(`tab-cat-${v}`);k&&(v===d?k.className="px-6 py-3.5 text-sm font-bold border-b-2 border-amber-500 text-amber-400 transition-all flex items-center gap-2":k.className="px-6 py-3.5 text-sm font-bold border-b-2 border-transparent text-gray-400 hover:text-white transition-all flex items-center gap-2")});let g=document.getElementById("type-filter-container"),p=document.getElementById("district-filter-container");d==="home"?(g?.classList.remove("hidden"),p?.classList.add("hidden")):d==="builder"?(g?.classList.add("hidden"),p?.classList.add("hidden")):d==="capital"&&(g?.classList.add("hidden"),p?.classList.remove("hidden")),window.__setTypeFilter("all"),window.__setDistrictFilter("all"),window.__setRatingFilter("all"),c(),window.__filterLayouts()},window.__setLevelFilter=d=>{n=d,s=1,document.querySelectorAll(".lvl-filter-btn").forEach(g=>{g.dataset.lvl===String(d)?g.className="lvl-filter-btn px-3 py-1.5 rounded-lg text-xs font-bold text-black bg-amber-500 transition-all shadow-md":g.className="lvl-filter-btn px-3 py-1.5 rounded-lg text-xs font-bold text-gray-400 bg-white/5 border border-white/10 hover:bg-white/10 transition-all"}),window.__filterLayouts()},window.__setTypeFilter=d=>{r=d,s=1,["all","war","farming","trophy","hybrid","defense","anti_2","anti_3","anti_air","anti_ground","fun","progress","troll"].forEach(g=>{let p=document.getElementById(`btn-type-${g}`);p&&(g===d?p.className="px-3.5 py-1.5 rounded-lg text-xs font-bold text-black bg-amber-500 transition-all shadow-md":p.className="px-3.5 py-1.5 rounded-lg text-xs font-bold text-gray-400 bg-white/5 border border-white/10 hover:bg-white/10 transition-all")}),window.__filterLayouts()},window.__setDistrictFilter=d=>{o=d,n="all",s=1,["all","capital_peak","barbarian_camp","wizard_valley","balloon_lagoon","builders_workshop","dragon_cliffs","golem_quarry","skeleton_park","goblin_mines"].forEach(g=>{let p=document.getElementById(`btn-dist-${g}`);p&&(g===d?p.className="px-3.5 py-1.5 rounded-lg text-xs font-bold text-black bg-amber-500 transition-all shadow-md":p.className="px-3.5 py-1.5 rounded-lg text-xs font-bold text-gray-400 bg-white/5 border border-white/10 hover:bg-white/10 transition-all")}),c(),window.__filterLayouts()},window.__setRatingFilter=d=>{i=d,s=1,["all","5","4","3"].forEach(g=>{let p=document.getElementById(`btn-rating-${g}`);p&&(g===d?p.className="px-3.5 py-1.5 rounded-lg text-xs font-bold text-black bg-amber-500 transition-all shadow-md":p.className="px-3.5 py-1.5 rounded-lg text-xs font-bold text-gray-400 bg-white/5 border border-white/10 hover:bg-white/10 transition-all")}),window.__filterLayouts()};function c(){let d=document.getElementById("level-filters-container");if(!d)return;let m=t.filter(k=>{let E=(k.category||"home")===a,b=!0;return a==="capital"&&(b=o==="all"||(k.district||"capital_peak")===o),E&&b}),g=Array.from(new Set(m.map(k=>parseInt(k.townHallLevel)))).sort((k,E)=>E-k),p=a==="builder"?"BH":a==="capital"?o==="capital_peak"?"CH":o==="all"?"Lvl/CH":"Lvl":"TH",v=`
        ...
        `;v+=g.map(k=>`
            <button onclick="window.__setLevelFilter('${k}')" data-lvl="${k}"
        ...
        `).join(""),d.innerHTML=v}window.__setPage=d=>{s=d,window.__filterLayouts(),document.getElementById("layouts-grid")?.scrollIntoView({behavior:"smooth",block:"start"})},c(),window.__filterLayouts()}var le=[],de=null;async function qt(){let e=document.getElementById("page-content");if(!M()){e.innerHTML=`
            <div class="pt-24 pb-8 px-4">
                <div class="max-w-3xl mx-auto text-center py-20">
                    <p class="text-6xl mb-4">\u{1F512}</p>
                    <h2 class="text-2xl font-bold text-white mb-2" style="font-family: 'Lilita One', cursive;">Access Denied</h2>
    ...
    `;try{le=await te()}catch(t){console.error(t),u.error("Gagal memuat layouts.")}de=null,Ra(e)}function Ra(e){let t=D();e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header & Back Button -->
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        ${h()}
    `,window.__onCategoryChange=Pe,window.__updateLevelOptions=Ke,window.__submitLayoutForm=()=>Fa(t),window.__deleteLayout=a=>Na(a),window.__editLayout=a=>Oa(a),window.__cancelEdit=ze,window.__onFilterCategoryChange=ja,window.__filterAdminLayouts=Kt,Pe(),Me()}function ja(){let e=document.getElementById("layout-filter-category")?.value,t=document.getElementById("layout-filter-level");if(t){if(!e)t.innerHTML='<option value="">Semua Level</option>',t.value="",t.disabled=!0;else{t.disabled=!1;let a=18,o="TH";e==="builder"?(a=11,o="BH"):e==="capital"&&(a=10,o="CH");let n='<option value="">Semua Level</option>';for(let r=a;r>=1;r--)n+=`<option value="${r}">${o} ${r}</option>`;t.innerHTML=n}Kt()}}function Kt(){Me()}function Pe(){let e=document.getElementById("layout-form-category")?.value||"home",t=document.getElementById("type-select-container"),a=document.getElementById("district-select-container");!t||!a||(e==="home"?(t.classList.remove("hidden"),a.classList.add("hidden")):e==="builder"?(t.classList.add("hidden"),a.classList.add("hidden")):e==="capital"&&(t.classList.add("hidden"),a.classList.remove("hidden")),Ke())}function Ke(){let e=document.getElementById("layout-form-category")?.value||"home",t=document.getElementById("layout-form-district")?.value||"capital_peak",a=document.getElementById("layout-form-th"),o=document.getElementById("level-label");if(!a||!o)return;let n="";e==="home"?(o.textContent="Level Town Hall (TH)",n=Array.from({length:18},(r,i)=>18-i).map(r=>`
            <option value="${r}">Town Hall ${r}</option>
        `).join("")):e==="builder"?(o.textContent="Level Builder Hall (BH)",n=Array.from({length:11},(r,i)=>11-i).map(r=>`
            <option value="${r}">Builder Hall ${r}</option>
        `).join("")):e==="capital"&&(t==="capital_peak"?(o.textContent="Level Capital Hall (CH)",n=Array.from({length:10},(r,i)=>10-i).map(r=>`
                <option value="${r}">Capital Hall ${r}</option>
            `).join("")):(o.textContent="Level Distrik (1 - 5)",n=Array.from({length:5},(r,i)=>5-i).map(r=>`
                <option value="${r}">Level ${r}</option>
            `).join(""))),a.innerHTML=n}function Me(){let e=document.getElementById("admin-layouts-list");if(!e)return;if(le.length===0){e.innerHTML='<p class="text-center text-gray-500 text-sm py-8">Belum ada layout base klan.</p>';return}let t=document.getElementById("layout-filter-search")?.value.toLowerCase()||"",a=document.getElementById("layout-filter-category")?.value||"",o=document.getElementById("layout-filter-level")?.value||"",n=le;if(a&&(n=n.filter(c=>c.category===a)),o&&(n=n.filter(c=>c.townHallLevel===parseInt(o,10))),t&&(n=n.filter(c=>c.title.toLowerCase().includes(t))),n.length===0){e.innerHTML='<p class="text-center text-gray-500 text-sm py-8">Tidak ada layout base yang cocok dengan filter.</p>';return}let r={home:"Desa Asal",builder:"Desa Tukang",capital:"Clan Capital"},i={capital_peak:"Puncak Ibu Kota",barbarian_camp:"Perkemahan Barbar",wizard_valley:"Lembah Penyihir",balloon_lagoon:"Laguna Balon",builders_workshop:"Bengkel Tukang",dragon_cliffs:"Tebing Naga",golem_quarry:"Tambang Golem",skeleton_park:"Taman Rangka",goblin_mines:"Tambang Goblin"},s={war:"War Base",farming:"Farming Base",trophy:"Trophy Base",hybrid:"Hybrid Base",defense:"Defense Base",anti_2:"Anti 2 Stars Base",anti_3:"Anti 3 Stars Base",anti_air:"Anti Air Base",anti_ground:"Anti Ground Base",fun:"Fun Base",progress:"Progress Base",troll:"Troll Base"},l={home:"bg-emerald-500/20 text-emerald-400",builder:"bg-orange-500/20 text-orange-400",capital:"bg-sky-500/20 text-sky-400"};e.innerHTML=n.map(c=>{let d="\u2B50".repeat(c.rating||5),m=r[c.category||"home"],g="";c.category==="home"?g=`<span class="px-2 py-0.5 rounded text-[10px] font-bold text-gray-300 bg-white/10">${s[c.type||"war"]||"War"}</span>`:c.category==="capital"&&(g=`<span class="px-2 py-0.5 rounded text-[10px] font-bold text-sky-400 bg-sky-500/10">${i[c.district||"capital_peak"]||"Ibu Kota"}</span>`);let p=c.category==="builder"?"BH":c.category==="capital"?c.district==="capital_peak"?"CH":"Lvl":"TH";return`
            <div class="flex items-center gap-4 p-3 rounded-xl border border-white/5 bg-white/5 hover:bg-white/10 transition-all duration-200">
                <img src="${c.imageUrl}" alt="" class="w-16 h-16 rounded-lg object-cover bg-slate-800 shrink-0"
                     onerror="this.src='https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=100'">
                <div class="flex-1 min-w-0">
                    <p class="text-white font-medium text-sm truncate">${c.title}</p>
                    <div class="flex flex-wrap items-center gap-2 mt-1.5">
                        <span class="px-2 py-0.5 rounded text-[10px] font-bold ${l[c.category||"home"]}">${m}</span>
                        <span class="px-2 py-0.5 rounded text-[10px] font-bold text-white bg-blue-500">${p} ${c.townHallLevel}</span>
                        ${g}
                        <span class="text-[10px] text-yellow-500">${d}</span>
                    </div>
                </div>
                <div class="flex gap-1 shrink-0">
                    <button onclick="window.__editLayout('${c.id}')" class="p-2 text-amber-400 hover:text-amber-300 hover:bg-white/5 rounded-lg transition-colors" title="Edit Base">
                        \u270F\uFE0F
                    </button>
                    <a href="${c.link}" target="_blank" class="p-2 text-sky-400 hover:text-sky-300 hover:bg-white/5 rounded-lg transition-colors" title="Uji Coba Link">
                        \u{1F441}\uFE0F
                    </a>
                    <button onclick="window.__deleteLayout('${c.id}')" class="p-2 text-red-400 hover:text-red-300 hover:bg-white/5 rounded-lg transition-colors" title="Hapus Base">
                        \u{1F5D1}\uFE0F
                    </button>
                </div>
            </div>
        `}).join("")}function Oa(e){let t=le.find(a=>a.id===e);t&&(de=e,document.getElementById("form-title").innerHTML=`\u270F\uFE0F Edit Base: ${t.title}`,document.getElementById("submit-btn").innerHTML="Update Layout Base",document.getElementById("cancel-btn").classList.remove("hidden"),document.getElementById("layout-form-category").value=t.category||"home",Pe(),t.category==="capital"&&(document.getElementById("layout-form-district").value=t.district||"capital_peak",Ke()),document.getElementById("layout-form-th").value=t.townHallLevel,t.category==="home"&&(document.getElementById("layout-form-type").value=t.type||"war"),document.getElementById("layout-form-rating").value=t.rating||"5",document.getElementById("layout-form-title").value=t.title||"",document.getElementById("layout-form-link").value=t.link||"",document.getElementById("layout-form-image").value=t.imageUrl||"",document.getElementById("form-title").scrollIntoView({behavior:"smooth",block:"center"}))}function ze(){de=null,document.getElementById("form-title").innerHTML="\u2795 Tambah Base Baru",document.getElementById("submit-btn").innerHTML="Simpan Layout Base",document.getElementById("cancel-btn").classList.add("hidden"),document.getElementById("layout-form-title").value="",document.getElementById("layout-form-link").value="",document.getElementById("layout-form-image").value="",document.getElementById("layout-form-category").value="home",Pe()}async function Fa(e){let t=document.getElementById("layout-form-category").value,a=parseInt(document.getElementById("layout-form-th").value),o=parseInt(document.getElementById("layout-form-rating").value),n=document.getElementById("layout-form-title").value.trim(),r=document.getElementById("layout-form-link").value.trim(),i=document.getElementById("layout-form-image").value.trim();if(!n||!r||!i){u.warning("Mohon isi seluruh kolom input.");return}if(!r.startsWith("http://")&&!r.startsWith("https://")){u.warning("Tautan Salin Base harus berupa URL valid.");return}let s={title:n,townHallLevel:a,category:t,rating:o,link:r,imageUrl:i,lastUpdatedBy:e?.displayName||"Admin"};t==="home"?(s.type=document.getElementById("layout-form-type").value,s.district=""):t==="capital"?(s.type="",s.district=document.getElementById("layout-form-district").value):(s.type="",s.district="");try{de?(await gt(de,s),u.success("Layout base berhasil diperbarui!"),ze()):(await pt({...s,addedBy:e?.displayName||"Admin"}),u.success("Layout base baru berhasil disimpan!"),document.getElementById("layout-form-title").value="",document.getElementById("layout-form-link").value="",document.getElementById("layout-form-image").value=""),le=await te(),Me()}catch(l){console.error(l),u.error("Gagal memproses layout.")}}async function Na(e){F.confirm({title:"Hapus Layout Base",message:"Apakah Anda yakin ingin menghapus layout base ini dari daftar?",onConfirm:async()=>{try{await bt(e),u.success("Layout base berhasil dihapus!"),de===e&&ze(),le=await te(),Me()}catch(t){console.error(t),u.error("Gagal menghapus layout.")}}})}var me=[],ce=null;async function zt(){let e=document.getElementById("page-content");if(!M()){e.innerHTML=`
            <div class="pt-24 pb-8 px-4">
                <div class="max-w-3xl mx-auto text-center py-20">
                    <p class="text-6xl mb-4">\u{1F512}</p>
                    <h2 class="text-2xl font-bold text-white mb-2" style="font-family: 'Lilita One', cursive;">Access Denied</h2>
    ...
    `;try{me=await ae()}catch(t){console.error(t),u.error("Gagal memuat berita.")}ce=null,Wa(e)}function Wa(e){let t=D();e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header & Back Button -->
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        ${h()}
    `,window.__submitNewsForm=()=>qa(),window.__deleteNews=a=>Ka(a),window.__editNews=a=>Ua(a),window.__cancelEditNews=Gt,Ge()}function Ge(){let e=document.getElementById("admin-news-list");if(e){if(me.length===0){e.innerHTML='<p class="text-center text-gray-500 text-sm py-8">Belum ada berita Supercell yang ditambahkan.</p>';return}e.innerHTML=me.map(t=>{let a=t.videoUrl?'<span class="px-2 py-0.5 rounded text-[10px] font-bold text-red-400 bg-red-500/10">\u{1F3AC} Video</span>':"",o=t.externalLink?'<span class="px-2 py-0.5 rounded text-[10px] font-bold text-blue-400 bg-blue-500/10">\u{1F517} Article</span>':"";return`
        ...
        `}).join("")}}function Ua(e){let t=me.find(a=>a.id===e);t&&(ce=e,document.getElementById("form-title").innerHTML="\u270F\uFE0F Edit Berita",document.getElementById("submit-btn").innerHTML="Update Berita",document.getElementById("cancel-btn").classList.remove("hidden"),document.getElementById("news-form-title").value=t.title||"",document.getElementById("news-form-desc").value=t.description||"",document.getElementById("news-form-image").value=t.imageUrl||"",document.getElementById("news-form-video").value=t.videoUrl||"",document.getElementById("news-form-link").value=t.externalLink||"",document.getElementById("form-title").scrollIntoView({behavior:"smooth",block:"center"}))}function Gt(){ce=null,document.getElementById("form-title").innerHTML="\u2795 Tambah Berita Baru",document.getElementById("submit-btn").innerHTML="Simpan Berita",document.getElementById("cancel-btn").classList.add("hidden"),document.getElementById("news-form-title").value="",document.getElementById("news-form-desc").value="",document.getElementById("news-form-image").value="",document.getElementById("news-form-video").value="",document.getElementById("news-form-link").value=""}async function qa(){let e=document.getElementById("news-form-title")?.value.trim(),t=document.getElementById("news-form-desc")?.value.trim(),a=document.getElementById("news-form-image")?.value.trim(),o=document.getElementById("news-form-video")?.value.trim(),n=document.getElementById("news-form-link")?.value.trim();if(!e||!t||!a){u.warning("Mohon lengkapi Judul, Deskripsi, dan Link Gambar.");return}let r={title:e,description:t,imageUrl:a,videoUrl:o,externalLink:n},i=document.getElementById("submit-btn");i.disabled=!0,i.innerHTML="Menyimpan...";try{ce?(await ht(ce,r),u.success("Berita berhasil diperbarui!")):(await xt(r),u.success("Berita baru berhasil ditambahkan!")),me=await ae(),Gt(),Ge()}catch(s){console.error(s),u.error("Gagal menyimpan berita.")}finally{i.disabled=!1,i.innerHTML=ce?"Update Berita":"Simpan Berita"}}async function Ka(e){if(confirm("Apakah Anda yakin ingin menghapus berita ini?"))try{await ft(e),u.success("Berita berhasil dihapus!"),me=await ae(),Ge()}catch(t){console.error(t),u.error("Gagal menghapus berita.")}}var ve=[{id:"theme_war",name:"Combat Planning (War)",url:"assets/audio/theme_war.mp3"},{id:"theme_classic",name:"Classic Clash Theme",url:"assets/audio/theme_classic.mp3"}];function Vt(){if(document.getElementById("music-player-container"))return;let e=localStorage.getItem("sl_music_track")||ve[0].id,t=parseFloat(localStorage.getItem("sl_music_volume")??"0.4"),a=localStorage.getItem("sl_music_playing")!=="false",o=ve.find(f=>f.id===e)||ve[0],n=new Audio(o.url);n.loop=!0,n.volume=t;let r=document.createElement("div");r.id="music-player-container",r.className="fixed bottom-4 left-4 md:bottom-6 md:left-6 z-50 flex items-center gap-2 sm:gap-3 bg-[#111827]/90 border border-white/10 backdrop-blur-md px-3 py-2 sm:px-4 sm:py-2.5 rounded-full shadow-2xl transition-all duration-300 hover:border-amber-500/30 group",r.innerHTML=`
    ...
    `,document.body.appendChild(r);let i=document.getElementById("music-disc"),s=document.getElementById("music-eq"),l=document.getElementById("music-play-btn"),c=document.getElementById("play-icon"),d=document.getElementById("pause-icon"),m=document.getElementById("music-volume-btn"),g=document.getElementById("volume-icon"),p=document.getElementById("mute-icon"),v=document.getElementById("music-volume-slider"),k=document.getElementById("music-track-btn"),E=document.getElementById("music-track-dropdown"),b=document.getElementById("music-tooltip"),j=document.getElementById("track-name");function B(f){a=f,localStorage.setItem("sl_music_playing",f),f?(n.play().catch(ye=>{console.log("Autoplay blocked by browser. Waiting for interaction.")}),c.classList.add("hidden"),d.classList.remove("hidden"),i.classList.add("animate-[spin_6s_linear_infinite]"),s.classList.remove("opacity-0"),s.classList.add("opacity-100")):(n.pause(),c.classList.remove("hidden"),d.classList.add("hidden"),i.classList.remove("animate-[spin_6s_linear_infinite]"),s.classList.remove("opacity-100"),s.classList.add("opacity-0"))}function _(f){t=parseFloat(f),n.volume=t,v.value=t,localStorage.setItem("sl_music_volume",t),t===0?(g.classList.add("hidden"),p.classList.remove("hidden")):(p.classList.add("hidden"),g.classList.remove("hidden"))}l.addEventListener("click",()=>{B(!a),b.classList.remove("opacity-100","translate-y-0"),b.classList.add("opacity-0","translate-y-2")}),i.addEventListener("click",()=>{B(!a),b.classList.remove("opacity-100","translate-y-0"),b.classList.add("opacity-0","translate-y-2")}),v.addEventListener("input",f=>{_(f.target.value)});let T=t||.4;m.addEventListener("click",()=>{n.volume>0?(T=n.volume,_(0)):_(T)}),k.addEventListener("click",f=>{f.stopPropagation(),E.classList.toggle("hidden")}),document.addEventListener("click",()=>{E.classList.add("hidden")}),E.querySelectorAll("button[data-track-id]").forEach(f=>{f.addEventListener("click",ye=>{ye.stopPropagation();let ke=f.getAttribute("data-track-id"),Ee=ve.find(Ae=>Ae.id===ke);if(Ee){e=ke,localStorage.setItem("sl_music_track",ke);let Ae=a;n.src=Ee.url,j.textContent=Ee.name,E.querySelectorAll("button[data-track-id]").forEach(Je=>{Je.classList.remove("text-amber-400","font-bold","bg-white/5");let Ie=Je.querySelector("span:last-child");Ie&&Ie.textContent==="\u2714"&&Ie.remove()}),f.classList.add("text-amber-400","font-bold","bg-white/5");let De=document.createElement("span");De.className="text-[10px]",De.textContent="\u2714",f.appendChild(De),E.classList.add("hidden"),Ae&&B(!0)}})}),_(t);let G=()=>{a&&n.paused&&n.play().then(()=>{B(!0)}).catch(f=>{console.log("Autoplay check:",f)})};["click","scroll","mousemove","keydown","touchstart"].forEach(f=>{document.addEventListener(f,G,{once:!0,passive:!0})}),a&&B(!0)}if(!document.getElementById("music-eq-styles")){let e=document.createElement("style");e.id="music-eq-styles",e.textContent=`
        .eq-bar {
    ...
    `,document.head.appendChild(e)}var Jt=null,Yt="",za={"/":{render:Va,title:"Home"},"/dashboard":{render:Ja,title:"Dashboard"},"/members":{render:Ya,title:"Members"},"/leaderboard":{render:Xa,title:"Leaderboard"},"/wars":{render:Za,title:"War History"},"/statistics":{render:eo,title:"Statistics"},"/layouts":{render:ro,title:"Base Layouts"},"/rules":{render:to,title:"Clan Rules"},"/admin":{render:ao,title:"Admin Panel"},"/admin/rules":{render:oo,title:"Rules Settings"},"/admin/landing":{render:no,title:"Landing Settings"},"/admin/sidepoints":{render:io,title:"Manage Side Points"},"/admin/layouts":{render:so,title:"Manage Base Layouts"},"/admin/news":{render:lo,title:"Manage News"},"/login":{render:co,title:"Login"}};document.addEventListener("DOMContentLoaded",()=>{Ga()});async function Ga(){Jt=new Le("particles-canvas"),Jt.start(),Vt(),At((e,t)=>{we(),e&&Ve()==="/login"&&(window.location.hash="#/dashboard")}),Qt(),window.addEventListener("hashchange",Qt),console.log("\u2694\uFE0F StreetLourd initialized!")}function Ve(){return window.location.hash.slice(1)||"/"}function Qt(){let e=Ve();if(e.startsWith("/member/")){let a=e.replace("/member/","");Yt="/member/:tag",document.title="Member Detail \u2014 StreetLourd",Qa(a),we();return}let t=za[e];t?(Yt=e,document.title=`${t.title} \u2014 StreetLourd`,t.render()):window.location.hash="#/",we()}function we(){let e=document.getElementById("navbar-container");if(!e)return;let t=D(),a=Dt(),o=Ve(),n="#"+o;o.startsWith("/member/")&&(n="#/members"),e.innerHTML=Qe(n,t,a),Xe();let r=document.getElementById("logout-btn"),i=document.getElementById("mobile-logout-btn");r&&r.addEventListener("click",async()=>{await We(),window.location.hash="#/",we()}),i&&i.addEventListener("click",async()=>{await We(),window.location.hash="#/",we()})}async function Va(){let e=document.getElementById("page-content");e.style.opacity="0",e.innerHTML=await vt(),requestAnimationFrame(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="1"}),setTimeout(()=>{ie(),Bt()},100)}async function Ja(){let e=document.getElementById("page-content");await S(e,()=>Lt())}async function Ya(){let e=document.getElementById("page-content");await S(e,()=>$t())}async function Qa(e){let t=document.getElementById("page-content");await S(t,()=>_t(e))}async function Xa(){let e=document.getElementById("page-content");await S(e,()=>Ct())}async function Za(){let e=document.getElementById("page-content");await S(e,()=>St())}async function eo(){let e=document.getElementById("page-content");await S(e,()=>Tt())}async function to(){let e=document.getElementById("page-content");e.style.opacity="0",e.innerHTML=await Mt(),requestAnimationFrame(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="1"}),setTimeout(()=>ie(),100)}async function ao(){let e=document.getElementById("page-content");await S(e,()=>Ht())}async function oo(){let e=document.getElementById("page-content");await S(e,()=>Ot())}async function no(){let e=document.getElementById("page-content");await S(e,()=>Ft())}async function io(){let e=document.getElementById("page-content");await S(e,()=>Nt())}async function ro(){let e=document.getElementById("page-content");await S(e,()=>Ut())}async function so(){let e=document.getElementById("page-content");await S(e,()=>qt())}async function lo(){let e=document.getElementById("page-content");await S(e,()=>zt())}function co(){let e=D(),t=document.getElementById("page-content");if(e){window.location.hash="#/dashboard";return}t.innerHTML=`
        <div class="pt-24 pb-8 px-4">
    ...
    `,document.getElementById("google-login-btn")?.addEventListener("click",async()=>{let a=document.getElementById("google-login-btn");a.disabled=!0,a.innerHTML='<span class="animate-spin">\u23F3</span> Logging in...',await Et(),a.disabled=!1,a.innerHTML="Sign in with Google"})}
