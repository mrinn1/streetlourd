var M=[{id:"war_participation",label:"Ikut War",points:10,icon:"\u2694\uFE0F",category:"war"},{id:"used_both_attacks",label:"Menggunakan 2 Attack",points:10,icon:"\u{1F5E1}\uFE0F",category:"war"},{id:"three_stars",label:"3 Bintang",points:15,icon:"\u2B50",category:"war"},{id:"cwl_participation",label:"Ikut CWL",points:30,icon:"\u{1F3C6}",category:"cwl"},{id:"clan_games_complete",label:"Clan Games Selesai",points:20,icon:"\u{1F3AE}",category:"clangames"},{id:"donation_1000",label:"Donasi 1000",points:5,icon:"\u{1F381}",category:"donation"},{id:"clan_capital_active",label:"Clan Capital Aktif",points:10,icon:"\u{1F3F0}",category:"capital"}],T=[{id:"missed_attack_1",label:"Tidak Menggunakan Attack Pertama",points:-20,icon:"\u274C",category:"war"},{id:"missed_attack_2",label:"Tidak Menggunakan Attack Kedua",points:-15,icon:"\u26D4",category:"war"},{id:"missed_war_no_excuse",label:"Tidak Ikut War Tanpa Izin",points:-30,icon:"\u{1F6AB}",category:"war"},{id:"afk_too_long",label:"AFK Terlalu Lama",points:-10,icon:"\u{1F4A4}",category:"activity"},{id:"rule_violation",label:"Melanggar Aturan Clan",points:-25,icon:"\u26A0\uFE0F",category:"violation"}];var le=[{label:"Home",hash:"#/",icon:"\u{1F3E0}"},{label:"Members",hash:"#/members",icon:"\u{1F465}"},{label:"Leaderboard",hash:"#/leaderboard",icon:"\u{1F3C6}"},{label:"War History",hash:"#/wars",icon:"\u2694\uFE0F"},{label:"Statistics",hash:"#/statistics",icon:"\u{1F4CA}"},{label:"Clan Rules",hash:"#/rules",icon:"\u{1F4DC}"},{label:"Admin Panel",hash:"#/admin",icon:"\u2699\uFE0F",adminOnly:!0}];var $={gold:"rgba(245, 166, 35, 1)",purple:"rgba(168, 85, 247, 1)",blue:"rgba(59, 130, 246, 1)",green:"rgba(34, 197, 94, 1)",red:"rgba(239, 68, 68, 1)",cyan:"rgba(6, 182, 212, 1)",goldAlpha:"rgba(245, 166, 35, 0.2)",purpleAlpha:"rgba(168, 85, 247, 0.2)",blueAlpha:"rgba(59, 130, 246, 0.2)",greenAlpha:"rgba(34, 197, 94, 0.2)",redAlpha:"rgba(239, 68, 68, 0.2)",cyanAlpha:"rgba(6, 182, 212, 0.2)"};function de(e="#/",t=null,a=null){let r=a==="leader"||a==="coleader",o=le.filter(n=>!(n.adminOnly&&!r));return`
    ...
    `}function ce(){let e=document.getElementById("main-navbar");if(!e)return;let t=0;function a(){let c=window.scrollY,p=e.querySelector(".navbar-glass");p&&(c>60?p.classList.add("navbar-solid"):p.classList.remove("navbar-solid"),t=c)}window.addEventListener("scroll",a,{passive:!0}),a();let r=document.getElementById("mobile-menu-btn"),o=document.getElementById("mobile-menu"),n=document.getElementById("mobile-menu-panel"),s=document.getElementById("mobile-menu-close"),i=document.getElementById("mobile-menu-backdrop");function l(){!o||!n||(o.classList.remove("hidden"),requestAnimationFrame(()=>{n.classList.remove("translate-x-full"),n.classList.add("translate-x-0")}))}function d(){!o||!n||(n.classList.remove("translate-x-0"),n.classList.add("translate-x-full"),setTimeout(()=>o.classList.add("hidden"),300))}return r?.addEventListener("click",l),s?.addEventListener("click",d),i?.addEventListener("click",d),document.querySelectorAll(".mobile-nav-link").forEach(c=>{c.addEventListener("click",d)}),()=>{window.removeEventListener("scroll",a)}}var z=class{constructor(t="particles-canvas"){this.canvas=document.getElementById(t),this.canvas&&(this.ctx=this.canvas.getContext("2d"),this.particles=[],this.animationId=null,this.maxParticles=60,this.colors=["rgba(245, 166, 35, 0.4)","rgba(168, 85, 247, 0.3)","rgba(59, 130, 246, 0.3)","rgba(255, 215, 0, 0.2)","rgba(147, 51, 234, 0.2)"],this.resize(),window.addEventListener("resize",()=>this.resize()))}resize(){this.canvas&&(this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight)}createParticle(){return{x:Math.random()*this.canvas.width,y:this.canvas.height+Math.random()*100,size:Math.random()*3+1,speedY:-(Math.random()*.5+.2),speedX:(Math.random()-.5)*.3,opacity:Math.random()*.5+.1,color:this.colors[Math.floor(Math.random()*this.colors.length)],life:0,maxLife:Math.random()*300+200,pulse:Math.random()*Math.PI*2,pulseSpeed:Math.random()*.02+.01}}update(){for(;this.particles.length<this.maxParticles;)this.particles.push(this.createParticle());for(let t=this.particles.length-1;t>=0;t--){let a=this.particles[t];a.x+=a.speedX,a.y+=a.speedY,a.life++,a.pulse+=a.pulseSpeed;let r=a.life/a.maxLife;r<.1?a.currentOpacity=a.opacity*(r/.1):r>.8?a.currentOpacity=a.opacity*((1-r)/.2):a.currentOpacity=a.opacity,a.currentSize=a.size+Math.sin(a.pulse)*.5,(a.life>=a.maxLife||a.y<-20)&&this.particles.splice(t,1)}}draw(){if(this.ctx){this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);for(let t of this.particles)this.ctx.save(),this.ctx.globalAlpha=t.currentOpacity||t.opacity,this.ctx.fillStyle=t.color,this.ctx.shadowColor=t.color,this.ctx.shadowBlur=t.currentSize*4,this.ctx.beginPath(),this.ctx.arc(t.x,t.y,t.currentSize,0,Math.PI*2),this.ctx.fill(),this.ctx.restore()}}animate(){this.update(),this.draw(),this.animationId=requestAnimationFrame(()=>this.animate())}start(){this.canvas&&this.animate()}stop(){this.animationId&&(cancelAnimationFrame(this.animationId),this.animationId=null)}destroy(){this.stop(),this.particles=[],this.ctx&&this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height)}};function u(){return`
        ...
        <section class="relative py-20 px-4 overflow-hidden" id="stats-preview">
            ...
            <div class="max-w-7xl mx-auto relative">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 animate-on-scroll" data-stagger="true">
                    ${V("\u{1F465}","50+","Active Members")}
                    ${V("\u2694\uFE0F","200+","Wars Fought")}
                    ${V("\u2B50","1,500+","Total Stars")}
                    ${V("\u{1F3C6}","85%","Win Rate")}
                </div>
            </div>
        </section>
        ...
        <section class="relative py-20 px-4">
            <div class="max-w-5xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 animate-on-scroll" data-stagger="true">
                    ${Y("1","Login & Connect","Login dengan Google dan hubungkan akun Clash of Clans kamu.","from-amber-500 to-yellow-600")}
                    ${Y("2","Sync Members","Data anggota clan akan otomatis tersinkronisasi dari CoC API.","from-purple-500 to-violet-600")}
                    ${Y("3","Manage & Track","Input war, kelola poin, dan pantau statistik clan secara real-time.","from-blue-500 to-cyan-600")}
                </div>
            </div>
        </section>
    ...
    `}function V(e,t,a){return`
        <div class="animate-item text-center p-6 rounded-2xl border border-white/5 bg-white/5 backdrop-blur-sm 
            ...
            <p class="text-2xl md:text-3xl font-bold text-white" style="font-family: 'Lilita One', cursive;">${t}</p>
            <p class="text-xs text-gray-500 uppercase tracking-wider mt-1">${a}</p>
        </div>
    `}function Y(e,t,a,r){return`
        <div class="animate-item text-center">
            <div class="w-16 h-16 rounded-2xl bg-gradient-to-br ${r} flex items-center justify-center 
    ...
    `}function ue({name:e,tag:t,role:a,townHallLevel:r,trophies:o,donations:n,clanCapital:s,totalPoints:i,onClick:l}){let d={leader:"from-amber-500 to-yellow-600",coLeader:"from-purple-500 to-violet-600",admin:"from-blue-500 to-cyan-600",member:"from-gray-500 to-gray-600"},c={leader:"Leader",coLeader:"Co-Leader",admin:"Elder",member:"Member"},S={1:"#8B7355",2:"#CD853F",3:"#DAA520",4:"#B8860B",5:"#4169E1",6:"#FFD700",7:"#9370DB",8:"#DC143C",9:"#4B0082",10:"#FF4500",11:"#00CED1",12:"#1E90FF",13:"#228B22",14:"#32CD32",15:"#4169E1",16:"#8B008B",17:"#FFD700"}[r]||"#6b7280";return`
        <div class="group relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm 
            ...
            <div class="flex items-center gap-3 sm:gap-4">
                <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center text-sm font-bold text-white shrink-0"
                     style="background: linear-gradient(135deg, ${S}, ${S}99); box-shadow: 0 0 15px ${S}40;">
                    TH${r||"?"}
                </div>
    ...
    `}import{initializeApp as Ue}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-app.js";import{getAuth as ze}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js";import{getFirestore as qe}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js";import{getStorage as Ve}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-storage.js";var Q={apiKey:"AIzaSyCJvQDiM7JQ7n0si8UgI-lpVA7CgiVD8eA",authDomain:"victorytoclan.firebaseapp.com",projectId:"victorytoclan",storageBucket:"victorytoclan.firebasestorage.app",messagingSenderId:"762294306774",appId:"1:762294306774:web:601d43f7d499167e40c677"},G,P,b,Ge;try{G=Ue(Q),P=ze(G),b=qe(G),Ge=Ve(G),console.log("\u2705 Firebase initialized successfully")}catch(e){console.warn("\u26A0\uFE0F Firebase initialization failed:",e.message),console.warn("Please configure your Firebase project in js/config/firebase.js")}function x(){return Q.apiKey!=="YOUR_API_KEY"&&Q.projectId!=="YOUR_PROJECT_ID"}async function y(){return await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js")}async function f(){if(!x())return X();try{let{collection:e,getDocs:t,query:a,orderBy:r}=await y(),o=a(e(b,"members"),r("totalPoints","desc"));return(await t(o)).docs.map(s=>({id:s.id,...s.data()}))}catch(e){return console.error("getMembers:",e),X()}}async function be(e){if(!x())return X().find(t=>t.tag===e)||null;try{let{doc:t,getDoc:a}=await y(),r=await a(t(b,"members",e));return r.exists()?{id:r.id,...r.data()}:null}catch(t){return console.error("getMember:",t),null}}async function R(){if(!x())return ge();try{let{collection:e,getDocs:t,query:a,orderBy:r}=await y(),o=a(e(b,"wars"),r("date","desc"));return(await t(o)).docs.map(s=>({id:s.id,...s.data()}))}catch(e){return console.error("getWars:",e),ge()}}async function xe(e){if(!x())return;let{collection:t,addDoc:a,serverTimestamp:r}=await y();return await a(t(b,"wars"),{...e,createdAt:r()})}async function Z(e){if(!x())return;let{collection:t,addDoc:a,serverTimestamp:r,doc:o,runTransaction:n}=await y(),s=o(b,"members",e.memberTag);await n(b,async i=>{let l=await i.get(s);if(!l.exists())throw"Document does not exist!";let d=(l.data().totalPoints||0)+e.amount;d>1500&&(d=1500),i.update(s,{totalPoints:d})}),await a(t(b,"pointHistory"),{...e,date:r()})}async function he(e){if(!x())return;let{collection:t,addDoc:a,serverTimestamp:r}=await y();return await a(t(b,"promotions"),{...e,date:r()})}async function ve(e){if(!x())return;let{collection:t,addDoc:a,serverTimestamp:r}=await y();return await a(t(b,"violations"),{...e,date:r()})}function X(){return["DragonSlayer","WarMachine","ClashKing","QueenArcher","GoblinHero","WallBreaker","TH17Master","EliteWarrior","SuperWitch","IceGolem","LavaHound","ElectroDragon","YetiSmash","HeadHunter","InfernoTower","PhoenixRise","RoyalGhost","SneakyGoblin","SuperBowler","PartyWizard"].map((t,a)=>({tag:`#${String(2e3+a).padStart(4,"0")}ABC`,name:t,townHallLevel:Math.floor(Math.random()*7)+11,role:a===0?"leader":a<3?"coLeader":a<7?"admin":"member",trophies:Math.floor(Math.random()*2e3)+4e3,donations:Math.floor(Math.random()*5e3)+500,donationsReceived:Math.floor(Math.random()*3e3)+200,clanCapitalContributions:Math.floor(Math.random()*1e5)+1e4,totalPoints:Math.floor(Math.random()*300)+50,totalWars:Math.floor(Math.random()*50)+10,totalStars:Math.floor(Math.random()*100)+20,avgDestruction:Math.random()*30+70}))}function ge(){return["Dark Warriors","Storm Legion","Iron Wolves","Shadow Riders","Thunder Hawks"].map((t,a)=>({id:`war-${a}`,date:new Date(Date.now()-a*3*864e5).toISOString(),opponent:t,warSize:[15,20,25,30,40][a%5],result:["win","win","loss","win","draw"][a],clanStars:Math.floor(Math.random()*30)+20,opponentStars:Math.floor(Math.random()*30)+15,clanDestruction:Math.random()*20+80,opponentDestruction:Math.random()*30+60}))}async function I(){if(!x())return null;try{let{doc:e,getDoc:t}=await y(),a=await t(e(b,"settings","rules"));return a.exists()?a.data():null}catch(e){return console.error("getRules:",e),null}}async function fe(e){if(!x())return;let{doc:t,setDoc:a}=await y();await a(t(b,"settings","rules"),e)}function L(e){return e==null?"0":Number(e).toLocaleString("en-US")}function we(e){return e?(e instanceof Date?e:new Date(e)).toLocaleDateString("id-ID",{year:"numeric",month:"long",day:"numeric"}):"-"}function ye(e,t=300){let a;return function(...r){clearTimeout(a),a=setTimeout(()=>e.apply(this,r),t)}}function ke(e){let t={leader:{label:"Leader",bg:"from-yellow-500 to-amber-600",text:"text-black"},coLeader:{label:"Co-Leader",bg:"from-purple-500 to-violet-600",text:"text-white"},admin:{label:"Elder",bg:"from-blue-500 to-cyan-600",text:"text-white"},member:{label:"Member",bg:"from-gray-500 to-gray-600",text:"text-white"}},a=t[e]||t.member;return`<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-gradient-to-r ${a.bg} ${a.text}">${a.label}</span>`}async function $e(){let e=document.getElementById("page-content");e.innerHTML=`
    ...
    `;let[t,a]=await Promise.all([f(),R()]),r=t.length,o=[...t].sort((i,l)=>(l.donations||0)-(i.donations||0))[0],n=[...t].sort((i,l)=>(l.trophies||0)-(i.trophies||0))[0],s=[...t].sort((i,l)=>(l.totalWars||0)-(i.totalWars||0))[0];e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <!-- Header -->
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 animate-on-scroll" data-stagger="true">
                    ${H({icon:"\u{1F465}",label:"Total Members",value:L(r),color:"blue"})}
                    ${H({icon:"\u{1F381}",label:"Top Donator",value:o?.name||"-",color:"purple",subtitle:`${L(o?.donations||0)} donated`})}
                    ${H({icon:"\u{1F3C6}",label:"Top Player",value:n?.name||"-",color:"gold",glow:!0,subtitle:`${L(n?.trophies||0)} trophies`})}
                    ${H({icon:"\u{1F525}",label:"Most Active",value:s?.name||"-",color:"red",subtitle:`${s?.totalWars||0} wars joined`})}
                </div>
    ...
    `}function Je(e,t){let a=["\u{1F947}","\u{1F948}","\u{1F949}"],r=["text-amber-400","text-gray-300","text-orange-400"];return`
    ...
    `}function A(){let e=new IntersectionObserver(t=>{t.forEach(a=>{a.isIntersecting&&(a.target.classList.add("animate-visible"),a.target.dataset.stagger&&a.target.querySelectorAll(".animate-item").forEach((o,n)=>{o.style.transitionDelay=`${n*100}ms`,o.classList.add("animate-visible")}))})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});return document.querySelectorAll(".animate-on-scroll").forEach(t=>{e.observe(t)}),e}function Le(){let e=document.querySelectorAll("[data-parallax]");if(!e.length)return;let t=!1;function a(){t||(requestAnimationFrame(()=>{let r=window.scrollY;e.forEach(o=>{let n=parseFloat(o.dataset.parallax)||.5;o.style.transform=`translateY(${r*n}px)`}),t=!1}),t=!0)}return window.addEventListener("scroll",a,{passive:!0}),()=>window.removeEventListener("scroll",a)}async function k(e,t){e.style.opacity="0",e.style.transform="translateY(10px)",await new Promise(a=>setTimeout(a,200)),await t(),window.scrollTo({top:0,behavior:"instant"}),requestAnimationFrame(()=>{e.style.transition="opacity 0.4s ease, transform 0.4s ease",e.style.opacity="1",e.style.transform="translateY(0)"}),setTimeout(()=>A(),100)}var j=[],O=[],v=1,K=12;async function Ce(){let e=document.getElementById("page-content");e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <div class="mb-8"><div class="h-8 bg-white/10 rounded w-48 mb-2 animate-pulse"></div></div>
                <div class="grid gap-4">${h.repeat("memberCard",6)}</div>
            </div>
        </div>
    `,j=await f(),O=[...j],v=1,ee(e)}function ee(e){let t=Math.ceil(O.length/K),a=O.slice((v-1)*K,v*K),r=[...new Set(j.map(l=>l.townHallLevel))].sort((l,d)=>d-l);e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <!-- Header -->
                <div class="mb-8 animate-on-scroll">
                    ...
                    <p class="text-gray-400">Daftar anggota clan \xB7 ${j.length} members</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 animate-on-scroll" id="members-list" data-stagger="true">
                    ${a.length>0?a.map(l=>ue({name:l.name,tag:l.tag,role:l.role,townHallLevel:l.townHallLevel,trophies:l.trophies,donations:l.donations,clanCapital:l.clanCapitalContributions,totalPoints:l.totalPoints,onClick:`location.hash='#/member/${encodeURIComponent(l.tag)}'`})).join(""):E("\u{1F465}","Tidak ada member ditemukan","Coba ubah filter pencarian")}
                </div>
                ...
                <div class="flex items-center justify-center gap-2 animate-on-scroll" id="pagination">
                    <button class="px-4 py-2 rounded-xl text-sm font-medium transition-all
                                   ${v===1?"bg-white/5 text-gray-600 cursor-not-allowed":"bg-white/10 text-white hover:bg-white/20"}"
                            onclick="window.__membersPage(${v-1})" ${v===1?"disabled":""}>
                        \u2190 Prev
                    </button>
                    ${Ye(v,t)}
                    <button class="px-4 py-2 rounded-xl text-sm font-medium transition-all
                                   ${v===t?"bg-white/5 text-gray-600 cursor-not-allowed":"bg-white/10 text-white hover:bg-white/20"}"
                            onclick="window.__membersPage(${v+1})" ${v===t?"disabled":""}>
                        Next \u2192
                    </button>
                </div>
                `:""}
        ...
        ${u()}
    `;let o=document.getElementById("member-search"),n=document.getElementById("filter-th"),s=document.getElementById("filter-role"),i=ye(()=>{let l=o?.value.toLowerCase()||"",d=n?.value||"",c=s?.value||"";O=j.filter(p=>{let S=!l||p.name.toLowerCase().includes(l)||p.tag.toLowerCase().includes(l),Fe=!d||p.townHallLevel==d,Ne=!c||p.role===c;return S&&Fe&&Ne}),v=1,ee(e)},250);o?.addEventListener("input",i),n?.addEventListener("change",i),s?.addEventListener("change",i),window.__membersPage=l=>{let d=Math.ceil(O.length/K);l<1||l>d||(v=l,ee(e),window.scrollTo({top:0,behavior:"smooth"}))},setTimeout(()=>A(),50)}function Ye(e,t){let a=[],o=Math.max(1,e-Math.floor(2.5)),n=Math.min(t,o+5-1);n-o<4&&(o=Math.max(1,n-5+1));for(let s=o;s<=n;s++)a.push(`
        ...
        `);return a.join("")}async function Me(e){let t=document.getElementById("page-content");t.innerHTML=`<div class="pt-24 pb-8 px-4"><div class="max-w-5xl mx-auto">${h.profile()}</div></div>`;let a=decodeURIComponent(e),r=await be(a);if(!r){t.innerHTML=`
            <div class="pt-24 pb-8 px-4">
        ...
        `;return}let n={1:"#8B7355",2:"#CD853F",3:"#DAA520",4:"#B8860B",5:"#4169E1",6:"#FFD700",7:"#9370DB",8:"#DC143C",9:"#4B0082",10:"#FF4500",11:"#00CED1",12:"#1E90FF",13:"#228B22",14:"#32CD32",15:"#4169E1",16:"#8B008B",17:"#FFD700"}[r.townHallLevel]||"#6b7280",s="",i=r.totalPoints||0;if(r.role==="leader")s=`
        ...
        `}else if(r.role==="admin")if(i<1e3)s=`
            ...
            `}else{let d=Math.max(0,Math.min(100,(i-500)/750*100)),c=1250-i,p="";i<300?p=`
                <div class="flex items-center gap-4 p-5 rounded-2xl bg-red-500/10 border border-red-500/20">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex flex-wrap gap-4 text-sm text-gray-400">
                                <span class="flex items-center gap-1.5">\u{1F3C6} ${L(r.trophies)} trophies</span>
                                <span class="flex items-center gap-1.5">\u{1F381} ${L(r.donations)} donated</span>
                            </div>
                        </div>
        ...
        ${u()}
    `}async function Se(){let e=document.getElementById("page-content");e.innerHTML=`
        <div class="pt-24 pb-8 px-4"><div class="max-w-4xl mx-auto">
            <div class="mb-8"><div class="h-8 bg-white/10 rounded w-48 mb-2 animate-pulse"></div></div>
            ${h.repeat("leaderboardRow",10)}
        </div></div>
    `;let a=(await f()).filter(n=>n.role!=="leader").sort((n,s)=>(s.totalPoints||0)-(n.totalPoints||0)).slice(0,100);if(a.length===0){e.innerHTML=`
            <div class="pt-24 pb-8 px-4"><div class="max-w-4xl mx-auto">
                ${E("\u{1F3C6}","Belum Ada Data","Leaderboard akan muncul setelah data member tersedia")}
            </div></div>${u()}
        `;return}let r=a.slice(0,3),o=a.slice(3);e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-12 animate-on-scroll">
                    ...
                    <p class="text-gray-400">Top ${a.length} members berdasarkan total poin kontribusi</p>
                </div>
                ...
                <div class="rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm overflow-hidden animate-on-scroll">
                    <div class="px-6 py-4 border-b border-white/5">
                        <h3 class="text-sm font-bold text-gray-400 uppercase tracking-wider">Rankings #4 - #${a.length}</h3>
                    </div>
                    <div class="p-4 space-y-2" data-stagger="true">
                        ${o.map((n,s)=>D({rank:s+4,...n})).join("")}
                    </div>
                </div>
                `:""}
            </div>
        ...
        ${u()}
    `}async function Te(){let e=document.getElementById("page-content");e.innerHTML=`
        <div class="pt-24 pb-8 px-4"><div class="max-w-4xl mx-auto">
            <div class="mb-8"><div class="h-8 bg-white/10 rounded w-48 mb-2 animate-pulse"></div></div>
            ${h.repeat("warCard",5)}
        </div></div>
    `;let t=await R();if(t.length===0){e.innerHTML=`
            <div class="pt-24 pb-8 px-4"><div class="max-w-4xl mx-auto">
                ...
                ${E("\u2694\uFE0F","Belum Ada Data War","Data war akan muncul setelah admin menginput hasil war")}
            </div></div>${u()}
        `;return}let a=t.length,r=t.filter(i=>i.result==="win").length,o=t.filter(i=>i.result==="loss").length,n=t.filter(i=>i.result==="draw").length,s=a?Math.round(r/a*100):0;e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-4xl mx-auto">
                <!-- Header -->
                <div class="mb-8 animate-on-scroll">
                ...
                <div class="relative animate-on-scroll">
                    ...
                    <div class="space-y-6" data-stagger="true">
                        ${t.map((i,l)=>{let d=we(i.date);return`
                                <div class="animate-item relative flex gap-6 md:gap-8">
                                    ...
                                    <div class="flex-1 pb-2">
                                        ${pe({date:d,opponent:i.opponent,warSize:i.warSize,result:i.result,clanStars:i.clanStars,opponentStars:i.opponentStars,clanDestruction:i.clanDestruction,opponentDestruction:i.opponentDestruction})}
                                    </div>
                                </div>
                            `}).join("")}
                    </div>
        ...
        ${u()}
    `}var B=[];async function De(){B.forEach(r=>{try{r.destroy()}catch{}}),B=[];let e=document.getElementById("page-content");e.innerHTML=`
        <div class="pt-24 pb-8 px-4"><div class="max-w-7xl mx-auto">
            <div class="mb-8"><div class="h-8 bg-white/10 rounded w-48 mb-2 animate-pulse"></div></div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">${h.repeat("chart",4)}</div>
        </div></div>
    `;let[t,a]=await Promise.all([f(),R()]);e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <div class="mb-10 animate-on-scroll">
        ...
        ${u()}
    `,await Qe(),Xe(t),Ze(a),et(t),tt(t)}function Qe(){return new Promise(e=>{if(window.Chart){e();return}let t=setInterval(()=>{window.Chart&&(clearInterval(t),e())},100);setTimeout(()=>{clearInterval(t),e()},5e3)})}function Xe(e){let t=document.getElementById("chart-donations");if(!t||!window.Chart)return;let a=[...e].sort((o,n)=>(n.donations||0)-(o.donations||0)).slice(0,10),r=new Chart(t.getContext("2d"),{type:"bar",data:{labels:a.map(o=>o.name.substring(0,10)),datasets:[{label:"Donations",data:a.map(o=>o.donations||0),backgroundColor:$.purpleAlpha,borderColor:$.purple,borderWidth:1,borderRadius:8}]},options:Ee()});B.push(r)}function Ze(e){let t=document.getElementById("chart-wars");if(!t||!window.Chart)return;let a=e.filter(s=>s.result==="win").length,r=e.filter(s=>s.result==="loss").length,o=e.filter(s=>s.result==="draw").length,n=new Chart(t.getContext("2d"),{type:"doughnut",data:{labels:["Victories","Defeats","Draws"],datasets:[{data:[a,r,o],backgroundColor:[$.green,$.red,$.gold],borderColor:"#0a0e17",borderWidth:3,hoverOffset:8}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"65%",plugins:{legend:{labels:{color:"#94a3b8",font:{size:12},padding:16,usePointStyle:!0}},tooltip:{backgroundColor:"rgba(15,23,42,0.9)",titleColor:"#f1f5f9",bodyColor:"#cbd5e1",borderColor:"rgba(255,255,255,0.1)",borderWidth:1,cornerRadius:12,padding:12}},animation:{animateRotate:!0,animateScale:!0,duration:1200}}});B.push(n)}function et(e){let t=document.getElementById("chart-points");if(!t||!window.Chart)return;let a=[...e].sort((o,n)=>(n.totalPoints||0)-(o.totalPoints||0)).slice(0,10),r=new Chart(t.getContext("2d"),{type:"bar",data:{labels:a.map(o=>o.name.substring(0,10)),datasets:[{label:"Points",data:a.map(o=>o.totalPoints||0),backgroundColor:$.goldAlpha,borderColor:$.gold,borderWidth:1,borderRadius:8}]},options:{...Ee(),indexAxis:"y"}});B.push(r)}function tt(e){let t=document.getElementById("chart-th");if(!t||!window.Chart)return;let a={};e.forEach(i=>{let l=i.townHallLevel||0;a[l]=(a[l]||0)+1});let r=Object.keys(a).sort((i,l)=>i-l).map(i=>`TH${i}`),o=Object.keys(a).sort((i,l)=>i-l).map(i=>a[i]),n=o.map((i,l)=>`hsl(${l*30+200}, 70%, 55%)`),s=new Chart(t.getContext("2d"),{type:"doughnut",data:{labels:r,datasets:[{data:o,backgroundColor:n,borderColor:"#0a0e17",borderWidth:3}]},options:{responsive:!0,maintainAspectRatio:!1,cutout:"55%",plugins:{legend:{labels:{color:"#94a3b8",font:{size:11},padding:12,usePointStyle:!0}},tooltip:{backgroundColor:"rgba(15,23,42,0.9)",titleColor:"#f1f5f9",bodyColor:"#cbd5e1",cornerRadius:12,padding:12}}}});B.push(s)}function Ee(){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{backgroundColor:"rgba(15,23,42,0.9)",titleColor:"#f1f5f9",bodyColor:"#cbd5e1",borderColor:"rgba(255,255,255,0.1)",borderWidth:1,cornerRadius:12,padding:12}},scales:{x:{ticks:{color:"#64748b",font:{size:10}},grid:{color:"rgba(255,255,255,0.05)"},border:{color:"rgba(255,255,255,0.1)"}},y:{ticks:{color:"#64748b",font:{size:10}},grid:{color:"rgba(255,255,255,0.05)"},border:{color:"rgba(255,255,255,0.1)"}}},animation:{duration:1e3,easing:"easeOutQuart"}}}var at=["Semua perubahan poin memiliki alasan, nama admin, dan tanggal yang tercatat","Jika status Opt-In dan tidak menyerang, poin otomatis berkurang","Jika status Opt-Out atau Izin, tidak ada pengurangan poin","Leader dan Co-Leader berhak menambah/mengurangi poin manual","Riwayat poin dapat dilihat oleh semua anggota","Promosi direkomendasikan berdasarkan akumulasi poin","Setiap anggota wajib menghormati sesama anggota clan","Donasi yang aktif dan Clan Capital yang rajin akan mendapat poin tambahan"];async function Pe(){let e=await I(),t=e&&e.rewards?e.rewards:M,a=e&&e.punishments?e.punishments:T,r=e&&e.generalRules?e.generalRules:at;return`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header -->
                <div class="text-center mb-12 animate-on-scroll">
    ...
    `}var te=class{constructor(){this.container=null,this.toasts=[],this.init()}init(){this.container||(this.container=document.createElement("div"),this.container.id="toast-container",this.container.className="fixed top-20 right-4 z-[9999] flex flex-col gap-3 pointer-events-none",this.container.style.maxWidth="380px",this.container.style.width="100%",document.body.appendChild(this.container))}show(t,a="info",r=4e3){this.init();let o={success:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',error:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',warning:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z"/></svg>',info:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>'},n={success:"border-green-500/50 bg-green-500/10",error:"border-red-500/50 bg-red-500/10",warning:"border-amber-500/50 bg-amber-500/10",info:"border-blue-500/50 bg-blue-500/10"},s={success:"text-green-400",error:"text-red-400",warning:"text-amber-400",info:"text-blue-400"},i=document.createElement("div");return i.className=`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-xl border ${n[a]} backdrop-blur-xl text-white shadow-2xl toast-enter`,i.innerHTML=`
        ...
        `,document.body.appendChild(l),document.body.style.overflow="hidden",n.forEach((d,c)=>{let p=l.querySelector(`#modal-action-${c}`);p&&d.onClick&&p.addEventListener("click",()=>d.onClick(l))}),requestAnimationFrame(()=>{let d=l.querySelector(".modal-content-enter");d&&d.classList.add("modal-content-visible")}),this.activeModal=l,this.onClose=s,this._escHandler=d=>{d.key==="Escape"&&this.close()},document.addEventListener("keydown",this._escHandler),l}confirm({title:t,message:a,confirmLabel:r="Confirm",cancelLabel:o="Cancel",onConfirm:n,onCancel:s,danger:i=!1}){return this.show({title:t||"Konfirmasi",content:`<p class="text-gray-300">${a}</p>`,size:"sm",actions:[{label:o,class:"px-4 py-2 rounded-xl text-sm font-medium bg-white/10 hover:bg-white/20 text-white transition-all",onClick:()=>{this.close(),s&&s()}},{label:r,class:`px-4 py-2 rounded-xl text-sm font-bold text-white transition-all ${i?"bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700":"bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700"}`,onClick:()=>{this.close(),n&&n()}}]})}close(){if(this.activeModal){let t=this.activeModal.querySelector(".modal-content-visible");t&&(t.classList.remove("modal-content-visible"),t.classList.add("modal-content-exit"));let a=this.activeModal;setTimeout(()=>{a.remove(),document.body.style.overflow=""},200),this.activeModal=null}this._escHandler&&document.removeEventListener("keydown",this._escHandler),this.onClose&&(this.onClose(),this.onClose=null)}},re=new ae;window.__modalManager=re;var oe=null,C=null,ot=[];async function Re(){if(!x())return m.warning("Firebase belum dikonfigurasi. Silakan setup Firebase terlebih dahulu."),null;try{let{GoogleAuthProvider:e,signInWithPopup:t}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js"),a=new e,r=await t(P,a);return m.success(`Selamat datang, ${r.user.displayName}!`),r.user}catch(e){return e.code==="auth/popup-closed-by-user"?m.info("Login dibatalkan."):m.error(`Login gagal: ${e.message}`),console.error("Auth error:",e),null}}async function ne(){try{let{signOut:e}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js");await e(P),oe=null,C=null,m.info("Berhasil logout.")}catch(e){m.error("Logout gagal."),console.error("Sign out error:",e)}}function Ie(e){if(!x())return e(null,null),()=>{};let{onAuthStateChanged:t}=P.constructor.prototype;import("https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js").then(({onAuthStateChanged:a})=>{a(P,async r=>{oe=r,r?(C=await nt(r.uid),await it(r)):C=null,e(r,C),ot.forEach(o=>o(r,C))})})}async function nt(e){try{let{doc:t,getDoc:a}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js"),r=await a(t(b,"users",e));return r.exists()&&r.data().role||"member"}catch(t){return console.warn("Error fetching user role:",t),"member"}}async function it(e){try{let{doc:t,getDoc:a,setDoc:r,serverTimestamp:o}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js"),n=t(b,"users",e.uid);if(!(await a(n)).exists())await r(n,{uid:e.uid,email:e.email,displayName:e.displayName,photoURL:e.photoURL,role:"member",playerTag:"",createdAt:o(),lastLogin:o()});else{let{updateDoc:i}=await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js");await i(n,{lastLogin:o()})}}catch(t){console.warn("Error ensuring user doc:",t)}}function _(){return oe}function Ae(){return C}function J(){return C==="leader"||C==="coleader"}var W=[],w=null;async function Be(){let e=document.getElementById("page-content");if(!J()){e.innerHTML=`
            <div class="pt-24 pb-8 px-4">
        ...
        `;return}W=await f(),w=await I();let t=w&&w.rewards?w.rewards:M,a=_();e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 animate-on-scroll" data-stagger="true">
                    ...
                    <div class="animate-item rounded-2xl border border-amber-500/20 bg-gradient-to-br from-amber-500/10 to-yellow-600/5 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select id="point-member" class="admin-select">${ie()}</select>
                            </div>
                            <div>
                    ...
                    <div class="animate-item rounded-2xl border border-purple-500/20 bg-gradient-to-br from-purple-500/10 to-violet-600/5 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select id="viol-member" class="admin-select">${ie()}</select>
                            </div>
                            <div>
                    ...
                    <div class="animate-item rounded-2xl border border-blue-500/20 bg-gradient-to-br from-blue-500/10 to-cyan-600/5 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-xs text-gray-400 mb-1.5">Member</label>
                                <select id="role-member" class="admin-select">${ie()}</select>
                            </div>
                            <div>
        ...
        ${u()}
    `,window.__updatePointPresets=st,window.__fillPointPreset=lt,window.__submitPoints=()=>dt(a),window.__submitWar=()=>ct(a),window.__submitViolation=()=>mt(a),window.__submitRole=()=>ut(a)}function ie(){return W.map(e=>`<option value="${e.tag}">${e.name} (${e.tag})</option>`).join("")}function st(){let e=document.getElementById("point-type")?.value,t=document.getElementById("point-preset-container"),a=document.getElementById("point-preset");if(a)if(e==="manual")t.style.display="none";else{t.style.display="block";let r=w&&w.rewards?w.rewards:M,o=w&&w.punishments?w.punishments:T,n=e==="reward"?r:o;a.innerHTML='<option value="">-- Pilih Preset --</option>'+n.map(s=>`<option value="${s.points}" data-reason="${s.label}">${s.points>0?"+":""}${s.points} \u2014 ${s.label}</option>`).join("")}}function lt(){let t=document.getElementById("point-preset")?.selectedOptions[0];if(!t||!t.value)return;let a=document.getElementById("point-amount"),r=document.getElementById("point-reason");a&&(a.value=t.value),r&&(r.value=t.dataset.reason||"")}async function dt(e){let t=document.getElementById("point-member")?.value,a=parseInt(document.getElementById("point-amount")?.value),r=document.getElementById("point-reason")?.value,o=document.getElementById("point-category")?.value;if(!t||isNaN(a)||!r){m.warning("Mohon lengkapi semua field.");return}let n=W.find(s=>s.tag===t);re.confirm({title:"Konfirmasi",message:`${a>0?"Tambah":"Kurangi"} <strong>${Math.abs(a)}</strong> poin untuk <strong>${n?.name}</strong>?<br><br>Alasan: ${r}`,onConfirm:async()=>{try{await Z({memberTag:t,memberName:n?.name||"Unknown",amount:a,reason:r,category:o,adminName:e?.displayName||"Admin"}),m.success(`Poin berhasil ${a>0?"ditambahkan":"dikurangi"}!`),document.getElementById("point-amount").value="",document.getElementById("point-reason").value=""}catch(s){m.error("Gagal menyimpan poin."),console.error(s)}}})}async function ct(e){let t=parseInt(document.getElementById("war-size")?.value),a=document.getElementById("war-result")?.value,r=document.getElementById("war-opponent")?.value,o=parseInt(document.getElementById("war-our-stars")?.value)||0,n=parseInt(document.getElementById("war-enemy-stars")?.value)||0,s=parseFloat(document.getElementById("war-our-dest")?.value)||0,i=parseFloat(document.getElementById("war-enemy-dest")?.value)||0;if(!r){m.warning("Mohon isi nama lawan.");return}try{await xe({date:new Date().toISOString(),opponent:r,warSize:t,result:a,clanStars:o,opponentStars:n,clanDestruction:s,opponentDestruction:i,addedBy:e?.displayName||"Admin"}),m.success("Data war berhasil disimpan!"),document.getElementById("war-opponent").value="",document.getElementById("war-our-stars").value="",document.getElementById("war-enemy-stars").value="",document.getElementById("war-our-dest").value="",document.getElementById("war-enemy-dest").value=""}catch(l){m.error("Gagal menyimpan data war."),console.error(l)}}async function mt(e){let t=document.getElementById("viol-member")?.value,a=document.getElementById("viol-type")?.value,r=document.getElementById("viol-desc")?.value,o=parseInt(document.getElementById("viol-points")?.value)||0;if(!t||!r){m.warning("Mohon lengkapi semua field.");return}let n=W.find(s=>s.tag===t);try{await ve({memberTag:t,memberName:n?.name||"Unknown",type:a,description:r,pointsDeducted:o,adminName:e?.displayName||"Admin"}),o>0&&await Z({memberTag:t,memberName:n?.name||"Unknown",amount:-o,reason:`[${a}] ${r}`,category:"violation",adminName:e?.displayName||"Admin"}),m.success("Violation berhasil dicatat!"),document.getElementById("viol-desc").value="",document.getElementById("viol-points").value=""}catch(s){m.error("Gagal menyimpan violation."),console.error(s)}}async function ut(e){let t=document.getElementById("role-member")?.value,a=document.getElementById("role-new")?.value,r=document.getElementById("role-reason")?.value,o=W.find(n=>n.tag===t);if(!t||!a){m.warning("Mohon pilih member dan role.");return}try{await he({memberTag:t,memberName:o?.name||"Unknown",fromRole:o?.role||"member",toRole:a,reason:r||"Role updated",adminName:e?.displayName||"Admin"}),m.success(`Role ${o?.name} berhasil diubah ke ${a}!`),document.getElementById("role-reason").value=""}catch(n){m.error("Gagal mengubah role."),console.error(n)}}var g={rewards:[],punishments:[],generalRules:[]},pt=["Semua perubahan poin memiliki alasan, nama admin, dan tanggal yang tercatat","Jika status Opt-In dan tidak menyerang, poin otomatis berkurang","Jika status Opt-Out atau Izin, tidak ada pengurangan poin","Leader dan Co-Leader berhak menambah/mengurangi poin manual","Riwayat poin dapat dilihat oleh semua anggota","Promosi direkomendasikan berdasarkan akumulasi poin","Setiap anggota wajib menghormati sesama anggota clan","Donasi yang aktif dan Clan Capital yang rajin akan mendapat poin tambahan"];async function Oe(){let e=document.getElementById("page-content");if(!J()){e.innerHTML=`
            <div class="pt-24 pb-8 px-4">
                <div class="max-w-3xl mx-auto text-center py-20">
                    <p class="text-6xl mb-4">\u{1F512}</p>
                    <h2 class="text-2xl font-bold text-white mb-2" style="font-family: 'Lilita One', cursive;">Access Denied</h2>
    ...
    `;try{let t=await I();t?g={rewards:t.rewards||[],punishments:t.punishments||[],generalRules:t.generalRules||[]}:g={rewards:JSON.parse(JSON.stringify(M)),punishments:JSON.parse(JSON.stringify(T)),generalRules:[...pt]}}catch(t){console.error(t),m.error("Gagal mengambil data rules.")}N(e)}function N(e){e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header & Back Button -->
                    ...
                    <div class="lg:col-span-7 space-y-8">
                        ...
                        <div class="rounded-2xl border border-green-500/20 bg-gradient-to-br from-green-500/5 to-emerald-600/5 p-6 backdrop-blur-sm">
                            ...
                            <div id="rewards-container" class="space-y-4 mb-4">
                                ${g.rewards.map((t,a)=>He(a,t,"reward")).join("")}
                            </div>
                        ...
                        <div class="rounded-2xl border border-red-500/20 bg-gradient-to-br from-red-500/5 to-rose-600/5 p-6 backdrop-blur-sm">
                            ...
                            <div id="punishments-container" class="space-y-4 mb-4">
                                ${g.punishments.map((t,a)=>He(a,t,"punishment")).join("")}
                            </div>
        ...
        ${u()}
    `,window.__addGeneralRule=()=>{F(),g.generalRules.push(""),N(e)},window.__removeGeneralRule=t=>{F(),g.generalRules.splice(t,1),N(e)},window.__addPreset=t=>{F(),(t==="reward"?g.rewards:g.punishments).push({id:`${t}_${Date.now()}`,label:"",points:t==="reward"?10:-10,icon:t==="reward"?"\u2B50":"\u274C",category:"war"}),N(e)},window.__removePreset=(t,a)=>{F(),(a==="reward"?g.rewards:g.punishments).splice(t,1),N(e)},window.__saveRulesConfig=async()=>{if(F(),g.generalRules.some(r=>!r.trim())){m.warning("Teks aturan umum tidak boleh kosong.");return}let t=g.rewards.some(r=>!r.label.trim()||isNaN(r.points)),a=g.punishments.some(r=>!r.label.trim()||isNaN(r.points));if(t||a){m.warning("Semua label preset harus diisi dan poin harus berupa angka.");return}try{await fe(g),m.success("Rules & presets berhasil disimpan ke database!")}catch(r){console.error(r),m.error("Gagal menyimpan rules.")}}}function He(e,t,a){let r=a==="reward";return`
    ...
    `}function F(){let e=document.querySelectorAll(".general-rule-input");g.generalRules=Array.from(e).map(o=>o.value);let t=document.querySelectorAll(".preset-row"),a=[],r=[];t.forEach((o,n)=>{let s=o.dataset.type,i=o.querySelector(".preset-icon-input")?.value||"",l=o.querySelector(".preset-label-input")?.value||"",d=parseInt(o.querySelector(".preset-points-input")?.value)||0,c=o.querySelector(".preset-category-input")?.value||"war",p={id:`${s}_${n}_${Date.now()}`,icon:i,label:l,points:d,category:c};s==="reward"?a.push(p):r.push(p)}),g.rewards=a,g.punishments=r}var je=null,_e="",gt={"/":{render:xt,title:"Home"},"/dashboard":{render:ht,title:"Dashboard"},"/members":{render:vt,title:"Members"},"/leaderboard":{render:wt,title:"Leaderboard"},"/wars":{render:yt,title:"War History"},"/statistics":{render:kt,title:"Statistics"},"/rules":{render:$t,title:"Clan Rules"},"/admin":{render:Lt,title:"Admin Panel"},"/admin/rules":{render:Ct,title:"Rules Settings"},"/login":{render:Mt,title:"Login"}};document.addEventListener("DOMContentLoaded",()=>{bt()});async function bt(){je=new z("particles-canvas"),je.start(),Ie((e,t)=>{U(),e&&se()==="/login"&&(window.location.hash="#/dashboard")}),We(),window.addEventListener("hashchange",We),console.log("\u2694\uFE0F StreetLourd initialized!")}function se(){return window.location.hash.slice(1)||"/"}function We(){let e=se();if(e.startsWith("/member/")){let a=e.replace("/member/","");_e="/member/:tag",document.title="Member Detail \u2014 StreetLourd",ft(a),U();return}let t=gt[e];t?(_e=e,document.title=`${t.title} \u2014 StreetLourd`,t.render()):window.location.hash="#/",U()}function U(){let e=document.getElementById("navbar-container");if(!e)return;let t=_(),a=Ae(),r=se(),o="#"+r;r.startsWith("/member/")&&(o="#/members"),e.innerHTML=de(o,t,a),ce();let n=document.getElementById("logout-btn"),s=document.getElementById("mobile-logout-btn");n&&n.addEventListener("click",async()=>{await ne(),window.location.hash="#/",U()}),s&&s.addEventListener("click",async()=>{await ne(),window.location.hash="#/",U()})}async function xt(){let e=document.getElementById("page-content");e.style.opacity="0",e.innerHTML=me(),requestAnimationFrame(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="1"}),setTimeout(()=>{A(),Le()},100)}async function ht(){let e=document.getElementById("page-content");await k(e,()=>$e())}async function vt(){let e=document.getElementById("page-content");await k(e,()=>Ce())}async function ft(e){let t=document.getElementById("page-content");await k(t,()=>Me(e))}async function wt(){let e=document.getElementById("page-content");await k(e,()=>Se())}async function yt(){let e=document.getElementById("page-content");await k(e,()=>Te())}async function kt(){let e=document.getElementById("page-content");await k(e,()=>De())}async function $t(){let e=document.getElementById("page-content");e.style.opacity="0",e.innerHTML=await Pe(),requestAnimationFrame(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="1"}),setTimeout(()=>A(),100)}async function Lt(){let e=document.getElementById("page-content");await k(e,()=>Be())}async function Ct(){let e=document.getElementById("page-content");await k(e,()=>Oe())}function Mt(){let e=_(),t=document.getElementById("page-content");if(e){window.location.hash="#/dashboard";return}t.innerHTML=`
        <div class="pt-24 pb-8 px-4">
    ...
    `,document.getElementById("google-login-btn")?.addEventListener("click",async()=>{let a=document.getElementById("google-login-btn");a.disabled=!0,a.innerHTML='<span class="animate-spin">\u23F3</span> Logging in...',await Re(),a.disabled=!1,a.innerHTML="Sign in with Google"})}
