var V=[{id:"war_participation",label:"Ikut War",points:10,icon:"\u2694\uFE0F",category:"war"},{id:"used_both_attacks",label:"Menggunakan 2 Attack",points:10,icon:"\u{1F5E1}\uFE0F",category:"war"},{id:"three_stars",label:"3 Bintang",points:15,icon:"\u2B50",category:"war"},{id:"cwl_participation",label:"Ikut CWL",points:30,icon:"\u{1F3C6}",category:"cwl"},{id:"clan_games_complete",label:"Clan Games Selesai",points:20,icon:"\u{1F3AE}",category:"clangames"},{id:"donation_1000",label:"Donasi 1000",points:5,icon:"\u{1F381}",category:"donation"},{id:"clan_capital_active",label:"Clan Capital Aktif",points:10,icon:"\u{1F3F0}",category:"capital"}],X=[{id:"missed_attack_1",label:"Tidak Menggunakan Attack Pertama",points:-20,icon:"\u274C",category:"war"},{id:"missed_attack_2",label:"Tidak Menggunakan Attack Kedua",points:-15,icon:"\u26D4",category:"war"},{id:"missed_war_no_excuse",label:"Tidak Ikut War Tanpa Izin",points:-30,icon:"\u{1F6AB}",category:"war"},{id:"afk_too_long",label:"AFK Terlalu Lama",points:-10,icon:"\u{1F4A4}",category:"activity"},{id:"rule_violation",label:"Melanggar Aturan Clan",points:-25,icon:"\u26A0\uFE0F",category:"violation"}];var Ge=[{label:"Home",hash:"#/",icon:"\u{1F3E0}"},{label:"Members",hash:"#/members",icon:"\u{1F465}"},{label:"Leaderboard",hash:"#/leaderboard",icon:"\u{1F3C6}"},{label:"War History",hash:"#/wars",icon:"\u2694\uFE0F"},{label:"Statistics",hash:"#/statistics",icon:"\u{1F4CA}"},{label:"Base Layouts",hash:"#/layouts",icon:"\u{1F5FA}\uFE0F"},{label:"Clan Rules",hash:"#/rules",icon:"\u{1F4DC}"},{label:"Admin Panel",hash:"#/admin",icon:"\u2699\uFE0F",adminOnly:!0}];var N={gold:"rgba(245, 166, 35, 1)",purple:"rgba(168, 85, 247, 1)",blue:"rgba(59, 130, 246, 1)",green:"rgba(34, 197, 94, 1)",red:"rgba(239, 68, 68, 1)",cyan:"rgba(6, 182, 212, 1)",goldAlpha:"rgba(245, 166, 35, 0.2)",purpleAlpha:"rgba(168, 85, 247, 0.2)",blueAlpha:"rgba(59, 130, 246, 0.2)",greenAlpha:"rgba(34, 197, 94, 0.2)",redAlpha:"rgba(239, 68, 68, 0.2)",cyanAlpha:"rgba(6, 182, 212, 0.2)"};function Ve(e="#/",t=null,a=null){let o=a==="leader"||a==="coleader",n=Ge.filter(r=>!(r.adminOnly&&!o));return`
    ...
    `}import{initializeApp as qt}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-app.js";import{getAuth as Ut}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-auth.js";import{initializeFirestore as Kt}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js";import{getStorage as zt}from"https://www.gstatic.com/firebasejs/11.8.1/firebase-storage.js";var Ae={apiKey:"AIzaSyCJvQDiM7JQ7n0si8UgI-lpVA7CgiVD8eA",authDomain:"victorytoclan.firebaseapp.com",projectId:"victorytoclan",storageBucket:"victorytoclan.firebasestorage.app",messagingSenderId:"762294306774",appId:"1:762294306774:web:601d43f7d499167e40c677"},we,J,f,Gt;try{we=qt(Ae),J=Ut(we),f=Kt(we,{experimentalForceLongPolling:!0}),Gt=zt(we),console.log("\u2705 Firebase initialized successfully with long polling enabled")}catch(e){console.warn("\u26A0\uFE0F Firebase initialization failed:",e.message),console.warn("Please configure your Firebase project in js/config/firebase.js")}function y(){return Ae.apiKey!=="YOUR_API_KEY"&&Ae.projectId!=="YOUR_PROJECT_ID"}async function w(){return await import("https://www.gstatic.com/firebasejs/11.8.1/firebase-firestore.js")}async function _(){if(!y())return Ie();try{let{collection:e,getDocs:t,query:a,orderBy:o}=await w(),n=a(e(f,"members"),o("totalPoints","desc"));return(await t(n)).docs.map(i=>({id:i.id,...i.data()}))}catch(e){return console.error("getMembers:",e),Ie()}}async function et(e){if(!y())return Ie().find(t=>t.tag===e)||null;try{let{doc:t,getDoc:a}=await w(),o=await a(t(f,"members",e));return o.exists()?{id:o.id,...o.data()}:null}catch(t){return console.error("getMember:",t),null}}async function Z(){if(!y())return Xe();try{let{collection:e,getDocs:t,query:a,orderBy:o}=await w(),n=a(e(f,"wars"),o("date","desc"));return(await t(n)).docs.map(i=>({id:i.id,...i.data()}))}catch(e){return console.error("getWars:",e),Xe()}}async function tt(e){if(!y())return;let{collection:t,addDoc:a,serverTimestamp:o}=await w();return await a(t(f,"wars"),{...e,createdAt:o()})}async function at(e){if(!y())return ke();try{let{collection:t,getDocs:a,query:o,where:n}=await w(),r=o(t(f,"pointHistory"),n("memberTag","==",e)),s=(await a(r)).docs.map(l=>({id:l.id,...l.data()}));return s.sort((l,c)=>{let d=l.date?l.date.toDate?l.date.toDate():new Date(l.date):0;return(c.date?c.date.toDate?c.date.toDate():new Date(c.date):0)-d}),s}catch(t){return console.error("getPointHistory:",t),ke()}}async function He(e){if(!y())return;let{collection:t,addDoc:a,serverTimestamp:o,doc:n,runTransaction:r}=await w(),i=n(f,"members",e.memberTag);await r(f,async s=>{let l=await s.get(i);if(!l.exists())throw"Document does not exist!";let c=l.data(),d=c.totalPoints!==void 0?c.totalPoints:500,m=c.sidePoints||0,g=d+m+e.amount,p=g,v=0;g>1500&&(p=1500,v=g-1500),p<0&&(p=0),s.update(i,{totalPoints:p,sidePoints:v})}),await a(t(f,"pointHistory"),{...e,date:o()})}async function ot(e){if(!y())return;let{collection:t,addDoc:a,serverTimestamp:o,doc:n,runTransaction:r}=await w(),i=n(f,"members",e.memberTag);await r(f,async s=>{let l=await s.get(i);if(!l.exists())throw"Document does not exist!";let c=l.data(),d=c.totalPoints!==void 0?c.totalPoints:500,m=c.sidePoints||0,g=d+m+e.amount,p=g,v=0;g>1500&&(p=1500,v=g-1500),p<0&&(p=0),s.update(i,{totalPoints:p,sidePoints:v})}),await a(t(f,"pointHistory"),{...e,date:o()})}async function W(){if(!y())return ke();try{let{collection:e,getDocs:t,query:a,orderBy:o,limit:n}=await w(),r=a(e(f,"pointHistory"),o("date","desc"),n(150));return(await t(r)).docs.map(s=>({id:s.id,...s.data()}))}catch(e){return console.error("getAllPointHistory:",e),ke()}}async function Le(e){if(!y())return;let{doc:t,deleteDoc:a}=await w(),o=t(f,"pointHistory",e);await a(o)}async function nt(e){if(!y())return;let{collection:t,addDoc:a,serverTimestamp:o}=await w();return await a(t(f,"promotions"),{...e,date:o()})}async function it(e){if(!y())return;let{collection:t,addDoc:a,serverTimestamp:o}=await w();return await a(t(f,"violations"),{...e,date:o()})}async function rt(){if(!y())return{clanTag:"#2ABC123",clanName:"StreetLourd"};try{let{doc:e,getDoc:t}=await w(),a=await t(e(f,"settings","general"));return a.exists()?a.data():{clanTag:"",clanName:""}}catch(e){return console.error("getSettings:",e),{clanTag:"",clanName:""}}}function Ie(){return["DragonSlayer","WarMachine","ClashKing","QueenArcher","GoblinHero","WallBreaker","TH17Master","EliteWarrior","SuperWitch","IceGolem","LavaHound","ElectroDragon","YetiSmash","HeadHunter","InfernoTower","PhoenixRise","RoyalGhost","SneakyGoblin","SuperBowler","PartyWizard"].map((t,a)=>({tag:`#${String(2e3+a).padStart(4,"0")}ABC`,name:t,townHallLevel:Math.floor(Math.random()*7)+11,role:a===0?"leader":a<3?"coLeader":a<7?"admin":"member",trophies:Math.floor(Math.random()*2e3)+4e3,donations:Math.floor(Math.random()*5e3)+500,donationsReceived:Math.floor(Math.random()*3e3)+200,clanCapitalContributions:Math.floor(Math.random()*1e5)+1e4,totalPoints:Math.floor(Math.random()*300)+50,totalWars:Math.floor(Math.random()*50)+10,totalStars:Math.floor(Math.random()*100)+20,avgDestruction:Math.random()*30+70}))}function Xe(){return["Dark Warriors","Storm Legion","Iron Wolves","Shadow Riders","Thunder Hawks"].map((t,a)=>({id:`war-${a}`,date:new Date(Date.now()-a*3*864e5).toISOString(),opponent:t,warSize:[15,20,25,30,40][a%5],result:["win","win","loss","win","draw"][a],clanStars:Math.floor(Math.random()*30)+20,opponentStars:Math.floor(Math.random()*30)+15,clanDestruction:Math.random()*20+80,opponentDestruction:Math.random()*30+60}))}function ke(){return["Ikut War","3 Bintang","Donasi 1000","Clan Games","Tidak Attack"].map((t,a)=>({id:`ph-${a}`,amount:a===4?-20:[10,15,5,20][a],reason:t,category:"war",adminName:"Leader",date:new Date(Date.now()-a*2*864e5).toISOString()}))}async function ee(){if(!y())return null;try{let{doc:e,getDoc:t}=await w(),a=await t(e(f,"settings","rules"));return a.exists()?a.data():null}catch(e){return console.error("getRules:",e),null}}async function st(e){if(!y())return;let{doc:t,setDoc:a}=await w();await a(t(f,"settings","rules"),e)}async function $e(){if(!y())return{heroTitle:`<span class="hero-title-gradient">Lead Your Clan</span>
<br>
<span class="hero-title-gradient-2">To Victory</span>`,heroDescription:"Pantau kontribusi anggota, statistik war, sistem poin, dan rekomendasi kenaikan pangkat secara otomatis."};try{let{doc:e,getDoc:t}=await w(),a=await t(e(f,"settings","landing"));return a.exists()?a.data():{heroTitle:`<span class="hero-title-gradient">Lead Your Clan</span>
<br>
...
<span class="hero-title-gradient-2">To Victory</span>`,heroDescription:"Pantau kontribusi anggota, statistik war, sistem poin, dan rekomendasi kenaikan pangkat secara otomatis."}}}async function lt(e){if(!y())return;let{doc:t,setDoc:a}=await w();await a(t(f,"settings","landing"),e,{merge:!0})}async function te(){if(!y())return Ze();try{let{collection:e,getDocs:t,query:a,orderBy:o}=await w(),n=a(e(f,"layouts"),o("createdAt","desc"));return(await t(n)).docs.map(i=>({id:i.id,...i.data()}))}catch(e){console.error("getLayouts:",e);try{let{collection:t,getDocs:a}=await w(),n=(await a(t(f,"layouts"))).docs.map(r=>({id:r.id,...r.data()}));return n.sort((r,i)=>{let s=r.createdAt?r.createdAt.toDate?r.createdAt.toDate():new Date(r.createdAt):0;return(i.createdAt?i.createdAt.toDate?i.createdAt.toDate():new Date(i.createdAt):0)-s}),n}catch(t){return console.error("getLayouts fallback failed:",t),Ze()}}}async function dt(e){if(!y())return;let{collection:t,addDoc:a,serverTimestamp:o}=await w();return await a(t(f,"layouts"),{...e,createdAt:o()})}async function ct(e,t){if(!y())return;let{doc:a,updateDoc:o}=await w();await o(a(f,"layouts",e),t)}async function mt(e){if(!y())return;let{doc:t,deleteDoc:a}=await w();await a(t(f,"layouts",e))}function Ze(){return[{id:"demo-1",title:"TH18 Legend League War Base",townHallLevel:18,category:"home",type:"war",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH18-War-Demo",createdAt:new Date().toISOString()},{id:"demo-2",title:"TH16 Hybrid farming layout",townHallLevel:16,category:"home",type:"hybrid",rating:4,imageUrl:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH16-Hybrid-Demo",createdAt:new Date().toISOString()},{id:"demo-2b",title:"TH18 Anti 3-Star War Base",townHallLevel:18,category:"home",type:"anti_3",rating:5,imageUrl:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH18-Anti3-Demo",createdAt:new Date().toISOString()},{id:"demo-2c",title:"TH15 Heart Shape Fun Base",townHallLevel:15,category:"home",type:"fun",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH15-Fun-Demo",createdAt:new Date().toISOString()},{id:"demo-3",title:"BH10 Trophy Push Base",townHallLevel:10,category:"builder",type:"",rating:4,imageUrl:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=BH10-Demo",createdAt:new Date().toISOString()},{id:"demo-4",title:"Capital Peak Level 10 Base",townHallLevel:10,category:"capital",district:"capital_peak",type:"",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=CH10-Demo",createdAt:new Date().toISOString()},{id:"demo-5",title:"Barbarian Camp Level 5 Base",townHallLevel:5,category:"capital",district:"barbarian_camp",type:"",rating:4,imageUrl:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=BC5-Demo",createdAt:new Date().toISOString()}]}async function ut(){let[e,t,a]=await Promise.all([$e(),rt(),_()]),r=`https://link.clashofclans.com/en?action=OpenClanProfile&tag=%23${(t.clanTag||"#P0YVL80U").replace("#","")}`,i=a.filter(s=>s.role!=="leader").sort((s,l)=>(l.totalPoints||0)-(s.totalPoints||0)).slice(0,3);return`
    ...
    `,me=await _(),ce=[...me],T=1,Re(e)}function Re(e){let t=Math.ceil(ce.length/Be),a=ce.slice((T-1)*Be,T*Be),o=[...new Set(me.map(l=>l.townHallLevel))].sort((l,c)=>c-l);e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                <!-- Header -->
                ...
                <div class="flex items-center justify-center gap-2 animate-on-scroll" id="pagination">
                    <button class="px-4 py-2 rounded-xl text-sm font-medium transition-all
                                   ${T===1?"bg-white/5 text-gray-600 cursor-not-allowed":"bg-white/10 text-white hover:bg-white/20"}"
                            onclick="window.__membersPage(${T-1})" ${T===1?"disabled":""}>
                        \u2190 Prev
                    </button>
                    ${Yt(T,t)}
                    <button class="px-4 py-2 rounded-xl text-sm font-medium transition-all
                                   ${T===t?"bg-white/5 text-gray-600 cursor-not-allowed":"bg-white/10 text-white hover:bg-white/20"}"
                            onclick="window.__membersPage(${T+1})" ${T===t?"disabled":""}>
                        Next \u2192
                    </button>
                </div>
                `:""}
    ...
    `;try{let t=await ee();t?L={rewards:t.rewards||[],punishments:t.punishments||[],generalRules:t.generalRules||[]}:L={rewards:JSON.parse(JSON.stringify(V)),punishments:JSON.parse(JSON.stringify(X)),generalRules:[...ya]}}catch(t){console.error(t),u.error("Gagal mengambil data rules.")}ge(e)}function ge(e){e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header & Back Button -->
    ...
    `;try{be=await $e()}catch(t){console.error(t),u.error("Gagal mengambil data landing page.")}wa(e)}function wa(e){e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header & Back Button -->
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
    ...
    `,document.head.appendChild(e)}var Ft=null,Nt="",Da={"/":{render:Ia,title:"Home"},"/dashboard":{render:Ha,title:"Dashboard"},"/members":{render:Ra,title:"Members"},"/leaderboard":{render:ja,title:"Leaderboard"},"/wars":{render:Fa,title:"War History"},"/statistics":{render:Na,title:"Statistics"},"/layouts":{render:Ga,title:"Base Layouts"},"/rules":{render:Wa,title:"Clan Rules"},"/admin":{render:qa,title:"Admin Panel"},"/admin/rules":{render:Ua,title:"Rules Settings"},"/admin/landing":{render:Ka,title:"Landing Settings"},"/admin/sidepoints":{render:za,title:"Manage Side Points"},"/admin/layouts":{render:Va,title:"Manage Base Layouts"},"/login":{render:Ja,title:"Login"}};document.addEventListener("DOMContentLoaded",()=>{Aa()});async function Aa(){Ft=new ye("particles-canvas"),Ft.start(),jt(),Bt((e,t)=>{he(),e&&Ke()==="/login"&&(window.location.hash="#/dashboard")}),Wt(),window.addEventListener("hashchange",Wt),console.log("\u2694\uFE0F StreetLourd initialized!")}function Ke(){return window.location.hash.slice(1)||"/"}function Wt(){let e=Ke();if(e.startsWith("/member/")){let a=e.replace("/member/","");Nt="/member/:tag",document.title="Member Detail \u2014 StreetLourd",Oa(a),he();return}let t=Da[e];t?(Nt=e,document.title=`${t.title} \u2014 StreetLourd`,t.render()):window.location.hash="#/",he()}function he(){let e=document.getElementById("navbar-container");if(!e)return;let t=F(),a=Ct(),o=Ke(),n="#"+o;o.startsWith("/member/")&&(n="#/members"),e.innerHTML=Ve(n,t,a),Je();let r=document.getElementById("logout-btn"),i=document.getElementById("mobile-logout-btn");r&&r.addEventListener("click",async()=>{await Fe(),window.location.hash="#/",he()}),i&&i.addEventListener("click",async()=>{await Fe(),window.location.hash="#/",he()})}async function Ia(){let e=document.getElementById("page-content");e.style.opacity="0",e.innerHTML=await ut(),requestAnimationFrame(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="1"}),setTimeout(()=>{ne(),ht()},100)}async function Ha(){let e=document.getElementById("page-content");await P(e,()=>xt())}async function Ra(){let e=document.getElementById("page-content");await P(e,()=>ft())}async function Oa(e){let t=document.getElementById("page-content");await P(t,()=>vt(e))}async function ja(){let e=document.getElementById("page-content");await P(e,()=>yt())}async function Fa(){let e=document.getElementById("page-content");await P(e,()=>wt())}async function Na(){let e=document.getElementById("page-content");await P(e,()=>kt())}async function Wa(){let e=document.getElementById("page-content");e.style.opacity="0",e.innerHTML=await $t(),requestAnimationFrame(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="1"}),setTimeout(()=>ne(),100)}async function qa(){let e=document.getElementById("page-content");await P(e,()=>Pt())}async function Ua(){let e=document.getElementById("page-content");await P(e,()=>Et())}async function Ka(){let e=document.getElementById("page-content");await P(e,()=>Dt())}async function za(){let e=document.getElementById("page-content");await P(e,()=>At())}async function Ga(){let e=document.getElementById("page-content");await P(e,()=>Ht())}async function Va(){let e=document.getElementById("page-content");await P(e,()=>Rt())}function Ja(){let e=F(),t=document.getElementById("page-content");if(e){window.location.hash="#/dashboard";return}t.innerHTML=`
        <div class="pt-24 pb-8 px-4">
