...
<span class="hero-title-gradient-2">To Victory</span>`,heroDescription:"Pantau kontribusi anggota, statistik war, sistem poin, dan rekomendasi kenaikan pangkat secara otomatis."}}}async function lt(e){if(!w())return;let{doc:t,setDoc:a}=await y();await a(t(f,"settings","landing"),e,{merge:!0})}async function te(){if(!w())return Ze();try{let{collection:e,getDocs:t,query:a,orderBy:o}=await y(),n=a(e(f,"layouts"),o("createdAt","desc"));return(await t(n)).docs.map(i=>({id:i.id,...i.data()}))}catch(e){console.error("getLayouts:",e);try{let{collection:t,getDocs:a}=await y(),n=(await a(t(f,"layouts"))).docs.map(r=>({id:r.id,...r.data()}));return n.sort((r,i)=>{let s=r.createdAt?r.createdAt.toDate?r.createdAt.toDate():new Date(r.createdAt):0;return(i.createdAt?i.createdAt.toDate?i.createdAt.toDate():new Date(i.createdAt):0)-s}),n}catch(t){return console.error("getLayouts fallback failed:",t),Ze()}}}async function dt(e){if(!w())return;let{collection:t,addDoc:a,serverTimestamp:o}=await y();return await a(t(f,"layouts"),{...e,createdAt:o()})}async function ct(e,t){if(!w())return;let{doc:a,updateDoc:o}=await y();await o(a(f,"layouts",e),t)}async function mt(e){if(!w())return;let{doc:t,deleteDoc:a}=await y();await a(t(f,"layouts",e))}function Ze(){return[{id:"demo-1",title:"TH18 Legend League War Base",townHallLevel:18,category:"home",type:"war",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH18-War-Demo",createdAt:new Date().toISOString()},{id:"demo-2",title:"TH16 Hybrid farming layout",townHallLevel:16,category:"home",type:"hybrid",rating:4,imageUrl:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH16-Hybrid-Demo",createdAt:new Date().toISOString()},{id:"demo-2b",title:"TH18 Anti 3-Star War Base",townHallLevel:18,category:"home",type:"anti_3",rating:5,imageUrl:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH18-Anti3-Demo",createdAt:new Date().toISOString()},{id:"demo-2c",title:"TH15 Heart Shape Fun Base",townHallLevel:15,category:"home",type:"fun",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=TH15-Fun-Demo",createdAt:new Date().toISOString()},{id:"demo-3",title:"BH10 Trophy Push Base",townHallLevel:10,category:"builder",type:"",rating:4,imageUrl:"https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=BH10-Demo",createdAt:new Date().toISOString()},{id:"demo-4",title:"Capital Peak Level 10 Base",townHallLevel:10,category:"capital",district:"capital_peak",type:"",rating:5,imageUrl:"https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=CH10-Demo",createdAt:new Date().toISOString()},{id:"demo-5",title:"Barbarian Camp Level 5 Base",townHallLevel:5,category:"capital",district:"barbarian_camp",type:"",rating:4,imageUrl:"https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=800&auto=format&fit=crop&q=60",link:"https://link.clashofclans.com/en?action=OpenLayout&id=BC5-Demo",createdAt:new Date().toISOString()}]}async function ut(){let[e,t,a]=await Promise.all([$e(),rt(),_()]),r=`https://link.clashofclans.com/en?action=OpenClanProfile&tag=%23${(t.clanTag||"#P0YVL80U").replace("#","")}`,i=a.filter(s=>s.role!=="leader").sort((s,l)=>(l.totalPoints||0)-(s.totalPoints||0)).slice(0,3);return`
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="animate-on-scroll" data-stagger="true">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ${t.filter(d=>d.role!=="leader").slice(0,3).map((d,m)=>Yt(d,m+1)).join("")}
                    </div>
                </div>
            </div>
        </div>
    ...
    `}function Yt(e,t){let a=["\u{1F947}","\u{1F948}","\u{1F949}"],o=["text-amber-400","text-gray-300","text-orange-400"];return`
        ...
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 animate-on-scroll" id="members-list" data-stagger="true">
                    ${a.length>0?a.map(l=>Je({name:l.name,tag:l.tag,role:l.role,townHallLevel:l.townHallLevel,trophies:l.trophies,donations:l.donations,clanCapital:l.clanCapitalContributions,totalPoints:l.totalPoints,sidePoints:l.sidePoints,onClick:`location.hash='#/member/${encodeURIComponent(l.tag)}'`})).join(""):q("\u{1F465}","Tidak ada member ditemukan","Coba ubah filter pencarian")}
                </div>
    ...
    `}var Oe=class{constructor(){this.container=null,this.toasts=[],this.init()}init(){this.container||(this.container=document.createElement("div"),this.container.id="toast-container",this.container.className="fixed top-20 right-4 z-[9999] flex flex-col gap-3 pointer-events-none",this.container.style.maxWidth="380px",this.container.style.width="100%",document.body.appendChild(this.container))}show(t,a="info",o=4e3){this.init();let n={success:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',error:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',warning:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z"/></svg>',info:'<svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>'},r={success:"border-green-500/50 bg-green-500/10",error:"border-red-500/50 bg-red-500/10",warning:"border-amber-500/50 bg-amber-500/10",info:"border-blue-500/50 bg-blue-500/10"},i={success:"text-green-400",error:"text-red-400",warning:"text-amber-400",info:"text-blue-400"},s=document.createElement("div");return s.className=`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-xl border ${r[a]} backdrop-blur-xl text-white shadow-2xl toast-enter`,s.innerHTML=`
        ...
        `;return}A=await _(),O=await ee(),D.clear(),J.clear();let t=O&&O.rewards?O.rewards:V,a=F();e.innerHTML=`
        <div class="pt-24 pb-8 px-4">
            <div class="max-w-5xl mx-auto">
                <!-- Header -->
    ...
    `,document.head.appendChild(e)}var Ft=null,Nt="",Da={"/":{render:Ia,title:"Home"},"/dashboard":{render:Ha,title:"Dashboard"},"/members":{render:Ra,title:"Members"},"/leaderboard":{render:ja,title:"Leaderboard"},"/wars":{render:Fa,title:"War History"},"/statistics":{render:Na,title:"Statistics"},"/layouts":{render:Ga,title:"Base Layouts"},"/rules":{render:Wa,title:"Clan Rules"},"/admin":{render:qa,title:"Admin Panel"},"/admin/rules":{render:Ua,title:"Rules Settings"},"/admin/landing":{render:za,title:"Landing Settings"},"/admin/sidepoints":{render:Ka,title:"Manage Side Points"},"/admin/layouts":{render:Va,title:"Manage Base Layouts"},"/login":{render:Ya,title:"Login"}};document.addEventListener("DOMContentLoaded",()=>{Aa()});async function Aa(){Ft=new we("particles-canvas"),Ft.start(),jt(),Bt((e,t)=>{he(),e&&ze()==="/login"&&(window.location.hash="#/dashboard")}),Wt(),window.addEventListener("hashchange",Wt),console.log("\u2694\uFE0F StreetLourd initialized!")}function ze(){return window.location.hash.slice(1)||"/"}function Wt(){let e=ze();if(e.startsWith("/member/")){let a=e.replace("/member/","");Nt="/member/:tag",document.title="Member Detail \u2014 StreetLourd",Oa(a),he();return}let t=Da[e];t?(Nt=e,document.title=`${t.title} \u2014 StreetLourd`,t.render()):window.location.hash="#/",he()}function he(){let e=document.getElementById("navbar-container");if(!e)return;let t=F(),a=Ct(),o=ze(),n="#"+o;o.startsWith("/member/")&&(n="#/members"),e.innerHTML=Ve(n,t,a),Ye();let r=document.getElementById("logout-btn"),i=document.getElementById("mobile-logout-btn");r&&r.addEventListener("click",async()=>{await Fe(),window.location.hash="#/",he()}),i&&i.addEventListener("click",async()=>{await Fe(),window.location.hash="#/",he()})}async function Ia(){let e=document.getElementById("page-content");e.style.opacity="0",e.innerHTML=await ut(),requestAnimationFrame(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="1"}),setTimeout(()=>{ne(),ht()},100)}async function Ha(){let e=document.getElementById("page-content");await T(e,()=>xt())}async function Ra(){let e=document.getElementById("page-content");await T(e,()=>ft())}async function Oa(e){let t=document.getElementById("page-content");await T(t,()=>vt(e))}async function ja(){let e=document.getElementById("page-content");await T(e,()=>wt())}async function Fa(){let e=document.getElementById("page-content");await T(e,()=>yt())}async function Na(){let e=document.getElementById("page-content");await T(e,()=>kt())}async function Wa(){let e=document.getElementById("page-content");e.style.opacity="0",e.innerHTML=await $t(),requestAnimationFrame(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="1"}),setTimeout(()=>ne(),100)}async function qa(){let e=document.getElementById("page-content");await T(e,()=>Tt())}async function Ua(){let e=document.getElementById("page-content");await T(e,()=>Et())}async function za(){let e=document.getElementById("page-content");await T(e,()=>Dt())}async function Ka(){let e=document.getElementById("page-content");await T(e,()=>At())}async function Ga(){let e=document.getElementById("page-content");await T(e,()=>Ht())}async function Va(){let e=document.getElementById("page-content");await T(e,()=>Rt())}function Ya(){let e=F(),t=document.getElementById("page-content");if(e){window.location.hash="#/dashboard";return}t.innerHTML=`
        <div class="pt-24 pb-8 px-4">
